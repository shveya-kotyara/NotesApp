...
var RequestShortener = require("webpack/lib/RequestShortener"); // TODO: allow the location to be customized in options
...
function getOrigin(e) {
  ...
  if (e.dependencies && e.origin) {
    ...
    e.dependencies.forEach(function (dep) {
      ...
      origin += ' ' + dep.loc.start.line + ':' + dep.loc.start.column + '-' + (dep.loc.start.line !== dep.loc.end.line ? dep.loc.end.line + ':' : '') + dep.loc.end.column;
    });
