...
!function (e, t) {
  ...
  function o(e, t, n) {
    !0 === e && (e = {});
    var i = e || {};
    if (n) for (var _e2 in i) {
      if (D(i, _e2) && !D(t, _e2)) throw new r("`" + _e2 + "` is not a supported option", t);
    }

    for (var _n2 in t) {
      if (D(t, _n2)) if (e && D(e, _n2)) {
        if ("ecma" === _n2) {
          var _t2 = 0 | e[_n2];

          _t2 > 5 && _t2 < 2015 && (_t2 += 2009), i[_n2] = _t2;
        } else i[_n2] = e && D(e, _n2) ? e[_n2] : t[_n2];
      } else i[_n2] = t[_n2];
    }
  ...
  function (_Error2) {
    ...
    function Q(e, t, n, i, r) {
      ...
      _this2 = _possibleConstructorReturn(this, _getPrototypeOf(Q).call(this)), _this2.name = "SyntaxError", _this2.message = e, _this2.filename = t, _this2.line = n, _this2.col = i, _this2.pos = r;
      return _this2;
    }
  ...
  function ie(e, t, n, i) {
    ...
    function h(e) {
      ...
      if (e && (c = e + c), x.test(c) && H.has_directive("use strict") && m("Legacy octal literals are not allowed in strict mode"), u && (c.endsWith("_") ? m("Numeric separators are not allowed at the end of numeric literals") : c.includes("__") && m("Only one underscore is allowed as numeric separator"), c = c.replace(/_/g, "")), c.endsWith("n")) {
        var _e3 = c.slice(0, -1),
            _t3 = J(_e3, w.test(_e3));

        if (!r && L.test(c) && !isNaN(_t3)) return _("big_int", _e3);
  ...
  function ce(e, t) {
    ...
    function b(e) {
      var t,
          n = null;
      m() || (n = le(sn, !0)), null != n ? ((t = i.labels.find(function (e) {
        return e.name === n.name;
      })) || c("Undefined label " + n.name), n.thedef = t) : 0 == i.in_loop && c(e.TYPE + " not inside a loop or switch"), g();
      var r = new e({
        label: n
      });
    ...
    function k() {
      ...
      for (var e, t = [], n = null, o = null; !r("punc", "}");) {
        r("eof") && f(), r("keyword", "case") ? (o && (o.end = u()), n = [], o = new it({
          start: (e = i.token, s(), e),
          expression: qe(!0),
          body: n
        ...
        switch (i.token.value) {
          case "(":
            ...
            var m = function (e, n) {
              ...
              for (_("("); !r("punc", ")");) {
                o && f(o), r("expand", "...") ? (o = i.token, n && (a = i.token), s(), l.push(new ke({
                  start: u(),
                  expression: qe(),
                  end: i.token
            ...
            if (h.start) {
              var _h$start$comments_bef;

              var _e4 = l.comments_before.length;

              if (n.set(l, _e4), (_h$start$comments_bef = h.start.comments_before).unshift.apply(_h$start$comments_bef, _toConsumableArray(l.comments_before)), l.comments_before = h.start.comments_before, 0 == _e4 && l.comments_before.length > 0) {
            ...
            h.start = l;
            var g = u();
            return h.end && (g.comments_before = h.end.comments_before, (_h$end$comments_after = h.end.comments_after).push.apply(_h$end$comments_after, _toConsumableArray(g.comments_after)), g.comments_after = h.end.comments_after), h.end = g, h instanceof mt && fe(h), _e(h, e);
    ...
    function H() {
      ...
      for (e.push(new He({
        ...
        s(), v(), e.push(qe(!0)), te("template_substitution") || f(), e.push(new He({
          start: i.token,
          raw: i.token.raw,
          value: i.token.value,
          end: i.token
    ...
    function q(e) {
      ...
      for (i.input.push_directives_stack(), i.input.add_directive("use strict"), "name" == i.token.type && "extends" != i.token.value && (o = le(e === Pt ? Zt : Jt)), e !== Pt || o || f(), "extends" == i.token.value && (s(), a = qe(!0)), _("{"); r("punc", ";");) {
        s();
      }

      for (; !r("punc", "}");) {
        for (t = i.token, (n = $(Q(), t, !0)) || f(), c.push(n); r("punc", ";");) {
          s();
        }
      }
    ...
    function $(e, t, n) {
      ...
      if (n) {
        var _n3 = function (e) {
          return "string" == typeof e || "number" == typeof e ? new $t({
            start: p,
            end: p,
            name: "" + e
          }) : (null === e && f(), e);
        }(e),
            _i2 = _n3 instanceof $t ? p.quote : void 0;
    ...
    var ge = function ge(e, t) {
      ...
      for (var a = G(e, t); r("operator") && oe.has(i.token.value) && !d(i.token);) {
        a instanceof Ve && f(), (a = De(Tt, i.token, a)).start = n, a.end = i.token, s();
      }
    ...
    function Xe(e) {
      if (e instanceof Mt) e = new Ke({
        ...
        for (var t = [], n = 0; n < e.elements.length; n++) {
          e.elements[n] instanceof ke && (n + 1 !== e.elements.length && l(e.elements[n].start, "Spread must the be last element in destructuring array"), e.elements[n].expression = Xe(e.elements[n].expression)), t.push(Xe(e.elements[n]));
        }
  ...
  function le(e, t, n) {
    var i = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : pe;
    var r = t = t ? t.split(/\s+/) : [];
    ...
    if (s && (u.prototype = s, u.BASE = i), i && i.SUBCLASSES.push(u), u.prototype.CTOR = u, u.prototype.constructor = u, u.PROPS = t || null, u.SELF_PROPS = r, u.SUBCLASSES = [], e && (u.prototype.TYPE = u.TYPE = e), n) for (a in n) {
  ...
  var _e = le("Statement", null, {
    ...
    _children_backwards: function _children_backwards(e) {
      e(this.body);
    }
  }, _e);
  ...
  var De = le("Block", "body block_scope", {
    ...
    args_as_names: function args_as_names() {
      for (var e = [], t = 0; t < this.argnames.length; t++) {
        this.argnames[t] instanceof Ke ? e.push.apply(e, _toConsumableArray(this.argnames[t].all_symbols())) : e.push(this.argnames[t]);
      }
    ...
    _children_backwards: function _children_backwards(e) {
      if (e(this.module_name), this.imported_names) {
        var _t4 = this.imported_names.length;

        for (; _t4--;) {
          e(this.imported_names[_t4]);
        }
      }
    ...
    _children_backwards: function _children_backwards(e) {
      if (this.module_name && e(this.module_name), this.exported_names) {
        var _t5 = this.exported_names.length;

        for (; _t5--;) {
          e(this.exported_names[_t5]);
        }
      }
  ...
  function yn(e, t) {
    ...
    for (; n.length;) {
      ...
      if (_r2) {
        if (_r2 === Cn) return !0;
      } else _e5._children_backwards(i);
    }
  ...
  function bn(e, t, n) {
    ...
    var u = {
      parent: function parent() {
        ...
        return -1 === e ? s : n && e >= o.length ? (e -= o.length, n[n.length - (e + 1)]) : o[o.length - (1 + e)];
      }
    };

    for (; i.length;) {
      for (s = i.pop(); a.length && i.length == a[a.length - 1];) {
        o.pop(), a.pop();
      }
      ...
      var _n4 = i.length;
      s._children_backwards(r), i.length > _n4 && (o.push(s), a.push(_n4 - 1));
    }

    return !1;
  }

  var Cn = Symbol("abort walk");
  ...
  function (_On) {
    ...
    function Fn(e, t) {
      ...
      _this3 = _possibleConstructorReturn(this, _getPrototypeOf(Fn).call(this)), _this3.before = e, _this3.after = t;
      return _this3;
    }
  ...
  function In(e) {
    ...
    for (var _n5, _i3 = 0; _n5 = e.parent(_i3); _i3++) {
      if (_n5 instanceof _e && _n5.body === t) return !0;
      if (!(_n5 instanceof Et && _n5.expressions[0] === t || "Call" === _n5.TYPE && _n5.expression === t || _n5 instanceof Ue && _n5.prefix === t || _n5 instanceof Dt && _n5.expression === t || _n5 instanceof St && _n5.expression === t || _n5 instanceof bt && _n5.condition === t || _n5 instanceof yt && _n5.left === t || _n5 instanceof Tt && _n5.expression === t)) return !1;
      t = _n5;
    }
  }
  ...
  function Bn(e) {
    ...
    if (e.comments) {
      ...
      if ("string" == typeof e.comments && /^\/.*\/[a-zA-Z]*$/.test(e.comments)) {
        ...
        _t7 = new RegExp(e.comments.substr(1, i - 1), e.comments.substr(i + 1));
      }

      n = _t7 instanceof RegExp ? function (e) {
        return "comment5" != e.type && _t7.test(e.value);
      } : "function" == typeof _t7 ? function (e) {
        return "comment5" != e.type && _t7(this, e);
      } : "some" === _t7 ? Vn : u;
    }
    ...
    return {
      ...
      append_comments: t || n === s ? a : function (e, t) {
        ...
        if (i) {
          ...
          if (o && !r.has(o) && (e instanceof _e || o.every(function (e) {
  ...
  !function () {
    ...
    function o(e, t, n) {
      var i = !1;
      n && (i = yn(e, function (e) {
        return e instanceof xe || (e instanceof yt && "in" == e.operator ? Cn : void 0);
      })), e.print(t, i);
    }
    ...
    pe.DEFMETHOD("print", function (e, t) {
      ...
      if (t instanceof yt) {
        var _e7 = t.operator,
            _n6 = this.operator;
        if ("??" === _n6 && ("||" === _e7 || "&&" === _e7)) return !0;
        var _i4 = se[_e7],
            _r3 = se[_n6];
        if (_i4 > _r3 || _i4 == _r3 && (this === t.right || "**" == _e7)) return !0;
      }
    }), t(Je, function (e) {
      var t = e.parent();
      ...
      var t = e.parent();
      if (t instanceof ht && t.expression === this) return yn(this, function (e) {
        return e instanceof xe || (e instanceof mt ? Cn : void 0);
      });
    }), t(mt, function (e) {
      var t,
          n = e.parent();
      ...
      for (var i = 0; i < e.segments.length; i++) {
        e.segments[i] instanceof He ? n ? t.print(e.segments[i].raw) : t.print_template_string_chars(e.segments[i].value) : (t.print("${"), e.segments[i].print(t), t.print("}"));
      }
      ...
      if (1 === t.body.length && o instanceof We) {
        ...
        }(_t11) ? _t11.print(e) : (e.print("("), _t11.print(e), e.print(")")) : e.print("{}");
      } else r(t, e);
      ...
      if (e.print(t), this.value) {
        e.space();
        var _t12 = this.value.start.comments_before;
        _t12 && _t12.length && !e.printed_comments.has(_t12) ? (e.print("("), this.value.print(e), e.print(")")) : this.value.print(e);
      }
    ...
    e(dn, function (e, t) {
      ...
      n = A(n), i = i ? function (e) {
        ...
        try {
          for (var _iterator = "gimuy"[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var _e8 = _step.value;
            t.has(_e8) && (n += _e8, t["delete"](_e8));
          }
        } catch (err) {
      ...
      }(i) : "", n = n.replace(c, l), t.print(t.to_utf8("/".concat(n, "/").concat(i)));
      var r = t.parent();
  ...
  var Kn = function Kn(e, t) {
    ...
    var t = Object.keys(e).map(function (t) {
      if ("eq" === e[t]) return "this.".concat(t, " === other.").concat(t);
      if ("exist" === e[t]) return "(this.".concat(t, " == null ? other.").concat(t, " == null : this.").concat(t, " === other.").concat(t, ")");
    ...
    _createClass(zn, [{
      ...
      value: function mangle(e) {
        ...
        if (this.global && t && t.has(this.name)) this.mangled_name = t.get(this.name);else if (!this.mangled_name && !this.unmangleable(e)) {
          ...
          this.mangled_name = _r4 ? _r4.mangled_name || _r4.name : n.next_mangled(e, this), this.global && t && t.set(this.name, this.mangled_name);
        }
      }
    }]);
  ...
  function Yn(e, t) {
    ...
    e: for (;;) {
      ...
      if (!O.has(i) && !(t.reserved.has(i) || Xn && Xn.has(i))) {
        for (var _e9 = n.length; --_e9 >= 0;) {
          var _r5 = n[_e9];
          if (i == (_r5.mangled_name || _r5.unmangleable(t) && _r5.name)) continue e;
        }
  ...
  zn.next_id = 1, xe.DEFMETHOD("figure_out_scope", function (e) {
    var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        _ref$parent_scope = _ref.parent_scope,
        t = _ref$parent_scope === void 0 ? null : _ref$parent_scope,
        _ref$toplevel = _ref.toplevel,
        n = _ref$toplevel === void 0 ? this : _ref$toplevel;
    ...
    var i = this.parent_scope = t,
        ...
        s = null,
        u = [],
        c = new On(function (t, n) {
      if (t.is_block_scope()) {
        var _r6 = i;
        t.block_scope = i = new xe(t), i._block_scope = !0;

        var _o = t instanceof ot ? _r6.parent_scope : _r6;

        if (i.init_scope_vars(_o), i.uses_with = _r6.uses_with, i.uses_eval = _r6.uses_eval, e.safari10 && (t instanceof Fe || t instanceof Me) && u.push(i), t instanceof et) {
          var _e10 = i;
          i = _r6, t.expression.walk(c), i = _e10;

          for (var _e11 = 0; _e11 < t.body.length; _e11++) {
            t.body[_e11].walk(c);
          }
        } else n();
      ...
      if (t instanceof we) for (var m = i; m; m = m.parent_scope) {
        m.uses_with = !0;
      } else {
        if (t instanceof Bt && (t.scope = i), t instanceof nn && (t.thedef = t, t.references = []), t instanceof jt) a.def_function(t, "arguments" == t.name ? void 0 : a);else if (t instanceof Yt) l((t.scope = a.parent_scope.get_defun_scope()).def_function(t, a), 1);else if (t instanceof Jt) l(a.def_variable(t, a), 1);else if (t instanceof en) i.def_variable(t);else if (t instanceof Zt) l((t.scope = a.parent_scope).def_function(t, a), 1);else if (t instanceof Gt || t instanceof zt || t instanceof Xt || t instanceof Qt) {
          if ((h = t instanceof Ht ? i.def_variable(t, null) : a.def_variable(t, "SymbolVar" == t.TYPE ? null : void 0)).orig.every(function (e) {
            return e === t || (t instanceof Ht ? e instanceof jt : !(e instanceof zt || e instanceof Xt));
          }) || ee("\"".concat(t.name, "\" is redeclared"), t.start.file, t.start.line, t.start.col, t.start.pos), t instanceof Wt || l(h, 2), a !== i) {
            t.mark_enclosed();
        ...
        i instanceof Ne || !(t instanceof dt || t instanceof _t) || ee("\"".concat(t.TYPE, "\" statement may only appear at the top level"), t.start.file, t.start.line, t.start.col, t.start.pos);
      }
    });
    ...
    c = new On(function (e) {
      ...
      if (e instanceof rn) {
        var t,
            i = e.name;
        if ("eval" == i && c.parent() instanceof mt) for (var r = e.scope; r && !r.uses_eval; r = r.parent_scope) {
          r.uses_eval = !0;
        }
      ...
      var o;
      if (e instanceof Qt && (o = Wn(e.definition()))) for (r = e.scope; r && (_(r.enclosed, o), r !== o.scope);) {
        r = r.parent_scope;
      }
    });

    if (this.walk(c), (e.ie8 || e.safari10) && yn(this, function (e) {
      if (e instanceof Qt) {
        var t = e.name,
      ...
      var _loop2 = function _loop2() {
        ...
        try {
          for (var _iterator4 = e.variables.values()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            ...
            t.has(_n7) && (_(i, _n7), _(e.enclosed, _n7));
          }
        } catch (err) {
    ...
    for (var e = this.definition(), t = this.scope; t && (_(t.enclosed, e), t !== e.scope);) {
      t = t.parent_scope;
    }
    ...
    this.walk(r), (e.keep_fnames || e.keep_classnames) && (Xn = new Set(), n.forEach(function (t) {
  ...
  function (_On2) {
    ...
    function ai(e, t) {
      ...
      _this5 = _possibleConstructorReturn(this, _getPrototypeOf(ai).call(this)), void 0 === e.defaults || e.defaults || (t = !0), _this5.options = o(e, {
        arguments: !1,
        arrows: !t,
        booleans: !t,
    ...
    _createClass(ai, [{
      ...
      value: function exposed(e) {
        ...
        if (e.global) for (var t = 0, n = e.orig.length; t < n; t++) {
          if (!this.toplevel[e.orig[t] instanceof Yt ? "funcs" : "vars"]) return !0;
        }
        return !1;
      }
    }, {
        ...
        for (var t = +this.options.passes || 1, n = 1 / 0, i = !1, r = {
          ...
          if (e.figure_out_scope(r), 0 === o && this.option("drop_console") && (e = e.drop_console()), (o > 0 || this.option("reduce_vars")) && e.reset_opt_flags(this), e = e.transform(this), t > 1) {
            var _ret = function () {
              ...
              if (yn(e, function () {
                t++;
              }), _this6.info("pass " + o + ": last_count: " + n + ", count: " + t), t < n) n = t, i = !1;else {
                if (i) return "break";
                i = !0;
              }
            }();
      ...
      key: "info",
      value: function info() {
        "verbose" == this.options.warnings && pe.warn.apply(pe, arguments);
      }
    }, {
      key: "warn",
  ...
  function _i(e) {
    for (var _t13 = 0;; _t13++) {
      var _n8 = e.parent(_t13);

      if (_n8 instanceof Ne) return _n8;
      if (_n8 instanceof Ie) return _n8;
      if (_n8.block_scope) return _n8.block_scope;
    }
  }

  function di(e, t) {
    for (var n, i = 0; (n = e.parent(i++)) && !(n instanceof xe);) {
      if (n instanceof ot && n.argname) {
  ...
  function gi(e, t) {
    return t instanceof Et ? e.push.apply(e, _toConsumableArray(t.expressions)) : e.push(t), e;
  }
  ...
  si(pe, function (e) {
    ...
    return function (e, t) {
      ...
      for (; n.length && i.length;) {
        ...
        if (!Kn(_e14, _t14)) return !1;
        if (_e14._children_backwards(r), _t14._children_backwards(o), n.length !== i.length) return !1;
      }
    ...
    function c(e, t, n, i) {
      ...
      var r;
      return null === t.fixed && (r = e.defs_to_safe_ids.get(t.id)) ? (r[t.id] = !1, e.defs_to_safe_ids["delete"](t.id), !0) : !!D(e.safe_ids, t.id) && !!u(e, t) && !1 !== t.fixed && !(null != t.fixed && (!i || t.references.length > t.assignments)) && (t.fixed instanceof Be ? i instanceof pe && t.fixed.parent_scope === n : t.orig.every(function (e) {
        return !(e instanceof Xt || e instanceof Yt || e instanceof jt);
      }));
    }
    ...
    e(Le, function (e, t, i) {
      ...
      return oi(this, 16), r(e), n(e, i, this), this.uses_arguments ? (t(), void o(e)) : (!this.name && (a = e.parent()) instanceof mt && a.expression === this && !a.args.some(function (e) {
        ...
        if (t.definition) {
          var i = t.definition();
          i.orig.length > 1 || (void 0 !== i.fixed || _this7.uses_arguments && !e.has_directive("use strict") ? i.fixed = !1 : (i.fixed = function () {
  ...
  function Mi(e, t) {
    ...
    function u(e, t) {
      ...
      for (var s, u = [], c = e.length, l = new Fn(function (e) {
        ...
        for (V(e[c]); u.length > 0;) {
          ...
          if (S && !fi(S) && !S.has_side_effects(t)) {
            ...
            if (!w) {
              for (var x = t.self().argnames.lastIndexOf(h.name) + 1; !M && x < s.length; x++) {
                s[x].transform(l);
              }
      ...
      function P() {
        ...
        if (li(n) && !n.name && !n.uses_arguments && !n.pinned() && (e = t.parent()) instanceof mt && e.expression === n && e.args.every(function (e) {
          return !(e instanceof ke);
        })) {
          ...
          for (var a = new Set(), c = o; --c >= 0;) {
            ...
            if (!(_i5 && _i5.orig.length > 1) && (s.unshift(p(ft, l, {
              name: l,
              value: f
      ...
      function B(e) {
        if (!(e instanceof ft && e.name instanceof Ut)) {
          var _t15 = e[e instanceof Ct ? "left" : "expression"];
          return !pi(_t15, Xt) && !pi(_t15, zt) && _t15;
        }
      ...
      function W(e) {
        ...
        var t = e.definition();
        return !(1 == t.orig.length && t.orig[0] instanceof Yt) && (t.scope.get_defun_scope() !== o || !t.references.every(function (e) {
    ...
    function c(e) {
      for (var t = [], n = 0; n < e.length;) {
        var i = e[n];
        i instanceof Se && i.body.every(vi) ? (a = !0, c(i.body), e.splice.apply(e, [n, 1].concat(_toConsumableArray(i.body))), n += i.body.length) : i instanceof ve ? (a = !0, e.splice(n, 1)) : i instanceof me ? t.indexOf(i.value) < 0 ? (n++, t.push(i.value)) : (a = !0, e.splice(n, 1)) : n++;
      }
    }
      ...
      for (var i, r = 0, o = 0; o < e.length; o++) {
        ...
        if (i) if (s instanceof ze) s.value = n(s.value || p(gn, s).transform(t));else if (s instanceof Fe) {
          if (!(s.init instanceof st)) {
            yn(i.body, function (e) {
              return e instanceof xe || (e instanceof yt && "in" === e.operator ? Cn : void 0);
            }) || (s.init ? s.init = n(s.init) : (s.init = i.body, r--, a = !0));
          }
  ...
  function Ri(e, t, n) {
    t instanceof Be || e.warn("Dropping unreachable code [{file}:{line},{col}]", t.start), yn(t, function (i) {
      return i instanceof ut ? (e.warn("Declarations in unreachable code! [{file}:{line},{col}]", i.start), i.remove_initializers(), n.push(i), !0) : i instanceof Be && (i === t || !e.has_directive("use strict")) ? (n.push(i === t ? i : p(ut, i, {
        definitions: [p(ft, i, {
  ...
  !function (e) {
    ...
    Ne.DEFMETHOD("resolve_defines", function (e) {
      return e.option("global_defs") ? (this.figure_out_scope({
        ...
        if (i) {
          for (var r, o = 0, a = n; (r = this.parent(o++)) && r instanceof gt && r.expression === a;) {
            a = r;
          }
  ...
  mt.DEFMETHOD("is_expr_pure", function (e) {
    if (e.option("unsafe")) {
      ...
      if (t instanceof Dt && yi(t.expression) && (_i7 = Gi.get(t.expression.name)) && _i7.has(t.property)) return !0;
    }
  ...
  var Xi = new Set(["Number", "String", "Array", "Object", "Function", "Promise"]);
  ...
  !function (e) {
    ...
    function t(e) {
      ...
      return yn(this, function (n) {
        if (n instanceof rn) {
          if (ii(_this8, 16)) return t = !1, Cn;
          var r = n.definition();

          if (i(r, _this8.enclosed) && !_this8.variables.has(r.name)) {
            if (e) {
        ...
        if (n instanceof un && _this8 instanceof Ve) return t = !1, Cn;
      }), t;
    }
    ...
    e(pe, s), e(ln, u), e(It, function (e) {
      ...
      try {
        for (var _iterator5 = this.properties[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          ...
          if (_t16.computed_key() && !_t16.key.is_constant_expression(e)) return !1;
          if (_t16["static"] && _t16.value && !_t16.value.is_constant_expression(e)) return !1;
        }
      } catch (err) {
    ...
    function t() {
      for (var e = 0; e < this.body.length; e++) {
        if (zi(this.body[e])) return this.body[e];
      }
  ...
  xe.DEFMETHOD("drop_unused", function (e) {
    ...
    var r = qi.test(e.option("unused")) ? s : function (e) {
      ...
      if (r instanceof Ie && r.uses_arguments && !_.has_directive("use strict") && r.argnames.forEach(function (e) {
        ...
        if (r instanceof Be || r instanceof Pt) {
          ...
          if ((_.parent() instanceof dt || !n && l === t) && f.global && !o.has(f.id) && o.set(f.id, f), r instanceof Pt) {
            ...
            try {
              for (var _iterator6 = r.properties[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                var _t17 = _step6.value;
                (_t17.has_side_effects(e) || _t17.may_throw(e)) && _t17.walk(_);
              }
            } catch (err) {
        ...
        if (r instanceof Wt && l === t && g(u, r.definition().id, r), r instanceof st && l === t) {
          var _t18 = _.parent() instanceof dt;

          return r.definitions.forEach(function (n) {
            if (n.name instanceof Gt && g(u, n.name.definition().id, n), !_t18 && i || yn(n.name, function (e) {
              if (e instanceof Ut) {
                var _n9 = e.definition();

                !_t18 && !_n9.global || o.has(_n9.id) || o.set(_n9.id, _n9);
              }
            }), n.value) {
    ...
    var d = new Fn(function (s, c, _) {
      ...
      if (i) {
        ...
        if (_e15 instanceof rn) {
          var E = _e15.definition(),
              g = o.has(E.id);
      ...
      if (l === t) {
        ...
        if ((s instanceof Be || s instanceof Pt) && s !== t) {
          var _t19 = s.name.definition();

          if (!(_t19.global && !n || o.has(_t19.id))) {
            if (e[s.name.unreferenced() ? "warn" : "info"]("Dropping unused function {name} [{file}:{line},{col}]", R(s.name)), _t19.eliminated++, s instanceof Pt) {
              var _t20 = s.drop_side_effect_free(e);

              if (_t20) return p(he, s, {
                body: _t20
              });
            }
    ...
    function h(e, n) {
      ...
      if (e instanceof rn) {
        if (i = e.definition(), !o.has(i.id) && (o.set(i.id, i), i.orig[0] instanceof Qt)) {
          var _e17 = i.scope.is_block_scope() && i.scope.get_defun_scope().variables.get(i.name);

          _e17 && o.set(_e17.id, _e17);
        }
    ...
    if (n || i) {
      var r = [],
          ...
          u = 0;
      yn(t, function (e) {
        return e instanceof xe && e !== t || (e instanceof ut ? (++u, !0) : void 0);
      }), i = i && u > 1;
      ...
      if (t = t.transform(c), s > 0) {
        ...
        var _e18 = t instanceof Ie,
            _n10 = _e18 ? t.args_as_names() : null;

        if (a.forEach(function (t, i) {
          _e18 && _n10.some(function (e) {
    ...
    var n = t instanceof Ne && e.top_retain || s,
      ...
      if (o instanceof ft) {
        ...
        if (_r7.scope === t && 1 != (_u = _r7.definition()).escaped && !_u.assignments && !_u.direct_access && !_u.single_use && !e.exposed(_u) && !n(_u) && (_c = _r7.fixed_value()) === o.value && _c instanceof Mt && _c.properties.every(function (e) {
          ...
          return _c.properties.forEach(function (n) {
            _t21.push(p(ft, o, {
              name: s(_r7, n.key, _e19),
              value: n.value
            }));
          }), i.set(_u.id, _e19), f.splice(_t21);
        }
      } else if (o instanceof gt && o.expression instanceof rn) {
        var _e20 = i.get(o.expression.definition().id);

        if (_e20) {
          var _t22 = _e20.get(String(wi(o.property))),
              _n11 = p(rn, o, {
            name: _t22.name,
    ...
    e(pe, c), e(ln, l), e(un, l), e(mt, function (e, n) {
      ...
      try {
        for (var _iterator7 = this.properties[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
          ...
          var _i8 = _n12.drop_side_effect_free(e);
      ...
      for (ri(this, 32); t instanceof gt;) {
        t = t.expression;
      }
      ...
      var n = this instanceof wt && this.key instanceof pe && this.key.drop_side_effect_free(e, t),
    ...
    if (Mi(e.body, t), e.bcatch && e.bfinally && e.bfinally.body.every(Si) && (e.bfinally = null), t.option("dead_code") && e.body.every(Si)) {
      var n = [];
      return e.bcatch && Ri(t, e.bcatch, n), e.bfinally && n.push.apply(n, _toConsumableArray(e.bfinally.body)), p(Se, e, {
        body: n
      }).optimize(t);
    }
    ...
    this.definitions.forEach(function (t) {
      t.name instanceof Ut ? (t.value = null, e.push(t)) : yn(t.name, function (n) {
    ...
    if (t.option("unsafe")) if (yi(n)) switch (n.name) {
      case "Array":
        ...
        if (e.args[0] instanceof pn && e.args[0].value <= 11) {
          ...
          for (var _n13 = 0; _n13 < e.args[0].value; _n13++) {
            _t23.push(new Dn());
          }
    ...
    if (t.option("unsafe_Function") && yi(n) && "Function" == n.name) {
      ...
      if (e.args.every(function (e) {
        ...
        var O,
            F = new ai(t.options);
        (b = b.transform(F)).figure_out_scope(C), qn.reset(), b.compute_char_frequency(C), b.mangle_names(C), yn(b, function (e) {
    ...
    if (x && R instanceof We) {
      ...
      if (!_n15 || _n15.is_constant_expression()) {
        _n15 = _n15 ? _n15.clone(!0) : p(gn, e);

        var _i10 = e.args.concat(_n15);

        return mi(e, _i10).optimize(t);
      }

      if (1 === i.argnames.length && i.argnames[0] instanceof Wt && e.args.length < 2 && _n15 instanceof rn && _n15.name === i.argnames[0].name) {
        var _n16;

        return e.args[0] instanceof gt && (_n16 = t.parent()) instanceof mt && _n16.expression === e ? mi(e, [p(pn, e, {
          value: 0
    ...
    if (x) {
      ...
      if (r && !i.uses_arguments && !i.pinned() && !(t.parent() instanceof It) && !(i.name && i instanceof Pe) && (_a = function (e) {
        var n = i.body,
            r = n.length;
        ...
        return V(e);
      }(R)) && (n === i || T(e, Rn) || t.option("unused") && 1 == (_o2 = n.definition()).references.length && !Ji(t, _o2) && i.is_constant_expression(n.scope)) && !T(e, Mn | wn) && !i.contains_this() && function () {
        var n = new Set();
        ...
        return !!function (e, t) {
          ...
          for (var _t24 = 0; _t24 < e.args.length; _t24++) {
            yn(e.args[_t24], n);
          }

          if (0 == t.size) return !0;

          for (var _e22 = 0, _n17 = i.argnames.length; _e22 < _n17; _e22++) {
            var r = i.argnames[_e22];
            if (!(r instanceof Ot && ii(r.left, 1)) && !(r instanceof ke && ii(r.expression, 1)) && !ii(r, 1) && t.has(r.name)) return !1;
          }

          for (var _e23 = 0, _n18 = i.body.length; _e23 < _n18; _e23++) {
            var o = i.body[_e23];
        ...
        return !1;
      }() && !(N instanceof It)) return ri(i, 256), _s.add_child_scope(i), mi(e, function (n) {
        var r = [],
            o = [];
        ...
        if (function (t, n) {
          ...
          for (var n = t.length, r = 0, o = i.body.length; r < o; r++) {
            ...
            if (a instanceof ut) for (var s = 0, u = a.definitions.length; s < u; s++) {
              ...
              if (B(e, t, l, c.value), k && i.argnames.every(function (e) {
          ...
          var _e24 = N.body.indexOf(t.parent(I - 1)) + 1;

          N.body.splice(_e24, 0, p(ut, i, {
            definitions: r
          }));
        }
    ...
    if ("delete" == e.operator && !(n instanceof rn || n instanceof gt || Fi(n))) {
      if (n instanceof Et) {
        var _i11 = n.expressions.slice();

        return _i11.push(p(Tn, e)), mi(e, _i11).optimize(t);
      }
  ...
  function Ji(e, t) {
    for (var n, i = 0; n = e.parent(i); i++) {
      if (n instanceof Ie || n instanceof It) {
        var r = n.name;
  ...
  function Qi(e, t) {
    ...
    try {
      for (var _iterator8 = t.enclosed[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
        var _n19 = _step8.value;
        if (t.variables.has(_n19.name)) continue;

        var _i12 = e.find_variable(_n19.name);

        if (_i12) {
          if (_i12 === _n19) continue;
          return !0;
        }
      }
    } catch (err) {
  ...
  si(yt, function (e, t) {
      ...
      switch (e.operator) {
        ...
        case "??":
          ...
          if (t.in_boolean_context()) {
            var _n20 = e.right.evaluate(t);

            if (!(_n20 instanceof pe || _n20)) return e.left;
          }
      ...
      switch (e.operator) {
        case "+":
          ...
          if (e.left instanceof Ge && e.right instanceof Ge) {
            ...
            for (var v = 1; v < E.segments.length; v++) {
              S.push(E.segments[v]);
            }
    ...
    if (t.option("reduce_vars") && Ii(e, n) !== e) {
      ...
      if (t.top_retain && _f.global && t.top_retain(_f)) return _f.fixed = !1, _f.should_replace = !1, _f.single_use = !1, e;
      var i = e.fixed_value(),
          r = _f.single_use && !(n instanceof mt && n.is_expr_pure(t) || T(n, wn));
      if (r && (i instanceof Ie || i instanceof It)) if (ji(i, t)) r = !1;else if (_f.scope !== e.scope && (1 == _f.escaped || ii(i, 16) || function (e) {
        ...
        return !1;
      }(t))) r = !1;else if (Ji(t, _f)) r = !1;else if ((_f.scope !== e.scope || _f.orig[0] instanceof Wt) && "f" == (r = i.is_constant_expression(e.scope))) {
        var o = e.scope;
      ...
      if (r && i instanceof Ie) {
        ...
        r = _f.scope === e.scope && !Qi(_o3, i) || n instanceof mt && n.expression === e && !Qi(_o3, i);
      }

      if (r && i instanceof It) {
        r = (!i["extends"] || !i["extends"].may_throw(t) && !i["extends"].has_side_effects(t)) && !i.properties.some(function (e) {
          return e.may_throw(t) || e.has_side_effects(t);
        });
      }

      if (r && i) {
        if (i instanceof Pt && (ri(i, 256), i = p(Vt, i, i)), i instanceof Be && (ri(i, 256), i = p(Pe, i, i)), _f.recursive_refs > 0 && i.name instanceof Yt) {
          var _e25 = i.name.definition();

          var _t25 = i.variables.get(i.name.name),
              _n21 = _t25 && _t25.orig[0];

          _n21 instanceof jt || (_n21 = p(jt, i.name, i.name), _n21.scope = i, i.name = _n21, _t25 = i.def_function(_n21)), yn(i, function (n) {
            n instanceof rn && n.definition() === _e25 && (n.thedef = _t25, _t25.references.push(n));
          });
        }
      ...
      if (i && void 0 === _f.should_replace) {
        var _e26;

        if (i instanceof un) _f.orig[0] instanceof Wt || !_f.references.every(function (e) {
          return _f.scope === e.scope;
        }) || (_e26 = i);else {
          var a = i.evaluate(t);
          a === i || !t.option("unsafe_regexp") && a instanceof RegExp || (_e26 = hi(a, i));
        }

        if (_e26) {
          var s,
              u = _e26.optimize(t).size();

          yn(i, function (e) {
            if (e instanceof rn) return Cn;
          }) ? s = function s() {
            var n = _e26.optimize(t);

            return n === _e26 ? n.clone(!0) : n;
          } : (u = Math.min(u, i.size()), s = function s() {
            var n = Li(_e26.optimize(t), i);
            return n === _e26 || n === i ? n.clone(!0) : n;
          });
          var c = _f.name.length,
              l = 0;
          t.option("unused") && !t.exposed(_f) && (l = (c + 2 + u) / (_f.references.length - _f.assignments)), _f.should_replace = u <= c + l && s;
        } else _f.should_replace = !1;
      }

      if (_f.should_replace) return _f.should_replace();
    }
  ...
  function sr(e, t, n) {
    for (var i = 0; i < n.length; i++) {
      ...
      if (r instanceof ke) {
        var o = r.expression;
        o instanceof Ft && (n.splice.apply(n, [i, 1].concat(_toConsumableArray(o.elements))), i--);
      }
    }
  ...
  si(Ct, function (e, t) {
    ...
    if (t.option("ecma") >= 2020 && function (e, t, n) {
      ...
      if (e instanceof yt && "||" === e.operator) {
        ...
        var _r9 = function _r9(e) {
          if (!(e instanceof yt) || "===" !== e.operator && "==" !== e.operator) return !1;
          var r,
              o = 0;
          return e.left instanceof hn && (o++, _n22 = e, r = e.right), e.right instanceof hn && (o++, _n22 = e, r = e.left), xi(e.left) && (o++, _i13 = e, r = e.right), xi(e.right) && (o++, _i13 = e, r = e.left), 1 === o && !!r.equivalent_to(t);
        };

        if (!_r9(e.left)) return !1;
        if (!_r9(e.right)) return !1;
        if (_n22 && _i13 && _n22 !== _i13) return !0;
      }
    ...
    e: if (t.option("arguments") && i instanceof rn && "arguments" == i.name && 1 == i.definition().orig.length && (n = i.scope) instanceof Ie && n.uses_arguments && !(n instanceof Ve) && r instanceof pn) {
      ...
      } else if (!_ && !t.option("keep_fargs") && s < n.argnames.length + 5) for (; s >= n.argnames.length;) {
        _ = p(Wt, n, {
    ...
    return yn(this, function (e) {
      return e instanceof un ? Cn : e !== _this9 && e instanceof xe && !(e instanceof Ve) || void 0;
    });
      ...
      if (i instanceof Mt) for (var r = i.properties, o = r.length; --o >= 0;) {
        ...
        if ("" + (a instanceof kt ? a.key.name : a.key) == e) {
          if (!r.every(function (e) {
            return e instanceof wt || n && e instanceof kt && !e.is_generator;
          })) break;
    ...
    if (!(n instanceof mt && T(n, wn))) {
      var _n23 = e.flatten_object(e.property, t);

      if (_n23) return _n23.optimize(t);
    }
    ...
    try {
      ...
      if (n.warnings && !pe.warn_function && (pe.warn_function = function (e) {
        ...
        for (var f in "string" == typeof e && (e = [e]), n.parse = n.parse || {}, n.parse.toplevel = null, e) {
          if (D(e, f) && (n.parse.filename = f, n.parse.toplevel = ce(e[f], n.parse), n.sourceMap && "inline" == n.sourceMap.content)) {
  ...
  !function () {
    var e = function e(_e27) {
      for (var t = !0, n = 0; n < _e27.length; n++) {
        t && _e27[n] instanceof _e && _e27[n].body instanceof fn ? _e27[n] = new me({
          start: _e27[n].start,
          end: _e27[n].end,
          value: _e27[n].body.value
        }) : !t || _e27[n] instanceof _e && _e27[n].body instanceof fn || (t = !1);
      }
      ...
      ArrowFunctionExpression: function ArrowFunctionExpression(e) {
        var t = "BlockStatement" === e.body.type ? s(e.body).body : [p(We, {}, {
          value: s(e.body)
        })];
        return new Ve({
          start: i(e),
      ...
      FieldDefinition: function FieldDefinition(e) {
        var t;
      ...
      Literal: function Literal(e) {
        ...
        if (o) {
          ...
          if (!_r10) throw new Error("Invalid regex source " + _i14);

          var _r11 = _slicedToArray(_r10, 3),
              _o4 = _r11[0],
              _a2 = _r11[1],
              _s2 = _r11[2];
