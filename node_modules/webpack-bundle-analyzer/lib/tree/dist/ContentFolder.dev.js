...
var ContentFolder =
/*#__PURE__*/
function (_BaseFolder$default) {
  _inherits(ContentFolder, _BaseFolder$default);
  ...
  function ContentFolder(name, ownerModule, parent) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ContentFolder).call(this, name, parent));
  ...
  _createClass(ContentFolder, [{
    ...
    value: function toChartData() {
      return _objectSpread({}, _get(_getPrototypeOf(ContentFolder.prototype), "toChartData", this).call(this), {
