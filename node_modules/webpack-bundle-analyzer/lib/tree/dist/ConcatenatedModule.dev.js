...
/*#__PURE__*/
function (_Module$default) {
  _inherits(ConcatenatedModule, _Module$default);
  ...
  function ConcatenatedModule(name, data, parent) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ConcatenatedModule).call(this, name, data, parent));
  ...
  _createClass(ConcatenatedModule, [{
    ...
    value: function fillContentModules() {
      ...
      _lodash["default"].each(this.data.modules, function (moduleData) {
    ...
    value: function addContentModule(moduleData) {
      ...
      _lodash["default"].each(folders, function (folderName) {
        ...
        if (!childFolder) {
          childFolder = currentFolder.addChildFolder(new _ContentFolder["default"](folderName, _this3));
        }

        currentFolder = childFolder;
      });

      var module = new _ContentModule["default"](fileName, moduleData, this);
    ...
    value: function toChartData() {
      return _objectSpread({}, _get(_getPrototypeOf(ConcatenatedModule.prototype), "toChartData", this).call(this), {
        concatenated: true,
