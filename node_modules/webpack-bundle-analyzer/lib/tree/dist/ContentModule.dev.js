...
function (_Module$default) {
  _inherits(ContentModule, _Module$default);
  ...
  function ContentModule(name, data, ownerModule, parent) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ContentModule).call(this, name, data, parent));
  ...
  _createClass(ContentModule, [{
    ...
    value: function toChartData() {
      return _objectSpread({}, _get(_getPrototypeOf(ContentModule.prototype), "toChartData", this).call(this), {
