...
function parseBundle(bundlePath) {
  ...
  walk.recursive(ast, walkState, {
    ...
    CallExpression: function CallExpression(node, state, c) {
      ...
      var args = node.arguments; // Main chunk with webpack loader.
...
function getModulesLocations(node) {
  ...
  if (node.type === 'ArrayExpression' || isOptimizedArray) {
    ...
    var minId = isOptimizedArray ? // Get the [minId] value from the Array() call first argument literal value
    node.callee.object.arguments[0].value : // `0` for simple array
    0;

    var _modulesNodes = isOptimizedArray ? // The modules reside in the `concat()` function call arguments
