...
!function (t, e) {
  ...
  "function" == typeof define && define.amd ? define("stackframe", [], e) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = e() : t.StackFrame = e();
}(void 0, function () {
  "use strict";
  ...
  function s(e) {
    if (e) for (var r = 0; r < o.length; r++) {
      void 0 !== e[o[r]] && this["set" + t(o[r])](e[o[r]]);
    }
  }
  ...
  s.prototype = {
    ...
    setEvalOrigin: function setEvalOrigin(t) {
    ...
    var e = t.indexOf("("),
        ...
        o = t.substring(r + 1);
    if (0 === o.indexOf("@")) var u = /@(.+?)(?::(\d+))?(?::(\d+))?$/.exec(o, ""),
        a = u[1],
        f = u[2],
        c = u[3];
    return new s({
  ...
  for (var u = 0; u < r.length; u++) {
    s.prototype["get" + t(r[u])] = e(r[u]), s.prototype["set" + t(r[u])] = function (t) {
      return function (e) {
        this[t] = Boolean(e);
      };
    }(r[u]);
  ...
  for (var a = 0; a < n.length; a++) {
    s.prototype["get" + t(n[a])] = e(n[a]), s.prototype["set" + t(n[a])] = function (t) {
      return function (e) {
  ...
  for (var f = 0; f < i.length; f++) {
    s.prototype["get" + t(i[f])] = e(i[f]), s.prototype["set" + t(i[f])] = function (t) {
      return function (e) {
        this[t] = String(e);
      };
    }(i[f]);
