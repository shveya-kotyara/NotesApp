...
module.exports = function validateWebpackConfig(webpackConfig, api, options) {
  var target = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'app';
  var singleConfig = Array.isArray(webpackConfig) ? webpackConfig[0] : webpackConfig;
  var actualTargetDir = singleConfig.output.path;
