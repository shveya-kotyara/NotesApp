...
module.exports = function (api, args, options) {
  ...
  var targetDir = api.resolve(args.dest || options.outputDir); // respect inline build destination in copy plugin

  if (args.dest && config.plugins.has('copy')) {
    config.plugin('copy').tap(function (pluginArgs) {
  ...
  if (args.modern) {
    var ModernModePlugin = require('../../webpack/ModernModePlugin');
