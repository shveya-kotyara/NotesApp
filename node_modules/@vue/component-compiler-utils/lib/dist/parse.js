...
function parse(options) {
    var source = options.source, _a = options.filename, filename = _a === void 0 ? '' : _a, compiler = options.compiler, _b = options.compilerParseOptions, compilerParseOptions = _b === void 0 ? { pad: 'line' } : _b, _c = options.sourceRoot, sourceRoot = _c === void 0 ? '' : _c, _d = options.needMap, needMap = _d === void 0 ? true : _d;
