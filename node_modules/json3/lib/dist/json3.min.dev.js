...
(function () {
  function O(u, v) {
    ...
    function q(a) {
      ...
      if ("bug-string-char-index" == a) var d = !1;else if ("json" == a) d = q("json-stringify") && q("date-serialization") && q("json-parse");else if ("date-serialization" == a) {
    ...
    var ca = u.Number || r.Number,
        ...
        fa = u.Math || r.Math;
    u = u.JSON || r.JSON;
    "object" == _typeof(u) && u && (v.stringify = u.stringify, v.parse = u.parse);
    I = I.prototype;
    var w = I.toString,
        J = I.hasOwnProperty,
        x,
    ...
    if (!q("json")) {
      var P = q("bug-string-char-index"),
        ...
        c ? _G = function G(b, h) {
          ...
          for (k in b) {
            p && "prototype" == k || !J.call(b, k) || (n = "constructor" === k) || h(k);
          }

          (n || J.call(b, k = "constructor")) && h(k);
        } : (l = "valueOf toString toLocaleString propertyIsEnumerable isPrototypeOf hasOwnProperty constructor".split(" "), _G = function G(b, h) {
          var p = "[object Function]" == w.call(b),
              k,
              n = !p && "function" != typeof b.constructor && H[_typeof(b.hasOwnProperty)] && b.hasOwnProperty || J;

          for (k in b) {
            p && "prototype" == k || !n.call(b, k) || h(k);
          }

          for (p = l.length; k = l[--p];) {
            n.call(b, k) && h(k);
          }
        });
        return _G(a, d);
      ...
      if (!q("json-stringify") && !q("date-serialization")) {
        var ha = {
          ...
          _L = function L(m) {
            m > -1 / 0 && m < 1 / 0 ? (k(m), m = (0 >= d || 1E4 <= d ? (0 > d ? "-" : "+") + A(6, 0 > d ? -d : d) : A(4, d)) + "-" + A(2, c + 1) + "-" + A(2, e) + "T" + A(2, l) + ":" + A(2, b) + ":" + A(2, h) + "." + A(3, p) + "Z", d = c = e = l = b = h = p = null) : m = null;
            return m;
          };
        ...
        if (q("json-stringify") && !q("date-serialization")) {
          ...
          var ka = function ka(a) {
            ...
            return '"' + (Q.test(a) ? a.replace(Q, ka) : a) + '"';
              ...
              R = function R(a, d, c, e, g, l, b) {
            var h, p;
            B(function () {
              h = d[a];
            });
            "object" == _typeof(h) && h && (h.getUTCFullYear && "[object Date]" == w.call(h) && h.toJSON === z.prototype.toJSON ? h = _L(h) : "function" == typeof h.toJSON && (h = h.toJSON(a)));
            c && (h = c.call(d, a, h));
          ...
          v.stringify = function (a, d, c) {
            ...
            if (H[_typeof(d)] && d) {
              var g = w.call(d);
              if ("[object Function]" == g) var l = d;else if ("[object Array]" == g) {
                var b = {};
            ...
            if (c) if (g = w.call(c), "[object Number]" == g) {
              if (0 < (c -= c % 1)) for (10 < c && (c = 10), e = ""; e.length < c;) {
                e += " ";
              }
      ...
      if (!q("json-parse")) {
        var la = U.fromCharCode,
          ...
          for (var a = M, d = a.length, c, e, g, l, b; f < d;) {
            switch (b = a.charCodeAt(f), b) {
              ...
              case 34:
                ...
                for (f++; f < d;) {
                  if (b = a.charCodeAt(f), 32 > b) t();else if (92 == b) switch (b = a.charCodeAt(++f), b) {
                    case 92:
                    case 34:
                    case 47:
                    case 98:
                    ...
                    case 117:
                      ...
                      for (g = f + 4; f < g; f++) {
                        b = a.charCodeAt(f), 48 <= b && 57 >= b || 97 <= b && 102 >= b || 65 <= b && 70 >= b || t();
                      }
          ...
          var e = a[d],
              g;
          if ("object" == _typeof(e) && e) if ("[object Array]" == w.call(e)) for (g = e.length; g--;) {
            X(w, _G, e, g, c);
          } else _G(e, function (l) {
            X(e, l, c);
          });
          return c.call(a, d, e);
        };
  ...
  var Y = typeof define === "function" && define.amd,
    ...
    object: !0
      ...
      T = H[typeof exports === "undefined" ? "undefined" : _typeof(exports)] && exports && !exports.nodeType && exports,
      r = H[typeof window === "undefined" ? "undefined" : _typeof(window)] && window || this,
      F = T && H[typeof module === "undefined" ? "undefined" : _typeof(module)] && module && !module.nodeType && "object" == (typeof global === "undefined" ? "undefined" : _typeof(global)) && global;
