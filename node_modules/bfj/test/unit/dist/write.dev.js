...
suite('write with error thrown by fs.createWriteStream:', function () {
  var write;
  setup(function () {
    write = proxyquire(modulePath, {
      fs: {
  ...
  test('write rejects', function () {
    write().then(function () {
      return assert.fail('write should reject');
