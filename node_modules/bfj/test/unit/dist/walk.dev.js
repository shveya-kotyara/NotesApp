...
suite('walk:', function () {
  ...
  suite('require:', function () {
    ...
    suite('empty json:', function () {
      ...
      test('endLine event did not occur', function () {
    ...
    suite('badly-closed array:', function () {
      ...
      test('dataError event occurred twice', function () {
        assert.strictEqual(log.counts.dataError, 2);
      });
      test('dataError event was dispatched correctly first time', function () {
      ...
      test('dataError event was dispatched correctly second time', function () {
    ...
    suite('badly-closed object:', function () {
      ...
      test('dataError event occurred three times', function () {
      ...
      test('dataError event was dispatched correctly third time', function () {
    ...
    suite('bad literal true:', function () {
      ...
      test('dataError event occurred four times', function () {
      ...
      test('dataError event was dispatched correctly fourth time', function () {
    ...
    suite('chunked string:', function () {
      ...
      test('string event was dispatched correctly', function () {
        assert.strictEqual(log.args.string[0][0], "\t\xA0");
      });
      test('end event occurred once', function () {
        assert.strictEqual(log.counts.end, 1);
      });
    ...
    suite('throw errors from event handlers:', function () {
      ...
      test('error event occurred eleven times', function () {
    ...
    suite('error occurs on stream:', function () {
      var stream, emitter;
      setup(function (done) {
        stream = new Readable();
    ...
    suite('two values separated by newline:', function () {
      var stream, emitter;
      setup(function (done) {
        stream = new Readable();
    ...
    suite('two values separated by newline, ndjson=true:', function () {
      var stream, emitter;
      setup(function (done) {
        stream = new Readable();
      ...
      test('endLine event occurred once', function () {
    ...
    suite('two values separated by newline, ndjson=true, with embedded newlines in a value:', function () {
      var stream, emitter;
      setup(function (done) {
        stream = new Readable();
      ...
      test('string event occurred three times', function () {
    ...
    suite('two values not separated by newline, ndjson=true:', function () {
      var stream, emitter;
      setup(function (done) {
        stream = new Readable();
      ...
      test('dataError event occurred five times', function () {
        assert.strictEqual(log.counts.dataError, 5);
      });
      test('string event did not occurr', function () {
        assert.strictEqual(log.counts.string, 0);
      });
      test('endLine event did not occur', function () {
        assert.strictEqual(log.counts.endLine, 0);
    ...
    suite('two values separated by two newlines, ndjson=true:', function () {
      var stream, emitter;
      setup(function (done) {
        stream = new Readable();
      ...
      test('endLine event occurred twice', function () {
