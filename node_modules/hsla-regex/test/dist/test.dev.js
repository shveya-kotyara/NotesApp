...
var hslaStrings = ['hsla(111, 12.343%, 0.9%, .1)', 'hsla(123, 45%, 67%, 1)', 'hsla(1, 1.111%, 1.1111%, .4)', 'hsla(1, .111%, .1111%, .123456)'];
var inexactHslaStrings = ['hsla(,,,)', 'hsla(12,,,)', 'hsla(1, 1.111%, 1.1111%, .123) ', '   hSla(1, 1.111%, 1.1111%, 1)', 'hsl(1, .111%, .1111%)'];
describe('hsla-regex', function () {
  ...
  describe('g', function () {
    it('should match hsla strings', function () {
      assert.deepEqual(hslaStrings.join('foobar').match(hslaRegex()), hslaStrings);
    });
    it('should not match non hsla strings', function () {
      assert.deepEqual(inexactHslaStrings.join('foobar').match(hslaRegex()), ['hsla(1, 1.111%, 1.1111%, .123)', 'hSla(1, 1.111%, 1.1111%, 1)']);
    });
  });
});