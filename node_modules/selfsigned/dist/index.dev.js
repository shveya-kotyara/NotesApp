...
var forge = require('node-forge'); // a hexString is considered negative if it's most significant bit is 1
...
exports.generate = function generate(attrs, options, done) {
  ...
  var generatePem = function generatePem(keyPair) {
    ...
    var fingerprint = forge.md.sha1.create().update(forge.asn1.toDer(forge.pki.certificateToAsn1(cert)).getBytes()).digest().toHex().match(/.{2}/g).join(':');
    var pem = {
