  ...
  return function (css, result) {
    ...
    css.walkAtRules(/^import$/i, function (atRule) {
      ...
      var _ref = (0, _postcssValueParser["default"])(atRule.params),
          nodes = _ref.nodes; // No nodes - `@import ;`
      ...
      var isRequestable = (0, _loaderUtils.isUrlRequest)(url);
      ...
      var media = _postcssValueParser["default"].stringify(nodes.slice(1)).trim().toLowerCase();
      ...
      if (isRequestable) {
        ...
        if (!importName) {
          importName = "___CSS_LOADER_AT_RULE_IMPORT_".concat(importsMap.size, "___");
