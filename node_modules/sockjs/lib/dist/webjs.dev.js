...
(function () {
  ...
  execute_request = function execute_request(app, funs, req, res, data) {
    var fun, results, x;
    ...
    try {
      ...
      if (_typeof(x) === 'object' && 'status' in x) {
        if (x.status === 0) {
          return;
  ...
  fake_response = function fake_response(req, res) {
    var headers;
    headers = {
      'Connection': 'close'
    };
