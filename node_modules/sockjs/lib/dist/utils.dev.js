...
(function () {
  ...
  exports.array_intersection = array_intersection = function array_intersection(arr_a, arr_b) {
    var a, j, len, r;
    r = [];
  ...
  exports.overshadowListeners = function (ee, event, handler) {
    ...
    new_handler = function new_handler() {
      var j, len, listener;
  ...
  unroll_lookup = function unroll_lookup(escapable) {
    var c, i, unrolled;
    unrolled = {};
