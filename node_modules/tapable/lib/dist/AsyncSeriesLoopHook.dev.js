...
var AsyncSeriesLoopHook =
/*#__PURE__*/
function (_Hook) {
  _inherits(AsyncSeriesLoopHook, _Hook);

  function AsyncSeriesLoopHook() {
    _classCallCheck(this, AsyncSeriesLoopHook);

    return _possibleConstructorReturn(this, _getPrototypeOf(AsyncSeriesLoopHook).apply(this, arguments));
  }

  _createClass(AsyncSeriesLoopHook, [{
    key: "compile",
