...
var getRegexLiteral = function getRegexLiteral(stringRegex) {
  try {
    /* jshint evil: true */
...
var testGenericFlags = function testGenericFlags(object) {
...
test('works as a function', function (t) {
  ...
  t.test('throws properly', function (st) {
    ...
    var throwsOnNonObject = function throwsOnNonObject(nonObject) {
...
test('shims properly', function (t) {
  ...
  t.test('has the correct descriptor', function (st) {
    ...
    st.equal(_typeof(descriptor.get), 'function');
