...
!function (e, t) {
  ...
  "function" == typeof define && define.amd ? define("stackframe", [], t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = t() : e.StackFrame = t();
}(void 0, function () {
  "use strict";
  ...
  for (var s = 0; s < r.length; s++) {
    o.prototype["get" + e(r[s])] = t(r[s]), o.prototype["set" + e(r[s])] = function (e) {
      return function (t) {
        this[e] = Boolean(t);
      };
    }(r[s]);
  ...
  for (var c = 0; c < n.length; c++) {
    o.prototype["get" + e(n[c])] = t(n[c]), o.prototype["set" + e(n[c])] = function (e) {
      return function (t) {
  ...
  for (var u = 0; u < i.length; u++) {
    o.prototype["get" + e(i[u])] = t(i[u]), o.prototype["set" + e(i[u])] = function (e) {
      return function (t) {
        this[e] = String(t);
      };
    }(i[u]);
  ...
  "function" == typeof define && define.amd ? define("error-stack-parser", ["stackframe"], t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = t(require("stackframe")) : e.ErrorStackParser = t(e.StackFrame);
}(void 0, function (e) {
  "use strict";
  ...
  return {
    ...
    parseV8OrIE: function parseV8OrIE(t) {
      return t.stack.split("\n").filter(function (e) {
        ...
        var r = t.replace(/^\s+/, "").replace(/\(eval code/g, "("),
            ...
            a = this.extractLocation(n ? n[1] : i.pop()),
            o = i.join(" ") || void 0,
    ...
    parseOpera11: function parseOpera11(r) {
