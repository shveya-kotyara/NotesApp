...
}).version().help('help').alias('help', 'h').alias('version', 'v');
var argv = yargs.argv;
var file = argv._[0];
var codePromise;
...
Promise.all([codePromise, argv.theme ? fs.readFile(argv.theme, 'utf8') : undefined]).then(function (_a) {
  var code = _a[0],
      theme = _a[1];
  var options = {
    ignoreIllegals: true,
  ...
  return new Promise(function (resolve, reject) {
    return process.stdout.write(index_1.highlight(code, options), function (err) {
