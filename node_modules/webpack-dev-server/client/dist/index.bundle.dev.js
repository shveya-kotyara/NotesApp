...
!function (e) {
  ...
  e.exports = function (e) {
    ...
    function c(e) {
      ...
      }(this, c), (t = a.call(this)).sock = new l(e), t.sock.onerror = function (e) {}, t;
    }
  ...
  var n = r(15).getLogger("webpack-dev-server");
  n.setDefaultLevel("info"), e.exports = {
    log: n,
  ...
  (function (e) {
    ...
    n(h, {
      ...
      invalid: function invalid() {
        s.info("[WDS] App updated. Recompiling..."), (p.useWarningOverlay || p.useErrorOverlay) && o.clear(), c("Invalid");
      },
      hash: function hash(e) {
        f.currentHash = e;
      },
      "still-ok": function stillOk() {
        s.info("[WDS] Nothing changed."), (p.useWarningOverlay || p.useErrorOverlay) && o.clear(), c("StillOk");
      },
      "log-level": function logLevel(e) {
        var t = r(29);
        -1 !== t.keys().indexOf("./log") && t("./log").setLogLevel(e), a(e);
      },
      overlay: function overlay(e) {
        "undefined" != typeof document && ("boolean" == typeof e ? (p.useWarningOverlay = !1, p.useErrorOverlay = e) : e && (p.useWarningOverlay = e.warnings, p.useErrorOverlay = e.errors));
      },
      progress: function progress(e) {
        "undefined" != typeof document && (p.useProgress = e);
      },
      "progress-update": function progressUpdate(e) {
        p.useProgress && s.info("[WDS] ".concat(e.percent, "% - ").concat(e.msg, ".")), c("Progress", e);
      },
      ok: function ok() {
        if (c("Ok"), (p.useWarningOverlay || p.useErrorOverlay) && o.clear(), p.initial) return p.initial = !1;
        l(p, f);
      },
      "content-changed": function contentChanged() {
        s.info("[WDS] Content base changed. Reloading..."), self.location.reload();
      },
      warnings: function warnings(e) {
        ...
        if (p.useWarningOverlay && o.showMessage(e), p.initial) return p.initial = !1;
        l(p, f);
      },
  ...
  var n = "undefined" != typeof __webpack_dev_server_client__ ? __webpack_dev_server_client__ : r(0),
      o = 0,
      i = null,
      s = function s(e, t) {
    ...
    e.exports = function e(t, r, n) {
      ...
      5: [function (e, t, r) {
        ...
        n.prototype.addEventListener = function (e, t) {
          ...
          if (this["on" + t] && this["on" + t].apply(this, r), t in this._listeners) for (var n = this._listeners[t], o = 0; o < n.length; o++) {
            n[o].apply(this, r);
          }
        }, t.exports = n;
      }, {}],
        ...
        (function (r) {
          ...
          "production" !== r.env.NODE_ENV && (u = e("debug")("sockjs-client:iframe-bootstrap")), t.exports = function (e, t) {
            ...
            t.forEach(function (e) {
              ...
              var t;
              c.currentWindowId = l.hash.slice(1), o.attachEvent("message", function (o) {
                  ...
                  if (a.windowId === c.currentWindowId) switch (a.type) {
                    case "s":
                      ...
                      var h = p[0],
                          ...
                          m = p[2],
                          v = p[3];
                      if (u(h, d, m, v), h !== e.version) throw new Error('Incompatible SockJS! Main site uses: "' + h + '", the iframe: "' + e.version + '".');
                      if (!n.isOriginEqual(m, l.href) || !n.isOriginEqual(v, l.href)) throw new Error("Can't connect to different domain from within an iframe. (" + l.href + ", " + m + ", " + v + ")");
                      t = new s(new f[d](m, v));
                      break;
      ...
      9: [function (e, t, r) {
        (function (r) {
          ...
          "production" !== r.env.NODE_ENV && (a = e("debug")("sockjs-client:info-ajax")), o(c, n), c.prototype.close = function () {
      ...
      10: [function (e, t, r) {
        ...
        n(c, o), c.transportName = "iframe-info-receiver", c.prototype.close = function () {
      ...
      12: [function (e, t, r) {
        (function (r) {
          ...
          "production" !== r.env.NODE_ENV && (p = e("debug")("sockjs-client:info-receiver")), o(h, n), h._getReceiver = function (e, t, r) {
            return r.sameOrigin ? new f(t, c) : a.enabled ? new f(t, a) : s.enabled && r.sameScheme ? new f(t, s) : u.enabled() ? new u(e, t) : new f(t, l);
      ...
      14: [function (e, r, n) {
        (function (t, n) {
          ...
          function C(e, t, r) {
            ...
            g.call(this), this.readyState = C.CONNECTING, this.extensions = "", this.protocol = "", (r = r || {}).protocols_whitelist && m.warn("'protocols_whitelist' is DEPRECATED. Use 'transports' instead."), this._transportsWhitelist = r.transports, this._transportOptions = r.transportOptions || {}, this._timeout = r.timeout || 0;
            var n = r.sessionId || 8;
          ...
          "production" !== t.env.NODE_ENV && (E = e("debug")("sockjs-client:main")), s(C, g), C.prototype.close = function (e, t) {
            ...
            this.readyState !== C.CLOSING && this.readyState !== C.CLOSED && this._close(e || 1e3, t || "Normal closure", !0);
            ...
            if (E("_receiveInfo", t), this._ir = null, e) {
              this._rto = this.countRTO(t), this._transUrl = e.base_url ? e.base_url : this.url, e = h.extend(e, this._urlInfo), E("info", e);
            ...
            for (var e = this._transports.shift(); e; e = this._transports.shift()) {
              if (E("attempt", e.transportName), e.needBody && (!n.document.body || void 0 !== n.document.readyState && "complete" !== n.document.readyState && "interactive" !== n.document.readyState)) return E("waiting for body"), this._transports.unshift(e), void f.attachEvent("load", this._connect.bind(this));
            ...
            E("_open", this._transport && this._transport.transportName, this.readyState), this.readyState === C.CONNECTING ? (this._transportTimeoutId && (clearTimeout(this._transportTimeoutId), this._transportTimeoutId = null), this.readyState = C.OPEN, this.transport = this._transport.transportName, this.dispatchEvent(new v("open")), E("connected", this.transport)) : this._close(1006, "Server lost session");
            ...
            this.readyState = C.CLOSING, setTimeout(function () {
              ...
              var o = new y("close");
              o.wasClean = r || !1, o.code = e || 1e3, o.reason = t, this.dispatchEvent(o), this.onmessage = this.onclose = this.onerror = null, E("disconnected");
            }.bind(this), 0);
      ...
      15: [function (e, t, r) {
        ...
        h(s, {
          bind: function bind(e) {
            ...
            for (var r = c.call(arguments, 1), n = function n() {
            ...
            }, o = Math.max(0, t.length - r.length), i = [], s = 0; s < o; s++) {
              i.push("$" + s);
            }

            var a = Function("binder", "return function (" + i.join(",") + "){ return binder.apply(this, arguments); }")(n);
            return t.prototype && (v.prototype = t.prototype, a.prototype = new v(), v.prototype = null), a;
          }
        }), h(Array, {
        ...
        }, (g = o.forEach, b = !0, y = !0, g && (g.call("foo", function (e, t, r) {
          "object" != _typeof(r) && (b = !1);
        }), g.call([1], function () {
        ...
        h(o, {
          indexOf: function indexOf(e) {
            ...
            for (arguments.length > 1 && (n = m(arguments[1])), n = n >= 0 ? n : Math.max(0, r + n); n < r; n++) {
        ...
        2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(/()()/).length > 1 ? (C = void 0 === /()??/.exec("")[1], a.split = function (e, t) {
          ...
          if ("[object RegExp]" !== l.call(e)) return _.call(this, e, t);
          var n,
              i,
              s,
              a,
          ...
          for (e = new RegExp(e.source, u + "g"), r += "", C || (n = new RegExp("^" + e.source + "$(?!\\s)", u)), t = void 0 === t ? -1 >>> 0 : t >>> 0; (i = e.exec(r)) && !((s = i.index + i[0].length) > f && (c.push(r.slice(f, i.index)), !C && i.length > 1 && i[0].replace(n, function () {
            for (var e = 1; e < arguments.length - 2; e++) {
              void 0 === arguments[e] && (i[e] = void 0);
            }
          }), i.length > 1 && i.index < r.length && o.push.apply(c, i.slice(1)), a = i[0].length, f = s, c.length >= t));) {
            e.lastIndex === i.index && e.lastIndex++;
          }

          return f === r.length ? !a && e.test("") || c.push("") : c.push(r.slice(f)), c.length > t ? c.slice(0, t) : c;
      ...
      17: [function (e, r, n) {
        (function (t, n) {
          ...
          "production" !== t.env.NODE_ENV && (l = e("debug")("sockjs-client:browser:xhr")), i(u, o), u.prototype._start = function (e, t, r, n) {
            var o = this;
            ...
            if (n && n.noCredentials || !u.supportsCORS || (l("withCredentials"), this.xhr.withCredentials = !0), n && n.headers) for (var i in n.headers) {
            ...
            this.xhr.onreadystatechange = function () {
              if (o.xhr) {
                ...
                switch (l("readyState", r.readyState), r.readyState) {
                  ...
                  case 4:
                    t = r.status, l("status", t), 1223 === t && (t = 204), 12005 !== t && 12029 !== t || (t = 0), l("finish", t, r.responseText), o.emit("finish", t, r.responseText), o._cleanup(!1);
                }
              }
            };
          ...
          !u.enabled && f in n && (l("overriding xmlhttprequest"), c = function c() {
            try {
      ...
      28: [function (e, t, r) {
        (function (r) {
          ...
          function c(e, t, r, n, c) {
            ...
            a(l);
            var u = this;
            i.call(this, e, r), this.poll = new s(n, l, c), this.poll.on("message", function (e) {
          ...
          "production" !== r.env.NODE_ENV && (a = e("debug")("sockjs-client:sender-receiver")), n(c, i), c.prototype.close = function () {
      ...
      30: [function (e, r, n) {
        (function (t, n) {
          ...
          function u(e) {
            l(e), a.call(this);
            var t = this;
            i.polluteGlobalNamespace(), this.id = "a" + c.string(6), e = s.addQuery(e, "c=" + decodeURIComponent(i.WPrefix + "." + this.id)), l("using htmlfile", u.htmlfileEnabled);
          ...
          "production" !== t.env.NODE_ENV && (l = e("debug")("sockjs-client:receiver:htmlfile")), o(u, a), u.prototype.abort = function () {
            l("abort"), this._cleanup(), this._close("user");
          }, u.prototype._cleanup = function () {
            l("_cleanup"), this.iframeObj && (this.iframeObj.cleanup(), this.iframeObj = null), delete n[i.WPrefix][this.id];
      ...
      31: [function (e, r, n) {
        (function (t, n) {
          ...
          "production" !== t.env.NODE_ENV && (u = e("debug")("sockjs-client:receiver:jsonp")), c(f, l), f.prototype.abort = function () {
            ...
            }, void 0 === o.async && n.document.attachEvent) if (s.isOpera()) (t = this.script2 = n.document.createElement("script")).text = "try{var a = document.getElementById('" + o.id + "'); if(a)a.onerror();}catch(x){};", o.async = t.async = !1;else {
              try {
      ...
      33: [function (e, r, n) {
        (function (t, n) {
          ...
          "production" !== t.env.NODE_ENV && (c = e("debug")("sockjs-client:sender:jsonp")), r.exports = function (e, t, r) {
            c(e, t), o || (c("createForm"), (o = n.document.createElement("form")).style.display = "none", o.style.position = "absolute", o.method = "POST", o.enctype = "application/x-www-form-urlencoded", o.acceptCharset = "UTF-8", (i = n.document.createElement("textarea")).name = "d", o.appendChild(i), n.document.body.appendChild(o));
            var l = "a" + s.string(8);
            ...
            var f = function f(e) {
              c("completed", l, e), u.onerror && (u.onreadystatechange = u.onerror = u.onload = null, setTimeout(function () {
      ...
      34: [function (e, r, n) {
        (function (t, n) {
          ...
          "production" !== t.env.NODE_ENV && (l = e("debug")("sockjs-client:sender:xdr")), i(u, o), u.prototype._start = function (e, t, r) {
            l("_start");
            var o = this,
      ...
      36: [function (e, t, r) {
        ...
        e("inherits")(o, n), o.prototype.close = function () {
      ...
      38: [function (e, t, r) {
        (function (r) {
          ...
          "production" !== r.env.NODE_ENV && (c = e("debug")("sockjs-client:websocket")), i(l, s), l.prototype.send = function (e) {
            var t = "[" + e + "]";
      ...
      42: [function (e, r, n) {
        (function (t) {
          ...
          }, l.transportName = "xhr-streaming", l.roundTrips = 2, l.needBody = !!t.document, r.exports = l;
        }).call(this, void 0 !== t ? t : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {});
      }, {
        "../utils/browser": 44,
        "./lib/ajax-based": 24,
      ...
      46: [function (e, r, n) {
        (function (t) {
          ...
          r.exports = {
            attachEvent: function attachEvent(e, r) {
            ...
            detachEvent: function detachEvent(e, r) {
        ...
        (function (t, n) {
          ...
          "production" !== t.env.NODE_ENV && (a = e("debug")("sockjs-client:utils:iframe")), r.exports = {
            ...
            createHtmlfile: function createHtmlfile(e, t) {
              ...
              return u.body.appendChild(d), c = u.createElement("iframe"), d.appendChild(c), c.src = e, c.onerror = function () {
                h("onerror");
          ...
          }, r.exports.iframeEnabled = !1, n.document && (r.exports.iframeEnabled = ("function" == typeof n.postMessage || "object" == _typeof(n.postMessage)) && !s.isKonqueror());
        }).call(this, {
          env: {}
        }, void 0 !== t ? t : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {});
      }, {
      ...
      50: [function (e, t, r) {
        ...
        t.exports = {
          string: function string(e) {
            for (var t = "abcdefghijklmnopqrstuvwxyz012345".length, r = n.randomBytes(e), o = [], i = 0; i < e; i++) {
      ...
      54: [function (e, t, r) {
        ...
        t.exports = function (e, t) {
          ...
          if ("number" === l && !1 === isNaN(e)) return t["long"] ? (r = e, (c = Math.abs(r)) >= s ? a(r, c, s, "day") : c >= i ? a(r, c, i, "hour") : c >= o ? a(r, c, o, "minute") : c >= n ? a(r, c, n, "second") : r + " ms") : function (e) {
            var t = Math.abs(e);
            ...
            function s() {
              ...
              if (s.enabled) {
                var i = s,
                    a = Number(new Date()),
                    c = a - (t || a);
                i.diff = c, i.prev = t, i.curr = a, t = a, r[0] = n.coerce(r[0]), "string" != typeof r[0] && r.unshift("%O");
                var l = 0;
          ...
          (function () {
            var t = {
              ...
              object: !0
                ...
                o = t[_typeof(n)] && n && !n.nodeType && n,
                i = t[typeof window === "undefined" ? "undefined" : _typeof(window)] && window || this,
                s = o && t[_typeof(r)] && r && !r.nodeType && "object" == _typeof(e) && e;
            ...
            function a(e, r) {
              ...
              var n = e.Number || i.Number,
                  ...
                  f = e.Math || i.Math,
                  p = e.JSON || i.JSON;
              "object" == _typeof(p) && p && (r.stringify = p.stringify, r.parse = p.parse);
              ...
              function b(e) {
                ...
                var t;
                if ("bug-string-char-index" == e) t = "a" != "a"[0];else if ("json" == e) t = b("json-stringify") && b("json-parse");else {
                  var i,
                      s = "{\"a\":[1,true,false,null,\"\\u0000\\b\\n\\f\\r\\t\"]}";

                  if ("json-stringify" == e) {
                    var a = r.stringify,
                        l = "function" == typeof a && g;
                    ...
                    if (l) {
                      ...
                      try {
                        l = "0" === a(0) && "0" === a(new n()) && '""' == a(new o()) && void 0 === a(v) && void 0 === a(void 0) && void 0 === a() && "1" === a(i) && "[1]" == a([i]) && "[null]" == a([void 0]) && "null" == a(null) && "[null,null,null]" == a([void 0, v, null]) && a({
                          a: [i, !0, !1, null, "\0\b\n\f\r\t"]
              ...
              if (!b("json")) {
                ...
                if ((_h = m.hasOwnProperty) || (_h = function h(e) {
                  ...
                  for (i in (n = function n() {
                    this.valueOf = 0;
                  }).prototype.valueOf = 0, o = new n()) {
                    _h.call(o, i) && s++;
                  }

                  return n = o = null, s ? _d = 2 == s ? function (e, t) {
                    var r,
                        n = {},
                        o = "[object Function]" == v.call(e);

                    for (r in e) {
                      o && "prototype" == r || _h.call(n, r) || !(n[r] = 1) || !_h.call(e, r) || t(r);
                    }
                  } : function (e, t) {
                    var r,
                        n,
                    ...
                    for (r in e) {
                      o && "prototype" == r || !_h.call(e, r) || (n = "constructor" === r) || t(r);
                    }

                    (n || _h.call(e, r = "constructor")) && t(r);
                  } : (o = ["valueOf", "toString", "toLocaleString", "propertyIsEnumerable", "isPrototypeOf", "hasOwnProperty", "constructor"], _d = function d(e, r) {
                    var n,
                        i,
                        s = "[object Function]" == v.call(e),
                        a = !s && "function" != typeof e.constructor && t[_typeof(e.hasOwnProperty)] && e.hasOwnProperty || _h;

                    for (n in e) {
                      s && "prototype" == n || !a.call(e, n) || r(n);
                    }
                  ...
                  var C = {
                    ...
                    return ("000000" + (t || 0)).slice(-e);
                      ...
                      S = function S(e) {
                    for (var t = '"', r = 0, n = e.length, o = !y || n > 10, i = o && (y ? e.split("") : e); r < n; r++) {
                    ...
                    return t + '"';
                      ...
                      O = function O(e, t, r, n, o, i, s) {
                    var a, c, l, f, p, m, g, b, y, x, C, A, q, j, k, N;

                    try {
                      a = t[e];
                    } catch (e) {}

                    if ("object" == _typeof(a) && a) if ("[object Date]" != (c = v.call(a)) || _h.call(a, "toJSON")) "function" == typeof a.toJSON && ("[object Number]" != c && "[object String]" != c && "[object Array]" != c || _h.call(a, "toJSON")) && (a = a.toJSON(e));else if (a > -1 / 0 && a < 1 / 0) {
                      if (E) {
                        for (p = w(a / 864e5), l = w(p / 365.2425) + 1970 - 1; E(l + 1, 0) <= p; l++) {
                          ;
                        }

                        for (f = w((p - E(l, 0)) / 30.42); E(l, f + 1) <= p; f++) {
                          ;
                        }

                        p = 1 + p - E(l, f), g = w((m = (a % 864e5 + 864e5) % 864e5) / 36e5) % 24, b = w(m / 6e4) % 60, y = w(m / 1e3) % 60, x = m % 1e3;
                      } else l = a.getUTCFullYear(), f = a.getUTCMonth(), p = a.getUTCDate(), g = a.getUTCHours(), b = a.getUTCMinutes(), y = a.getUTCSeconds(), x = a.getUTCMilliseconds();

                      a = (l <= 0 || l >= 1e4 ? (l < 0 ? "-" : "+") + _(6, l < 0 ? -l : l) : _(4, l)) + "-" + _(2, f + 1) + "-" + _(2, p) + "T" + _(2, g) + ":" + _(2, b) + ":" + _(2, y) + "." + _(3, x) + "Z";
                    } else a = null;
                    ...
                    if ("object" == _typeof(a)) {
                      ...
                      if (s.push(a), C = [], k = i, i += o, "[object Array]" == c) {
                        for (q = 0, j = a.length; q < j; q++) {
                          A = O(q, a, r, n, o, i, s), C.push(void 0 === A ? "null" : A);
                        }

                        N = C.length ? o ? "[\n" + i + C.join(",\n" + i) + "\n" + k + "]" : "[" + C.join(",") + "]" : "[]";
                      } else _d(n || a, function (e) {
                        var t = O(e, a, r, n, o, i, s);
                        void 0 !== t && C.push(S(e) + ":" + (o ? " " : "") + t);
                      }), N = C.length ? o ? "{\n" + i + C.join(",\n" + i) + "\n" + k + "}" : "{" + C.join(",") + "}" : "{}";
                  ...
                  r.stringify = function (e, r, n) {
                    var o, i, s, a;
                    if (t[_typeof(r)] && r) if ("[object Function]" == (a = v.call(r))) i = r;else if ("[object Array]" == a) {
                      s = {};

                      for (var c, l = 0, u = r.length; l < u; c = r[l++], ("[object String]" == (a = v.call(c)) || "[object Number]" == a) && (s[c] = 1)) {
                        ;
                      }
                    }
                    if (n) if ("[object Number]" == (a = v.call(n))) {
                ...
                if (!b("json-parse")) {
                  var A,
                    ...
                    throw A = q = null, l();
                      ...
                      T = function T() {
                    for (var e, t, r, n, o, i = q, s = i.length; A < s;) {
                      switch (o = i.charCodeAt(A)) {
                        ...
                        case 58:
                        case 44:
                          return e = y ? i.charAt(A) : i[A], A++, e;

                        case 34:
                          for (e = "@", A++; A < s;) {
                            if ((o = i.charCodeAt(A)) < 32) N();else if (92 == o) switch (o = i.charCodeAt(++A)) {
                              case 92:
                              case 34:
                              case 47:
                              case 98:
                              ...
                              case 117:
                                for (t = ++A, r = A + 4; A < r; A++) {
                                  (o = i.charCodeAt(A)) >= 48 && o <= 57 || o >= 97 && o <= 102 || o >= 65 && o <= 70 || N();
                                }
                              ...
                              for (o = i.charCodeAt(A), t = A; o >= 32 && 92 != o && 34 != o;) {
                                o = i.charCodeAt(++A);
                              }
                        ...
                        default:
                          if (t = A, 45 == o && (n = !0, o = i.charCodeAt(++A)), o >= 48 && o <= 57) {
                            for (48 == o && (o = i.charCodeAt(A + 1)) >= 48 && o <= 57 && N(), n = !1; A < s && (o = i.charCodeAt(A)) >= 48 && o <= 57; A++) {
                              ;
                            }

                            if (46 == i.charCodeAt(A)) {
                              for (r = ++A; r < s && (o = i.charCodeAt(r)) >= 48 && o <= 57; r++) {
                                ;
                              }
                            ...
                            if (101 == (o = i.charCodeAt(A)) || 69 == o) {
                              for (43 != (o = i.charCodeAt(++A)) && 45 != o || A++, r = A; r < s && (o = i.charCodeAt(r)) >= 48 && o <= 57; r++) {
                                ;
                              }
                          ...
                          if (n && N(), "true" == i.slice(A, A + 4)) return A += 4, !0;
                    ...
                    if ("$" == e && N(), "string" == typeof e) {
                      ...
                      if ("{" == e) {
                        for (t = {}; "}" != (e = T()); r || (r = !0)) {
                          r && ("," == e ? "}" == (e = T()) && N() : N()), "," != e && "string" == typeof e && "@" == (y ? e.charAt(0) : e[0]) && ":" == T() || N(), t[e.slice(1)] = L(T());
                        }
                    ...
                    var n,
                        o = e[t];
                    if ("object" == _typeof(o) && o) if ("[object Array]" == v.call(o)) for (n = o.length; n--;) {
                      D(o, n, r);
                    } else _d(o, function (e) {
                      D(o, e, r);
                    });
                    return r.call(e, t, o);
                  };
                  ...
                  r.parse = function (e, t) {
                    var r, n;
                    return A = 0, q = "" + e, r = L(T()), "$" != T() && N(), A = q = null, t && "[object Function]" == v.call(t) ? R(((n = {})[""] = r, n), "", t) : r;
                  };
                }
              }
      ...
      61: [function (e, r, n) {
        (function (t) {
          ...
          function l(e) {
            ...
            if ("blob:" === e.protocol) o = new f(unescape(e.pathname), {});else if ("string" === i) for (r in o = new f(e, {}), c) {
              delete o[r];
            } else if ("object" === i) {
              for (r in e) {
                r in c || (o[r] = e[r]);
          ...
          function f(e, t, r) {
            ...
            for ("object" !== v && "string" !== v && (r = t, t = null), r && "function" != typeof r && (r = o.parse), t = l(t), i = !(s = u(e || "")).protocol && !s.slashes, g.slashes = s.slashes || i && t.slashes, g.protocol = s.protocol || t.protocol || "", e = s.rest, s.slashes || (m[3] = [/(.*)/, "pathname"]); b < m.length; b++) {
              "function" != typeof (p = m[b]) ? (c = p[0], d = p[1], c != c ? g[d] = e : "string" == typeof c ? ~(h = e.indexOf(c)) && ("number" == typeof p[2] ? (g[d] = e.slice(0, h), e = e.slice(h + p[2])) : (g[d] = e.slice(h), e = e.slice(0, h))) : (h = c.exec(e)) && (g[d] = h[1], e = e.slice(0, h.index)), g[d] = g[d] || i && p[3] && t[d] || "", p[4] && (g[d] = g[d].toLowerCase())) : e = p(e);
            }

            r && (g.query = r(g.query)), i && t.slashes && "/" !== g.pathname.charAt(0) && ("" !== g.pathname || "" !== t.pathname) && (g.pathname = function (e, t) {
            ...
            }(g.pathname, t.pathname)), n(g.port, g.protocol) || (g.host = g.hostname, g.port = ""), g.username = g.password = "", g.auth && (p = g.auth.split(":"), g.username = p[0] || "", g.password = p[1] || ""), g.origin = g.protocol && g.host && "file:" !== g.protocol ? g.protocol + "//" + g.host : "null", g.href = g.toString();
          }
          ...
          f.prototype = {
            ...
            toString: function toString(e) {
              ...
              var i = n + (r.slashes ? "//" : "");
              return r.username && (i += r.username, r.password && (i += ":" + r.password), i += "@"), i += r.host + r.pathname, (t = "object" == _typeof(r.query) ? e(r.query) : r.query) && (i += "?" !== t.charAt(0) ? "?" + t : t), r.hash && (i += r.hash), i;
            }
          }, f.extractProtocol = u, f.location = l, f.qs = o, r.exports = f;
        }).call(this, void 0 !== t ? t : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {});
      }, {
        querystringify: 59,
        "requires-port": 60
  ...
  function l(e) {
    a ? e(a) : (c = e, s || (s = function (e) {
      var t = document.createElement("iframe");
      return t.id = "webpack-dev-server-client-overlay", t.src = "about:blank", t.style.position = "fixed", t.style.left = 0, t.style.top = 0, t.style.right = 0, t.style.bottom = 0, t.style.width = "100vw", t.style.height = "100vh", t.style.border = "none", t.style.zIndex = 9999999999, t.onload = e, t;
    }(function () {
      var e, t;
      (t = (e = s).contentDocument.createElement("div")).id = "webpack-dev-server-client-overlay-div", t.style.position = "fixed", t.style.boxSizing = "border-box", t.style.left = 0, t.style.top = 0, t.style.right = 0, t.style.bottom = 0, t.style.width = "100vw", t.style.height = "100vh", t.style.backgroundColor = "rgba(0, 0, 0, 0.85)", t.style.color = "#E8E8E8", t.style.fontFamily = "Menlo, Consolas, monospace", t.style.fontSize = "large", t.style.padding = "2rem", t.style.lineHeight = "1.2", t.style.whiteSpace = "pre-wrap", t.style.overflow = "auto", e.contentDocument.body.appendChild(t), c(a = t);
    }), document.body.appendChild(s)));
  }

  n.setColors(i), e.exports = {
    clear: function clear() {
      a && (document.body.removeChild(s), a = null, s = null, c = null);
    },
    showMessage: function showMessage(e) {
      l(function (t) {
        t.innerHTML = '<span style="color: #'.concat(i.red, '">Failed to compile.</span><br><br>').concat(n(o.encode(e[0])));
      });
    }
  };
}, function (e, t, r) {
  ...
  [0, 21, 22, 27, 28, 39, 49].forEach(function (e) {
    ...
    if ("object" != _typeof(e)) throw new Error("`colors` parameter must be an Object.");
    var t = {};
  ...
  })) : (c.tags.open = s, c.tags.close = a), c.reset();
}, function (e, t, r) {
  "use strict";
    ...
    return e.prototype.encode = function (e) {
      ...
      for (var t = e.length, r = "", n = 0; n < t;) {
        var i = e.charCodeAt(n),
            s = o[i];
        s ? (r += "&" + s + ";", n++) : (r += i < 32 || i > 126 ? "&#" + i + ";" : e.charAt(n), n++);
      }
  ...
  !function () {
    for (var e = 0, t = n.length; e < t;) {
      var r = n[e],
          a = o[e];
      i[r] = String.fromCharCode(a), s[a] = r, e++;
    }
  }();
  ...
  !function (e, t) {
    ...
    for (; r--;) {
      var o = n[r],
          ...
          s = o[1],
          a = s[0],
          c = a < 32 || a > 126 || 62 === a || 60 === a || 38 === a || 34 === a || 39 === a,
          l = void 0;

      if (c && (l = t[a] = t[a] || {}), s[1]) {
        var u = s[1];
        e[i] = String.fromCharCode(a) + String.fromCharCode(u), c && (l[u] = i);
      } else e[i] = String.fromCharCode(a), c && (l[""] = i);
    }
  }(o, i);
    ...
    void 0 === (o = "function" == typeof (n = function n() {
      ...
      function l(e, t, n) {
        ...
        e && (a += ":" + e), i.name = e, i.levels = {
          ...
          ERROR: 4,
          SILENT: 5
        }, i.methodFactory = n || c, i.getLevel = function () {
          return o;
          ...
          }(t), s.call(i, t, e), "undefined" == typeof console && t < i.levels.SILENT) return "No console available for logging";
      ...
      u.getLogger = function (e) {
        ...
        var t = f[e];
        return t || (t = f[e] = new l(e, u.getLevel(), u.methodFactory)), t;
      };
  ...
  e.exports = function (e, t) {
    var o = e.hotReload,
        ...
        a = t.isUnloading,
        c = t.currentHash;
    if (!a && o) if (i) n.info("[WDS] App hot update..."), r(18).emit("webpackHotUpdate", c), "undefined" != typeof self && self.window && self.postMessage("webpackHotUpdate".concat(c), "*");else if (s) var l = self,
        u = self.setInterval(function () {
      ("about:" !== l.location.protocol || (l = l.parent).parent === l) && f(l, u);
    });

    function f(e, t) {
      clearInterval(t), n.info("[WDS] App updated. Reloading..."), e.location.reload();
    }
  };
}, function (e, t, r) {
  var n = r(19);
  ...
  function f(e, t, r, n) {
    var o, i, s, a;
    if (l(r), void 0 === (i = e._events) ? (i = e._events = Object.create(null), e._eventsCount = 0) : (void 0 !== i.newListener && (e.emit("newListener", t, r.listener ? r.listener : r), i = e._events), s = i[t]), void 0 === s) s = i[t] = r, ++e._eventsCount;else if ("function" == typeof s ? s = i[t] = n ? [r, s] : [s, r] : n ? s.unshift(r) : s.push(r), (o = u(e)) > 0 && s.length > o && !s.warned) {
      s.warned = !0;
  ...
  e.exports = function (e, t) {
    var r;
    if ("string" == typeof e && "" !== e) r = n.parse(e.substr(1).replace("&", "?"), !0);else {
      var i = o();
      r = n.parse(i || "/", !0, !0);
    }
    return function (e, t) {
      var r = e.auth,
          ...
          a = e.port;
      a && "0" !== a || (a = t.port);
      "0.0.0.0" !== i && "::" !== i || !t.hostname || 0 !== t.protocol.indexOf("http") || (i = t.hostname);
      !i || "127.0.0.1" === i || "https:" !== t.protocol && "0.0.0.0" !== e.hostname || (s = t.protocol);
      var c = o.sockHost || i,
    ...
    }(r, t = "string" == typeof t && "" !== t ? n.parse(t) : self.location);
  };
}, function (e, t, r) {
  "use strict";
  ...
  i.prototype.parse = function (e, t, r) {
    ...
    if (!v[x] && (C || x && !g[x])) {
      for (var _, S, O = -1, A = 0; A < p.length; A++) {
        -1 !== (q = y.indexOf(p[A])) && (-1 === O || q < O) && (O = q);
      }

      -1 !== (S = -1 === O ? y.lastIndexOf("@") : y.lastIndexOf("@", O)) && (_ = y.slice(0, S), y = y.slice(S + 1), this.auth = decodeURIComponent(_)), O = -1;

      for (A = 0; A < f.length; A++) {
        var q;
        -1 !== (q = y.indexOf(f[A])) && (-1 === O || q < O) && (O = q);
      }
      ...
      if (!j) for (var k = this.hostname.split(/\./), N = (A = 0, k.length); A < N; A++) {
        var T = k[A];

        if (T && !T.match(h)) {
          for (var L = "", D = 0, R = T.length; D < R; D++) {
          ...
          if (!L.match(h)) {
            var I = k.slice(0, A),
                U = k.slice(A + 1),
                F = T.match(d);
            F && (I.push(F[1]), U.unshift(F[2])), U.length && (y = "/" + U.join(".") + y), this.hostname = I.join(".");
            break;
          }
        }
      }
      ...
      var P = this.port ? ":" + this.port : "",
          M = this.hostname || "";
      this.host = M + P, this.href += this.host, j && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== y[0] && (y = "/" + y));
    }

    if (!m[E]) for (A = 0, N = u.length; A < N; A++) {
      var V = u[A];
    ...
    if (-1 !== G ? (this.search = y.substr(G), this.query = y.substr(G + 1), t && (this.query = b.parse(this.query)), y = y.slice(0, G)) : t && (this.search = "", this.query = {}), y && (this.pathname = y), g[E] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
      P = this.pathname || "";
      var W = this.search || "";
      this.path = P + W;
    }
    ...
    return t && ":" !== t.substr(-1) && (t += ":"), this.slashes || (!t || g[t]) && !1 !== i ? (i = "//" + (i || ""), r && "/" !== r.charAt(0) && (r = "/" + r)) : i || (i = ""), n && "#" !== n.charAt(0) && (n = "#" + n), a && "?" !== a.charAt(0) && (a = "?" + a), t + i + (r = r.replace(/[?#]/g, function (e) {
    ...
    if (_ && (r.hostname = "", r.port = null, r.host && ("" === C[0] ? C[0] = r.host : C.unshift(r.host)), r.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === d[0] ? d[0] = e.host : d.unshift(e.host)), e.host = null), x = x && ("" === d[0] || "" === C[0])), w) r.host = e.host || "" === e.host ? e.host : r.host, r.hostname = e.hostname || "" === e.hostname ? e.hostname : r.hostname, r.search = e.search, r.query = e.query, C = d;else if (d.length) C || (C = []), C.pop(), C = C.concat(d), r.search = e.search, r.query = e.query;else if (!o.isNullOrUndefined(e.search)) {
      if (_) r.hostname = r.host = C.shift(), (j = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) && (r.auth = j.shift(), r.host = r.hostname = j.shift());
    ...
    for (var S = C.slice(-1)[0], O = (r.host || e.host || C.length > 1) && ("." === S || ".." === S) || "" === S, A = 0, q = C.length; q >= 0; q--) {
      "." === (S = C[q]) ? C.splice(q, 1) : ".." === S ? (C.splice(q, 1), A++) : A && (C.splice(q, 1), A--);
    }
    ...
    _ && (r.hostname = r.host = k ? "" : C.length ? C.shift() : "", (j = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) && (r.auth = j.shift(), r.host = r.hostname = j.shift()));
    return (x = x || r.host && C.length) && !k && C.unshift(""), C.length ? r.pathname = C.join("/") : (r.pathname = null, r.path = null), o.isNull(r.pathname) && o.isNull(r.search) || (r.path = (r.pathname ? r.pathname : "") + (r.search ? r.search : "")), r.auth = e.auth || r.auth, r.slashes = r.slashes || e.slashes, r.href = r.format(), r;
  ...
  (function (e, n) {
    ...
    !function (i) {
      ...
      function E(e) {
        ...
        for (o = r > 0 ? r + 1 : 0; o < v;) {
          for (i = g, s = 1, a = 36; o >= v && m("invalid-input"), ((l = (p = e.charCodeAt(o++)) - 48 < 10 ? p - 22 : p - 65 < 26 ? p - 65 : p - 97 < 26 ? p - 97 : 36) >= 36 || l > h((c - g) / s)) && m("overflow"), g += l * s, !(l < (u = a <= w ? 1 : a >= w + 26 ? 26 : a - w)); a += 36) {
            s > h(c / (f = 36 - u)) && m("overflow"), s *= f;
          }

          w = x(g - i, t = d.length + 1, 0 == i), h(g / t) > c - b && m("overflow"), b += h(g / t), g %= t, d.splice(g++, 0, b);
        }
      ...
      function C(e) {
        ...
        for (v = (e = b(e)).length, t = 128, r = 0, i = 72, s = 0; s < v; ++s) {
          (p = e[s]) < 128 && C.push(d(p));
        }

        for (n = o = C.length, o && C.push("-"); n < v;) {
          for (a = c, s = 0; s < v; ++s) {
            (p = e[s]) >= t && p < a && (a = p);
          }

          for (a - t > h((c - r) / (g = n + 1)) && m("overflow"), r += (a - t) * g, t = a, s = 0; s < v; ++s) {
            if ((p = e[s]) < t && ++r > c && m("overflow"), p == t) {
              for (l = r, u = 36; !(l < (f = u <= i ? 1 : u >= i + 26 ? 26 : u - i)); u += 36) {
                E = l - f, y = 36 - f, C.push(d(w(f + E % y, 0))), l = h(E / y);
              }

              C.push(d(w(l, 0))), i = x(r, g, n == o), r = 0, ++n;
            }
          }
  ...
  e.exports = function (e, t, r, i) {
    ...
    for (var u = 0; u < l; ++u) {
      var f,
          ...
          m = e[u].replace(a, "%20"),
          v = m.indexOf(r);
      v >= 0 ? (f = m.substr(0, v), p = m.substr(v + 1)) : (f = m, p = ""), h = decodeURIComponent(f), d = decodeURIComponent(p), n(s, h) ? o(s[h]) ? s[h].push(d) : s[h] = [s[h], d] : s[h] = d;
    }
  ...
  e.exports = function (e, t, r, a) {
    return t = t || "&", r = r || "=", null === e && (e = void 0), "object" == _typeof(e) ? i(s(e), function (s) {
  ...
  }, o.resolve = i, e.exports = o, o.id = 29;
}, function (e, t) {
  var r = "info";
  ...
  e.exports.group = i(s), e.exports.groupCollapsed = i(a), e.exports.groupEnd = i(c), e.exports.setLogLevel = function (e) {
    r = e;
