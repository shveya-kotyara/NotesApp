...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports.SockJS = e() : t.SockJS = e();
}(window, function () {
  return function (t) {
    var e = {};
      ...
      (function () {
        var i = n(44),
          ...
          object: !0
            ...
            a = s[_typeof(e)] && e && !e.nodeType && e,
            c = s[typeof window === "undefined" ? "undefined" : _typeof(window)] && window || this,
            u = a && s[_typeof(t)] && t && !t.nodeType && "object" == _typeof(r) && r;
        ...
        function l(t, e) {
          ...
          var n = t.Number || c.Number,
              ...
              f = t.Math || c.Math,
              h = t.JSON || c.JSON;
          "object" == _typeof(h) && h && (e.stringify = h.stringify, e.parse = h.parse);
          var p = o.prototype,
              d = p.toString,
              m = p.hasOwnProperty;
          ...
          function b(t) {
            ...
            var o;
            if ("bug-string-char-index" == t) o = "a" != "a"[0];else if ("json" == t) o = b("json-stringify") && b("date-serialization") && b("json-parse");else if ("date-serialization" == t) {
              if (o = b("json-stringify") && y) {
                var s = e.stringify;
                v(function () {
                  o = '"-271821-04-20T00:00:00.000Z"' == s(new i(-864e13)) && '"+275760-09-13T00:00:00.000Z"' == s(new i(864e13)) && '"-000001-01-01T00:00:00.000Z"' == s(new i(-621987552e5)) && '"1969-12-31T23:59:59.999Z"' == s(new i(-1));
                });
              }
            } else {
              var a,
              ...
              if ("json-stringify" == t) {
                ...
                u && ((a = function a() {
                  ...
                  u = "0" === s(0) && "0" === s(new n()) && '""' == s(new r()) && void 0 === s(d) && void 0 === s(void 0) && void 0 === s() && "1" === s(a) && "[1]" == s([a]) && "[null]" == s([void 0]) && "null" == s(null) && "[null,null,null]" == s([void 0, d, null]) && s({
                    a: [a, !0, !1, null, "\0\b\n\f\r\t"]
                  }) == c && "1" === s(null, a) && "[\n 1,\n 2\n]" == s([1, 2], null, 1);
                }, function () {
                  u = !1;
              ...
              if ("json-parse" == t) {
                ...
                "function" == typeof f && v(function () {
                  0 !== f("0") || f(!1) || (a = f(c), (l = 5 == a.a.length && 1 === a.a[0]) && (v(function () {
                    l = !f('"\t"');
                  }), l && v(function () {
                    l = 1 !== f("01");
                  }), l && v(function () {
          ...
          if (v(function () {
            ...
            var g = b("bug-string-char-index"),
              ...
              return n = r = null, i ? _w = function w(t, e) {
                var n,
                    r,
                    o = "[object Function]" == d.call(t);

                for (n in t) {
                  o && "prototype" == n || !m.call(t, n) || (r = "constructor" === n) || e(n);
                }

                (r || m.call(t, n = "constructor")) && e(n);
              } : (r = ["valueOf", "toString", "toLocaleString", "propertyIsEnumerable", "isPrototypeOf", "hasOwnProperty", "constructor"], _w = function w(t, e) {
                var n,
                    o,
                    i = "[object Function]" == d.call(t),
                    a = !i && "function" != typeof t.constructor && s[_typeof(t.hasOwnProperty)] && t.hasOwnProperty || m;
            ...
            if (!b("json-stringify") && !b("date-serialization")) {
              var x = {
                ...
                if (y) e = function e(t) {
                  n = t.getUTCFullYear(), r = t.getUTCMonth(), o = t.getUTCDate(), s = t.getUTCHours(), a = t.getUTCMinutes(), c = t.getUTCSeconds(), u = t.getUTCMilliseconds();
                };else {
                  var l = f.floor,
                      h = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
                      p = function p(t, e) {
                    return h[e] + 365 * (t - 1970) + l((t - 1969 + (e = +(e > 1))) / 4) - l((t - 1901 + e) / 100) + l((t - 1601 + e) / 400);
                  };

                  e = function e(t) {
                    for (o = l(t / 864e5), n = l(o / 365.2425) + 1970 - 1; p(n + 1, 0) <= o; n++) {
                      ;
                    }
                ...
                return (_E = function E(t) {
                  return t > -1 / 0 && t < 1 / 0 ? (e(t), t = (n <= 0 || n >= 1e4 ? (n < 0 ? "-" : "+") + _(6, n < 0 ? -n : n) : _(4, n)) + "-" + _(2, r + 1) + "-" + _(2, o) + "T" + _(2, s) + ":" + _(2, a) + ":" + _(2, c) + "." + _(3, u) + "Z", n = r = o = s = a = c = u = null) : t = null, t;
                })(t);
              };
              ...
              if (b("json-stringify") && !b("date-serialization")) {
                ...
                var T = function T(t) {
                  ...
                  return n || "\\u00" + _(2, e.toString(16));
                    ...
                    j = /[\x00-\x1f\x22\x5c]/g,
                    C = function C(t) {
                  return j.lastIndex = 0, '"' + (j.test(t) ? t.replace(j, T) : t) + '"';
                },
                    N = function N(t, e, n, r, o, s, a) {
                  var c, l, f, h, p, m, y, b, g;
                  if (v(function () {
                    c = e[t];
                  }), "object" == _typeof(c) && c && (c.getUTCFullYear && "[object Date]" == d.call(c) && c.toJSON === i.prototype.toJSON ? c = _E(c) : "function" == typeof c.toJSON && (c = c.toJSON(t))), n && (c = n.call(e, t, c)), null == c) return void 0 === c ? c : "null";

                  switch ("object" == (l = _typeof(c)) && (f = d.call(c)), f || l) {
                    case "boolean":
                    case "[object Boolean]":
                      return "" + c;
                  ...
                  if ("object" == _typeof(c)) {
                    ...
                    if (a.push(c), h = [], b = s, s += o, "[object Array]" == f) {
                      for (m = 0, y = c.length; m < y; m++) {
                        p = N(m, c, n, r, o, s, a), h.push(void 0 === p ? "null" : p);
                      }

                      g = h.length ? o ? "[\n" + s + h.join(",\n" + s) + "\n" + b + "]" : "[" + h.join(",") + "]" : "[]";
                    } else _w(r || c, function (t) {
                      var e = N(t, c, n, r, o, s, a);
                      void 0 !== e && h.push(C(t) + ":" + (o ? " " : "") + e);
                    }), g = h.length ? o ? "{\n" + s + h.join(",\n" + s) + "\n" + b + "}" : "{" + h.join(",") + "}" : "{}";
                ...
                e.stringify = function (t, e, n) {
                  var r, o, i, a;
                  if (s[_typeof(e)] && e) if ("[object Function]" == (a = d.call(e))) o = e;else if ("[object Array]" == a) {
                    i = {};
                  ...
                  if (n) if ("[object Number]" == (a = d.call(n))) {
                    if ((n -= n % 1) > 0) for (n > 10 && (n = 10), r = ""; r.length < n;) {
                      r += " ";
                    }
            ...
            if (!b("json-parse")) {
              var A,
                ...
                throw A = k = null, a();
                  ...
                  R = function R() {
                for (var t, e, n, r, o, i = k, s = i.length; A < s;) {
                  switch (o = i.charCodeAt(A)) {
                    ...
                    case 58:
                    case 44:
                      return t = g ? i.charAt(A) : i[A], A++, t;

                    case 34:
                      for (t = "@", A++; A < s;) {
                        if ((o = i.charCodeAt(A)) < 32) L();else if (92 == o) switch (o = i.charCodeAt(++A)) {
                          case 92:
                          case 34:
                          case 47:
                          case 98:
                          ...
                          case 117:
                            for (e = ++A, n = A + 4; A < n; A++) {
                              (o = i.charCodeAt(A)) >= 48 && o <= 57 || o >= 97 && o <= 102 || o >= 65 && o <= 70 || L();
                            }
                          ...
                          for (o = i.charCodeAt(A), e = A; o >= 32 && 92 != o && 34 != o;) {
                            o = i.charCodeAt(++A);
                          }
                    ...
                    default:
                      if (e = A, 45 == o && (r = !0, o = i.charCodeAt(++A)), o >= 48 && o <= 57) {
                        for (48 == o && (o = i.charCodeAt(A + 1)) >= 48 && o <= 57 && L(), r = !1; A < s && (o = i.charCodeAt(A)) >= 48 && o <= 57; A++) {
                          ;
                        }
                      ...
                      r && L();
                      var a = i.slice(A, A + 4);
                      if ("true" == a) return A += 4, !0;
                      if ("fals" == a && 101 == i.charCodeAt(A + 4)) return A += 5, !1;
                      if ("null" == a) return A += 4, null;
                      L();
                  }
                }
                ...
                if ("$" == t && L(), "string" == typeof t) {
                  ...
                  if ("[" == t) {
                    for (e = []; "]" != (t = R());) {
                      n ? "," == t ? "]" == (t = R()) && L() : L() : n = !0, "," == t && L(), e.push(M(t));
                    }
                  ...
                  if ("{" == t) {
                    for (e = {}; "}" != (t = R());) {
                      n ? "," == t ? "}" == (t = R()) && L() : L() : n = !0, "," != t && "string" == typeof t && "@" == (g ? t.charAt(0) : t[0]) && ":" == R() || L(), e[t.slice(1)] = M(R());
                    }
                ...
                var r,
                    o = t[e];
                if ("object" == _typeof(o) && o) if ("[object Array]" == d.call(o)) for (r = o.length; r--;) {
                  U(d, _w, o);
                } else _w(o, function (t) {
                  U(o, t, n);
                });
                return n.call(t, e, o);
              };
              ...
              e.parse = function (t, e) {
                var n, r;
                return A = 0, k = "" + t, n = M(R()), "$" != R() && L(), A = k = null, e && "[object Function]" == d.call(e) ? D(((r = {})[""] = n, r), "", e) : n;
              };
            }
          }
        ...
        if (!u || u.global !== u && u.window !== u && u.self !== u || (c = u), a && !i) l(c, a);else {
          var f = c.JSON,
              h = c.JSON3,
              p = !1,
              d = l(c, c.JSON3 = {
    ...
    (function (e) {
      ...
      t.exports = {
        attachEvent: function attachEvent(t, n) {
        ...
        detachEvent: function detachEvent(t, n) {
    ...
    t.exports = {
      string: function string(t) {
        for (var e = "abcdefghijklmnopqrstuvwxyz012345".length, n = r.randomBytes(t), o = [], i = 0; i < t; i++) {
    ...
    (function (e) {
      ...
      t.exports = {
        ...
        postMessage: function postMessage(n, r) {
        ...
        createIframe: function createIframe(t, n) {
          var o,
              i,
          ...
          }, e.document.body.appendChild(s), o = setTimeout(function () {
            u("timeout");
        ...
        createHtmlfile: function createHtmlfile(n, o) {
          var i,
              s,
              a,
            ...
            clearTimeout(i), a.onerror = null;
              ...
              f = function f() {
            u && (l(), r.unloadDel(s), a.parentNode.removeChild(a), a = u = null, CollectGarbage());
          },
              h = function h(t) {
            u && (f(), o(t));
          };

          u.open(), u.write('<html><script>document.domain="' + e.document.domain + '";<\/script></html>'), u.close(), u.parentWindow[t.exports.WPrefix] = e[t.exports.WPrefix];
          var p = u.createElement("div");
          return u.body.appendChild(p), a = u.createElement("iframe"), p.appendChild(a), a.src = n, a.onerror = function () {
            h("onerror");
      ...
      }, t.exports.iframeEnabled = !1, e.document && (t.exports.iframeEnabled = ("function" == typeof e.postMessage || "object" == _typeof(e.postMessage)) && !i.isKonqueror());
    }).call(this, n(1));
  }, function (t, e, n) {
    "use strict";
    ...
    (function (e) {
      ...
      o(c, r), c.prototype._start = function (t, n, r) {
        var o = this,
            s = new e.XDomainRequest();
        n = a.addQuery(n, "t=" + +new Date()), s.onerror = function () {
          o._error();
        ...
        this._cleanup(!0);
      }, c.enabled = !(!e.XDomainRequest || !s.hasDomain()), t.exports = c;
    }).call(this, n(1));
  }, function (t, e, n) {
    "use strict";
    ...
    (function (e) {
      ...
      function f(t) {
        ...
        if ("blob:" === t.protocol) o = new p(unescape(t.pathname), {});else if ("string" === s) for (n in o = new p(t, {}), l) {
          delete o[n];
        } else if ("object" === s) {
          for (n in t) {
            n in l || (o[n] = t[n]);
      ...
      function p(t, e, n) {
        ...
        for ("object" !== y && "string" !== y && (n = e, e = null), n && "function" != typeof n && (n = o.parse), e = f(e), i = !(s = h(t || "")).protocol && !s.slashes, b.slashes = s.slashes || i && e.slashes, b.protocol = s.protocol || e.protocol || "", t = s.rest, s.slashes || (v[3] = [/(.*)/, "pathname"]); g < v.length; g++) {
          "function" != typeof (l = v[g]) ? (a = l[0], m = l[1], a != a ? b[m] = t : "string" == typeof a ? ~(d = t.indexOf(a)) && ("number" == typeof l[2] ? (b[m] = t.slice(0, d), t = t.slice(d + l[2])) : (b[m] = t.slice(d), t = t.slice(0, d))) : (d = a.exec(t)) && (b[m] = d[1], t = t.slice(0, d.index)), b[m] = b[m] || i && l[3] && e[m] || "", l[4] && (b[m] = b[m].toLowerCase())) : t = l(t);
        }

        n && (b.query = n(b.query)), i && e.slashes && "/" !== b.pathname.charAt(0) && ("" !== b.pathname || "" !== e.pathname) && (b.pathname = function (t, e) {
          if ("" === t) return e;
        ...
        }(b.pathname, e.pathname)), r(b.port, b.protocol) || (b.host = b.hostname, b.port = ""), b.username = b.password = "", b.auth && (l = b.auth.split(":"), b.username = l[0] || "", b.password = l[1] || ""), b.origin = b.protocol && b.host && "file:" !== b.protocol ? b.protocol + "//" + b.host : "null", b.href = b.toString();
      }
      ...
      p.prototype = {
        ...
        toString: function toString(t) {
          ...
          var i = r + (n.slashes ? "//" : "");
          return n.username && (i += n.username, n.password && (i += ":" + n.password), i += "@"), i += n.host + n.pathname, (e = "object" == _typeof(n.query) ? t(n.query) : n.query) && (i += "?" !== e.charAt(0) ? "?" + e : e), n.hash && (i += n.hash), i;
        }
      }, p.extractProtocol = h, p.location = f, p.trimLeft = c, p.qs = o, t.exports = p;
    }).call(this, n(1));
  }, function (t, e, n) {
    "use strict";
    ...
    r.prototype.addEventListener = function (t, e) {
      ...
      if (this["on" + e] && this["on" + e].apply(this, n), e in this._listeners) for (var r = this._listeners[e], o = 0; o < r.length; o++) {
        r[o].apply(this, n);
      }
    }, t.exports = r;
  }, function (t, e, n) {
    ...
    (function (e) {
      ...
      o(c, r), c.prototype._start = function (t, e, n, r) {
        ...
        if (r && r.noCredentials || !c.supportsCORS || (this.xhr.withCredentials = !0), r && r.headers) for (var u in r.headers) {
    ...
    function f(t, e, n) {
      ...
      i.call(this);
      var r = this;
      this.origin = a.getOrigin(n), this.baseUrl = n, this.transUrl = e, this.transport = t, this.windowId = l.string(8);
    ...
    t.exports = [n(34), n(39), n(21), n(22), n(14)(n(22)), n(26), n(14)(n(26)), n(27), n(46), n(14)(n(27)), n(47)];
  }, function (t, e, n) {
    "use strict";
    ...
    (function (e) {
      ...
      }, u.transportName = "xhr-streaming", u.roundTrips = 2, u.needBody = !!e.document, t.exports = u;
    }).call(this, n(1));
  }, function (t, e, n) {
    "use strict";
    ...
    (function (e) {
      ...
      a(u, c), u.prototype.abort = function () {
        ...
        if (s.id = "a" + o.string(8), s.src = t, s.type = "text/javascript", s.charset = "UTF-8", s.onerror = this._scriptError.bind(this), s.onload = function () {
        ...
        }, void 0 === s.async && e.document.attachEvent) if (i.isOpera()) (n = this.script2 = e.document.createElement("script")).text = "try{var a = document.getElementById('" + s.id + "'); if(a)a.onerror();}catch(x){};", s.async = n.async = !1;else {
          try {
        ...
        a.insertBefore(s, a.firstChild), n && a.insertBefore(n, a.firstChild);
      }, t.exports = u;
    }).call(this, n(1));
  }, function (t, e, n) {
    "use strict";
    ...
    (function (e) {
      ...
      t.exports = function (t, n, a) {
        r || ((r = e.document.createElement("form")).style.display = "none", r.style.position = "absolute", r.method = "POST", r.enctype = "application/x-www-form-urlencoded", r.acceptCharset = "UTF-8", (o = e.document.createElement("textarea")).name = "d", r.appendChild(o), e.document.body.appendChild(r));
        var c = "a" + i.string(8);
    ...
    (function (e) {
      ...
      function x(t, e, n) {
        ...
        v.call(this), this.readyState = x.CONNECTING, this.extensions = "", this.protocol = "", (n = n || {}).protocols_whitelist && d.warn("'protocols_whitelist' is DEPRECATED. Use 'transports' instead."), this._transportsWhitelist = n.transports, this._transportOptions = n.transportOptions || {}, this._timeout = n.timeout || 0;
        var r = n.sessionId || 8;
      ...
      i(x, v), x.prototype.close = function (t, e) {
        ...
        if ("string" != typeof t && (t = "" + t), this.readyState === x.CONNECTING) throw new Error("InvalidStateError: The connection has not been established yet");
        this.readyState === x.OPEN && this._transport.send(c.quote(t));
      }, x.version = n(25), x.CONNECTING = 0, x.OPEN = 1, x.CLOSING = 2, x.CLOSED = 3, x.prototype._receiveInfo = function (t, e) {
        if (this._ir = null, t) {
        ...
        for (var t = this._transports.shift(); t; t = this._transports.shift()) {
          if (t.transportName, t.needBody && (!e.document.body || void 0 !== e.document.readyState && "complete" !== e.document.readyState && "interactive" !== e.document.readyState)) return this._transports.unshift(t), void l.attachEvent("load", this._connect.bind(this));
        ...
        this.transport, this._transport && (this._transport.removeAllListeners(), this._transport = null, this.transport = null), _(t) || 2e3 === t || this.readyState !== x.CONNECTING ? this._close(t, e) : this._connect();
      }, x.prototype._open = function () {
        this._transport && this._transport.transportName, this.readyState, this.readyState === x.CONNECTING ? (this._transportTimeoutId && (clearTimeout(this._transportTimeoutId), this._transportTimeoutId = null), this.readyState = x.OPEN, this.transport = this._transport.transportName, this.dispatchEvent(new m("open")), this.transport) : this._close(1006, "Server lost session");
      }, x.prototype._close = function (t, e, n) {
        this.transport, this.readyState;
        var r = !1;
        if (this._ir && (r = !0, this._ir.close(), this._ir = null), this._transport && (this._transport.close(), this._transport = null, this.transport = null), this.readyState === x.CLOSED) throw new Error("InvalidStateError: SockJS has already been closed");
        this.readyState = x.CLOSING, setTimeout(function () {
          this.readyState = x.CLOSED, r && this.dispatchEvent(new m("error"));
          var o = new b("close");
    ...
    var p = function p(t, e, n) {
      for (var o in e) {
        i.hasOwnProperty.call(e, o) && r(t, o, e[o], n);
      }
    },
        d = function d(t) {
    ...
    p(s, {
      bind: function bind(t) {
        ...
        for (var n = c.call(arguments, 1), r = function r() {
        ...
        }, o = Math.max(0, e.length - n.length), i = [], s = 0; s < o; s++) {
          i.push("$" + s);
        }

        var a = Function("binder", "return function (" + i.join(",") + "){ return binder.apply(this, arguments); }")(r);
        return e.prototype && (v.prototype = e.prototype, a.prototype = new v(), v.prototype = null), a;
      }
    }), p(Array, {
    ...
    }, (y = o.forEach, b = !0, g = !0, y && (y.call("foo", function (t, e, n) {
    ...
    p(o, {
      indexOf: function indexOf(t) {
        ...
        for (arguments.length > 1 && (r = m(arguments[1])), r = r >= 0 ? r : Math.max(0, n + r); r < n; r++) {
    ...
    var E,
        S = a.split;
    2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(/()()/).length > 1 ? (E = void 0 === /()??/.exec("")[1], a.split = function (t, e) {
      var n = this;
      ...
      for (t = new RegExp(t.source, l + "g"), n += "", E || (r = new RegExp("^" + t.source + "$(?!\\s)", l)), e = void 0 === e ? -1 >>> 0 : e >>> 0; (i = t.exec(n)) && !((s = i.index + i[0].length) > f && (c.push(n.slice(f, i.index)), !E && i.length > 1 && i[0].replace(r, function () {
        for (var t = 1; t < arguments.length - 2; t++) {
          void 0 === arguments[t] && (i[t] = void 0);
        }
      }), i.length > 1 && i.index < n.length && o.push.apply(c, i.slice(1)), a = i[0].length, f = s, c.length >= e));) {
        t.lastIndex === i.index && t.lastIndex++;
      }

      return f === n.length ? !a && t.test("") || c.push("") : c.push(n.slice(f)), c.length > e ? c.slice(0, e) : c;
    ...
    o(h, r), h._getReceiver = function (t, e, n) {
      return n.sameOrigin ? new f(e, c) : a.enabled ? new f(e, a) : s.enabled && n.sameScheme ? new f(e, s) : l.enabled() ? new l(t, e) : new f(e, u);
    }, h.prototype.doXhr = function (t, e) {
      var n = this,
          r = i.addPath(t, "/info");
      this.xo = h._getReceiver(t, r, e), this.timeoutRef = setTimeout(function () {
        n._cleanup(!1), n.emit("finish");
      }, h.timeout), this.xo.once("finish", function (t, e) {
    ...
    n(0)(o, r), o.prototype.close = function () {
    ...
    t.exports = function (t, e) {
      ...
      }), l[a.transportName] = a, t.bootstrap_iframe = function () {
        var e;
          ...
          if (o.source === parent && (void 0 === n && (n = o.origin), o.origin === n)) {
            ...
            if (a.windowId === c.currentWindowId) switch (a.type) {
              case "s":
                ...
                if (!r.isOriginEqual(d, u.href) || !r.isOriginEqual(m, u.href)) throw new Error("Can't connect to different domain from within an iframe. (" + u.href + ", " + d + ", " + m + ")");
                e = new s(new l[p](d, m));
                break;
