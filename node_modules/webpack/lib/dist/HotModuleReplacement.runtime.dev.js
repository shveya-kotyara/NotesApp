  ...
  function hotCreateModule(moduleId) {
    var hot = {
      ...
      accept: function accept(dep, callback) {
        if (dep === undefined) hot._selfAccepted = true;else if (typeof dep === "function") hot._selfAccepted = dep;else if (_typeof(dep) === "object") for (var i = 0; i < dep.length; i++) {
          hot._acceptedDependencies[dep[i]] = callback || function () {};
        } else hot._acceptedDependencies[dep] = callback || function () {};
      },
      decline: function decline(dep) {
        if (dep === undefined) hot._selfDeclined = true;else if (_typeof(dep) === "object") for (var i = 0; i < dep.length; i++) {
