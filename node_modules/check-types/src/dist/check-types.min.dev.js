...
!function (n) {
  ...
  function P(n, t) {
    ...
    for (r in t) {
      if (t.hasOwnProperty(r)) {
        if (!1 === n.hasOwnProperty(r) || _typeof(n[r]) != _typeof(t[r])) return !1;
  ...
  r = {
    ...
    f: function f(n) {
      ...
      return "string" == (t = _typeof(n)) || "number" === t || b && "symbol" === t;
    },
    s: "v"
  }, {
    n: "includes",
    ...
    return m;
  }) : "undefined" != typeof module && null !== module && module.exports ? module.exports = m : n.check = m;
}(void 0);