...
!function (u, D) {
  ...
  var D = u(function (u) {
    ...
    return "object" == _typeof(u) ? null !== u : "function" == typeof u;
  }),
      r = function r(u) {
  ...
  var h,
    ...
    var e,
      ...
      return u;
        ...
        F = w(D),
        n = r.length;
    return F < 0 || F >= n ? h ? "" : void 0 : (e = r.charCodeAt(F)) < 55296 || e > 56319 || F + 1 === n || (t = r.charCodeAt(F + 1)) < 56320 || t > 57343 ? h ? r.charAt(F) : e : h ? r.slice(F, F + 2) : t - 56320 + (e - 55296 << 10) + 65536;
  });
  ...
  function Du() {
    ...
    if (null !== u && "object" == _typeof(u)) O.push(u), I = Array.isArray(u) ? "beforeArrayValue" : "beforePropertyName";else {
      var e = O[O.length - 1];
  ...
  return {
    parse: function parse(u, D) {
      ...
      return "function" == typeof D ? function u(D, e, t) {
        var r = D[e];
        if (null != r && "object" == _typeof(r)) for (var F in r) {
          var n = u(r, F, t);
    ...
    stringify: function stringify(u, D, e) {
      var t,
          ...
          C = "",
          A = "";
      if (null == D || "object" != _typeof(D) || Array.isArray(D) || (e = D.space, F = D.quote, D = D.replacer), "function" == typeof D) r = D;else if (Array.isArray(D)) {
        t = [];
      ...
      function c(u, D) {
        ...
        return "string" == typeof e ? B(e) : "number" == typeof e ? String(e) : "object" == _typeof(e) ? Array.isArray(e) ? function (u) {
