...
var apply_extends_1 = require("./apply-extends");

var middleware_1 = require("./middleware");

var processArgv = require("./process-argv");

var is_promise_1 = require("./is-promise");

var Parser = require("yargs-parser");

var y18nFactory = require("y18n");
...
function Yargs() {
  ...
  var parentRequire = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : require;
  var self = {};
  var command;
  var completion = null;
  var groups = {};
  ...
  self.resetOptions = self.reset = function resetOptions() {
    ...
    objectOptions.forEach(function (k) {
      tmpOptions[k] = obj_filter_1.objFilter(options[k], function (k) {
        return !localLookup[k];
      });
    });
  ...
  function populateParserHintDictionary(builder, type, key, value, singleKeyHandler) {
    if (Array.isArray(key)) {
      ...
      try {
        for (var _iterator = common_types_1.objectKeys(key)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var k = _step.value;
          builder(k, key[k]);
        }
      } catch (err) {
  ...
  function deleteFromParserHintObject(optionKey) {
    ...
    common_types_1.objectKeys(options).forEach(function (hintKey) {
  ...
  function pkgUp(rootPath) {
    ...
    try {
      var startDir = rootPath || requireMainFilename(parentRequire); // When called in an environment that lacks require.main.filename, such as a jest test runner,
  ...
  self.option = self.options = function option(key, opt) {
    ...
    if (_typeof(key) === 'object') {
      ...
      var demand = opt.demand || opt.required || opt.require; // A required option can be specified via "demand: true".
  ...
  self.positional = function (key, opts) {
    ...
    opts = obj_filter_1.objFilter(opts, function (k, v) {
    ...
    common_types_1.objectKeys(parseOptions).forEach(function (pk) {
