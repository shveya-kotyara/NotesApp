...
var ReexportTemplate = {
  loose: _template["default"].statement(_templateObject4()),
  looseComputed: _template["default"].statement(_templateObject5()),
  spec: (0, _template["default"])(_templateObject6())
};
...
function buildESModuleHeader(metadata) {
  ...
  return (enumerable ? _template["default"].statement(_templateObject7()) : _template["default"].statement(_templateObject8()))({
    EXPORTS: metadata.exportName
  });
}

function buildNamespaceReexport(metadata, namespace, loose) {
  return (loose ? _template["default"].statement(_templateObject9()) : _template["default"].statement(_templateObject10()))({
    NAMESPACE: namespace,
    EXPORTS: metadata.exportName,
