...
var flow = function flow(superClass) {
  ...
  function (_superClass2) {
    ...
    function _temp(options, input) {
      ...
      _this3 = _possibleConstructorReturn(this, _getPrototypeOf(_temp).call(this, options, input));
    ...
    _createClass(_temp, [{
      ...
      value: function toAssignable(node) {
        if (node.type === "TypeCastExpression") {
          return _get(_getPrototypeOf(_temp.prototype), "toAssignable", this).call(this, this.typeCastToParameter(node));
        } else {
          return _get(_getPrototypeOf(_temp.prototype), "toAssignable", this).call(this, node);
        }
      }
    }, {
      ...
      value: function toAssignableList(exprList, trailingCommaPos) {
        ...
        return _get(_getPrototypeOf(_temp.prototype), "toAssignableList", this).call(this, exprList, trailingCommaPos);
      }
    }, {
      ...
      value: function checkLVal(expr) {
        ...
        if (expr.type !== "TypeCastExpression") {
          return _get(_getPrototypeOf(_temp.prototype), "checkLVal", this).call(this, expr, bindingType, checkClashes, contextDescription);
        }
      }
    }, {
    ...
    function (_superClass4) {
      ...
      _createClass(_class3, [{
        ...
        value: function parseArrayLike() {
          ...
          var node = (_get2 = _get(_getPrototypeOf(_class3.prototype), "parseArrayLike", this)).call.apply(_get2, [this].concat(args));
        ...
        value: function parseObjPropValue(prop) {
          ...
          (_get3 = _get(_getPrototypeOf(_class3.prototype), "parseObjPropValue", this)).call.apply(_get3, [this, prop].concat(args));
        }
      }, {
        key: "parseFunctionParams",
        value: function parseFunctionParams(node, allowModifiers) {
        ...
        value: function parseMaybeAssign() {
          ...
          if (this.match(types.jsxTagStart)) {
            ...
            jsx = this.tryParse(function () {
              ...
              return (_get4 = _get(_getPrototypeOf(_class3.prototype), "parseMaybeAssign", _this35)).call.apply(_get4, [_this35].concat(args));
            }, state);
            if (!jsx.error) return jsx.node;
            var context = this.state.context;
          ...
          if (!((_jsx = jsx) == null ? void 0 : _jsx.error) && !this.isRelational("<")) {
            ...
            return (_get5 = _get(_getPrototypeOf(_class3.prototype), "parseMaybeAssign", this)).call.apply(_get5, [this].concat(args));
          }
          ...
          var arrow = this.tryParse(function (abort) {
            ...
            var expr = (_get6 = _get(_getPrototypeOf(_class3.prototype), "parseMaybeAssign", _this35)).call.apply(_get6, [_this35].concat(args));
        ...
        value: function toAssignable(node) {
          switch (node.type) {
            case "TSTypeCastExpression":
              return _get(_getPrototypeOf(_class3.prototype), "toAssignable", this).call(this, this.typeCastToParameter(node));

            case "TSParameterProperty":
              return _get(_getPrototypeOf(_class3.prototype), "toAssignable", this).call(this, node);
        ...
        value: function checkLVal(expr) {
          ...
          switch (expr.type) {
            ...
            default:
              _get(_getPrototypeOf(_class3.prototype), "checkLVal", this).call(this, expr, bindingType, checkClashes, contextDescription);
        ...
        value: function parseMaybeDefault() {
          ...
          var node = (_get8 = _get(_getPrototypeOf(_class3.prototype), "parseMaybeDefault", this)).call.apply(_get8, [this].concat(args));
