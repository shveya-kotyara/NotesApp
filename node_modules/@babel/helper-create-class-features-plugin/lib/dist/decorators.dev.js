...
function buildDecoratedClass(ref, path, elements, file) {
  ...
  var replacement = _core.template.expression.ast(_templateObject2(), addDecorateHelper(file), classDecorators || _core.types.nullLiteral(), initializeId, superClass ? _core.types.cloneNode(superId) : null, node, _core.types.cloneNode(node.id), definitions, superClass);
  ...
  return {
    instanceNodes: [_core.template.statement.ast(_templateObject4(), _core.types.cloneNode(initializeId))],
