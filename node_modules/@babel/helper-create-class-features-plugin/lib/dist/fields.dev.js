...
var privateInVisitor = privateNameVisitorFactory({
  BinaryExpression: function BinaryExpression(path) {
    ...
    if (loose) {
      ...
      path.replaceWith(_core.template.expression.ast(_templateObject5(), right, _core.types.cloneNode(_id)));
      return;
    }
    ...
    path.replaceWith(_core.template.expression.ast(_templateObject7(), _core.types.cloneNode(id), right));
  }
});
...
function buildPrivateFieldInitLoose(ref, prop, privateNamesMap) {
  ...
  return _core.template.statement.ast(_templateObject9(), ref, _core.types.cloneNode(id), value);
}
...
function buildPrivateInstanceFieldInitSpec(ref, prop, privateNamesMap) {
  ...
  var value = prop.node.value || prop.scope.buildUndefinedNode();
  return _core.template.statement.ast(_templateObject10(), _core.types.cloneNode(id), ref, value);
}
...
function buildPrivateStaticFieldInitSpec(prop, privateNamesMap) {
  ...
  if (isAccessor) {
    ...
    return _core.template.statement.ast(_templateObject11(), _core.types.cloneNode(id), getId ? getId.name : prop.scope.buildUndefinedNode(), setId ? setId.name : prop.scope.buildUndefinedNode());
  }

  var value = prop.node.value || prop.scope.buildUndefinedNode();
  return _core.template.statement.ast(_templateObject12(), _core.types.cloneNode(id), value);
}
