  ...
  _createClass(Scope, [{
    ...
    value: function registerDeclaration(path) {
      if (path.isLabeledStatement()) {
        ...
        try {
          for (var _iterator7 = declarations[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
    ...
    value: function registerBinding(kind, path) {
      ...
      if (path.isVariableDeclaration()) {
        ...
        try {
          for (var _iterator9 = declarators[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
      ...
      for (var _i4 = 0, _Object$keys4 = Object.keys(ids); _i4 < _Object$keys4.length; _i4++) {
        ...
        try {
          for (var _iterator10 = ids[name][Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
    ...
    value: function isPure(node, constantsOnly) {
      if (t.isIdentifier(node)) {
        ...
        try {
          for (var _iterator11 = node.body[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
        ...
        try {
          for (var _iterator12 = node.elements[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
        ...
        try {
          for (var _iterator14 = node.expressions[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
