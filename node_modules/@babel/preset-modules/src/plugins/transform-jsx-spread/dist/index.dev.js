...
var _default = function _default(_ref) {
  ...
  function convertAttributesAssign(attributes) {
    ...
    for (var i = 0, current; i < attributes.length; i++) {
      ...
      if (t.isJSXSpreadAttribute(node)) {
        ...
        var value = getAttributeValue(node);
  ...
  return {
    ...
    visitor: {
      JSXOpeningElement: function JSXOpeningElement(path, state) {
        var useSpread = state.opts.useSpread === true;
        var hasSpread = path.node.attributes.some(function (attr) {
