...
function fixOwner(cache, filepath) {
  ...
  return BB.resolve(inferOwner(cache)).then(function (owner) {
    var uid = owner.uid,
    ...
    return inflight('fixOwner: fixing ownership on ' + filepath, function () {
      return chownr(filepath, typeof uid === 'number' ? uid : self.uid, typeof gid === 'number' ? gid : self.gid)["catch"]({
        code: 'ENOENT'
      }, function () {
        return null;
      });
...
function mkdirfix(cache, p, cb) {
  ...
  return BB.resolve(inferOwner(cache)).then(function () {
