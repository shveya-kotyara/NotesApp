  ...
  (function b(n, x, m) {
    ...
    6: [function (n, x, m) {
      m.read = function (b, e, g, h, d) {
        ...
        if (0 === g) g = 1 - r;else {
          if (g === l) return a ? NaN : Infinity * (u ? -1 : 1);
          a += Math.pow(2, h);
          g -= r;
        }
    ...
    8: [function (n, x, m) {
      (function (b) {
        ...
        m.relative = function (a, b) {
          ...
          for (var l = d(a.split("/")), v = d(b.split("/")), e = Math.min(l.length, v.length), c = e, k = 0; k < e; k++) {
            if (l[k] !== v[k]) {
              c = k;
              break;
            }
    ...
    16: [function (n, x, m) {
      ...
      e.fromSourceMap = function (a, b) {
        ...
        for (var h = a._mappings.toArray().slice(), r = c.__generatedMappings = [], m = c.__originalMappings = [], u = 0, n = h.length; u < n; u++) {
          var f = h[u],
              p = new g();
      ...
      e.prototype._parseMappings = function (a, b) {
        for (var c = 1, k = 0, e = 0, l = 0, v = 0, h = 0, m = a.length, u = 0, f = {}, p = {}, n = [], x = [], z, B, A, E, I; u < m;) {
          if (";" === a.charAt(u)) c++, u++, k = 0;else if ("," === a.charAt(u)) u++;else {
            z = new g();
            z.generatedLine = c;
    ...
    17: [function (n, x, m) {
      ...
      b.prototype._serializeMappings = function () {
        for (var a = 0, b = 1, d = 0, h = 0, m = 0, n = 0, c = "", k, w, y, F = this._mappings.toArray(), D = 0, t = F.length; D < t; D++) {
          w = F[D];
          k = "";
          if (w.generatedLine !== b) for (a = 0; w.generatedLine !== b;) {
            k += ";", b++;
          } else if (0 < D) {
            if (!g.compareByGeneratedPositionsInflated(w, F[D - 1])) continue;
            k += ",";
          }
    ...
    18: [function (n, x, m) {
      ...
      b.fromStringWithSourceMap = function (d, a, e) {
        ...
        a.eachMapping(function (a) {
          if (null !== y) if (k < a.generatedLine) l(y, c()), k++, w = 0;else {
            var b = n[u] || "",
      ...
      b.prototype.toStringWithSourceMap = function (b) {
        ...
        this.walk(function (b, e) {
          ...
          null !== e.source && null !== e.line && null !== e.column ? (n === e.source && c === e.line && k === e.column && w === e.name || h.addMapping({
            ...
            name: e.name
          }), n = e.source, c = e.line, k = e.column, w = e.name, m = !0) : m && (h.addMapping({
            generated: {
              line: d,
              column: g
            }
    ...
    21: [function (n, x, m) {
      (function (b) {
        ...
        z.push(function (a) {
          ...
          try {
            if (y) y.existsSync(a) && (b = y.readFileSync(a, "utf8"));else {
        ...
        m.install = function (a) {
          ...
          if (!t) {
            ...
            a && "object" === _typeof(b) && null !== b && "function" === typeof b.on && (t = !0, c());
          }
        };
