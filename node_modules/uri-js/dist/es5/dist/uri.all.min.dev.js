...
!function (e, r) {
  ...
  function v(e, r) {
    ...
    if (o) {
      for (var i = o.toLowerCase().split("::").reverse(), u = T(i, 2), s = u[0], f = u[1], c = f ? f.split(":").map(m) : [], p = s.split(":").map(m), h = r.IPV4ADDRESS.test(p[p.length - 1]), d = h ? 7 : 8, l = p.length - d, v = Array(d), E = 0; E < d; ++E) {
        v[E] = c[E] || p[l + E] || "";
      }
  ...
  function y(e) {
    for (var r = []; e.length;) {
      if (e.match(X)) e = e.replace(X, "");else if (e.match(ee)) e = e.replace(ee, "/");else if (e.match(re)) e = e.replace(re, "/"), r.pop();else if ("." === e || ".." === e) e = "";else {
        var n = e.match(ne);
  ...
  var F = u(!1),
    ...
    serialize: function serialize(e, r) {
      ...
      for (var m in d) {
        d[m] !== ue[m] && l.push(m.replace(de, I).replace(de, o).replace(me, h) + "=" + d[m].replace(de, I).replace(de, o).replace(ge, h));
      }
