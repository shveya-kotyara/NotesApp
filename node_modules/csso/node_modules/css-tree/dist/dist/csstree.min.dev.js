...
!function (e, t) {
  ...
  U.prototype = {
    ...
    dump: function dump() {
      ...
      return this.forEachToken(function (t, n, r, i) {
        e[i] = {
          idx: i,
          type: _[t],
          chunk: _this.source.substring(n, r),
          balance: _this.balance[i]
        };
      }), e;
    }
  };
  ...
  function Z(_ref, r) {
    ...
    if (r) {
      ...
      i.offset += r.length, i.line += _e2.length - 1, i.column = 1 === _e2.length ? i.column + r.length : _e2.pop().length + 1;
    }
  ...
  var $ = function $(e, t) {
    ...
    var i = o("SyntaxMatchError", e),
      ...
      for (var _e3 = 0; _e3 < n.length; _e3++) {
        var _t2 = n[_e3].value;
        _e3 === r && (c = _t2.length, l = h.length), null !== a && n[_e3].node === a && (_e3 <= r ? u++ : u = 0), h += _t2;
      }
      ...
      return r === n.length || u > 1 ? (o = X(a || t, "end") || Z(Q, h), s = Z(o)) : (o = X(a, "start") || Z(X(t, "start") || Q, h.slice(0, l)), s = X(a, "end") || Z(o, h.substr(l, c))), {
        ...
        a = _ref2.css,
        s = _ref2.mismatchOffset,
        l = _ref2.mismatchLength,
        c = _ref2.start,
        u = _ref2.end;
  ...
  function jt(e, t) {
    ...
    for (Ce(e, Rt); !Rt.eof;) {
      if (t) for (; i < t.length && r + t[i].len <= Rt.tokenStart;) {
      ...
      case "Multiplier":
        return function (e) {
          ...
          if (0 === e.max) n = qt(n, Wt, Ft), (t = qt(n, null, Ft)).then = qt(_t, _t, t), e.comma && (t.then["else"] = qt({
            type: "Comma",
            syntax: e
          }, t, Ft));else for (var r = e.min || 1; r <= e.max; r++) {
            e.comma && t !== _t && (t = qt({
              type: "Comma",
              syntax: e
            }, t, Ft)), t = qt(n, qt(_t, _t, t), Ft);
          }
          if (0 === e.min) t = qt(_t, _t, t);else for (r = 0; r < e.min - 1; r++) {
            e.comma && t !== _t && (t = qt({
              type: "Comma",
              syntax: e
            }, t, Ft)), t = qt(n, t, Ft);
  ...
  function gn(e, t) {
    return function (n, r) {
      ...
      for (var i in t) {
        pn.call(t, i) && !1 === pn.call(n, i) && r(n, "Field `" + e + "." + i + "` is missed");
      }
    };
  }
  ...
  function Cn(e, t, n) {
    ...
    for (var i in e) {
      e[i].syntax && (r[i] = n ? e[i].syntax : G(e[i].syntax, {
        compact: t
      }));
    }
  ...
  function zn(e, t, n) {
    ...
    for (var _i2 = 0, _Object$entries = Object.entries(e); _i2 < _Object$entries.length; _i2++) {
      ...
      r[_i3] = {
        prelude: _a2.prelude && (n ? _a2.prelude.syntax : G(_a2.prelude.syntax, {
          compact: t
        })),
        descriptors: _a2.descriptors && Cn(_a2.descriptors, t, n)
      };
    }
  ...
  var Tn = function Tn(e, t, n) {
    if (this.valueCommonSyntax = wn, this.syntax = t, this.generic = !1, this.atrules = {}, this.properties = {}, this.types = {}, this.structure = n || xn(e), e) {
      ...
      if (e.generic) for (var r in this.generic = !0, mt) {
  ...
  Tn.prototype = {
    ...
    addAtrule_: function addAtrule_(e, t) {
      ...
      t && (this.atrules[e] = {
        ...
        descriptors: t.descriptors ? Object.keys(t.descriptors).reduce(function (n, r) {
          return n[r] = _this2.createDescriptor(t.descriptors[r], "AtruleDescriptor", r, e), n;
        }, {}) : null
      });
    },
    ...
    checkAtruleName: function checkAtruleName(e) {
      if (!this.getAtrule(e)) return new bn("Unknown at-rule", "@" + e);
    },
    checkAtrulePrelude: function checkAtrulePrelude(e, t) {
      var n = this.checkAtruleName(e);
      if (n) return n;
    ...
    checkAtruleDescriptorName: function checkAtruleDescriptorName(e, t) {
      var n = this.checkAtruleName(e);
      if (n) return n;
      var r = this.getAtrule(e),
          i = ae.keyword(t);
    ...
    checkPropertyName: function checkPropertyName(e) {
    ...
    getAtrule: function getAtrule(e) {
  ...
  var $n = function $n(e) {
    ...
    return function (e, n) {
      ...
      return "function" == typeof a && t.scanner.forEachToken(function (n, r, i) {
        if (n === Un) {
          var _n2 = t.getLocation(r, i),
              _o2 = _n(e, i - 2, i, "*/") ? e.slice(r + 2, i - 2) : e.slice(r + 2, i);
  ...
  var Sr = function Sr(e) {
    ...
    for (var o in t) {
      fr.call(t, o) && null !== t[o] && (n[o] = xr(t[o], !1), r[o] = xr(t[o], !0));
    }
  ...
  var zr = Object.prototype.hasOwnProperty,
    ...
    properties: Er,
    parseContext: function parseContext(e, t) {
      return Object.assign(e, t);
    },
    scope: function e(t, n) {
      for (var _r2 in n) {
        zr.call(n, _r2) && (Pr(t[_r2]) ? e(t[_r2], Tr(n[_r2])) : t[_r2] = Tr(n[_r2]));
      }
  ...
  function Er(e, t) {
    ...
    for (var _r3 in t) {
      zr.call(t, _r3) && (n[_r3] = Lr(zr.call(e, _r3) ? e[_r3] : void 0, t[_r3]));
    }
  ...
  var Or = function Or(e, t) {
    return function e(t, n, r) {
      for (var _i4 in r) {
        if (!1 !== zr.call(r, _i4)) if (!0 === r[_i4]) _i4 in n && zr.call(n, _i4) && (t[_i4] = Tr(n[_i4]));else if (r[_i4]) if ("function" == typeof r[_i4]) {
          var _e4 = r[_i4];
          t[_i4] = _e4({}, t[_i4]), t[_i4] = _e4(t[_i4] || {}, n[_i4]);
        } else if (Pr(r[_i4])) {
          var _a3 = {};

          for (var _n3 in t[_i4]) {
            _a3[_n3] = e({}, t[_i4][_n3], r[_i4]);
          }

          for (var _t3 in n[_i4]) {
            _a3[_t3] = e(_a3[_t3] || {}, n[_i4][_t3], r[_i4]);
          }

          t[_i4] = _a3;
        } else if (Array.isArray(r[_i4])) {
          var _a4 = {},
              _o3 = r[_i4].reduce(function (e, t) {
            return e[t] = !0, e;
          }, {});

          for (var _i5 = 0, _Object$entries2 = Object.entries(t[_i4] || {}); _i5 < _Object$entries2.length; _i5++) {
            var _Object$entries2$_i = _slicedToArray(_Object$entries2[_i5], 2),
                _n4 = _Object$entries2$_i[0],
                _r4 = _Object$entries2$_i[1];

            _a4[_n4] = {}, _r4 && e(_a4[_n4], _r4, _o3);
          }

          for (var _t4 in n[_i4]) {
            zr.call(n[_i4], _t4) && (_a4[_t4] || (_a4[_t4] = {}), n[_i4] && n[_i4][_t4] && e(_a4[_t4], n[_i4][_t4], _o3));
          }
  ...
  var ua = {
    ...
    parse: function parse() {
      ...
      var l = this.scanner.tokenIndex;
      if (i || this.scanner.skipSC(), e = a ? this.parseWithFallback(ca, o) : o.call(this, this.scanner.tokenIndex), i && "Value" === e.type && e.children.isEmpty()) for (var _t5 = l - this.scanner.tokenIndex; _t5 <= 0; _t5++) {
        if (this.scanner.lookupType(_t5) === oa) {
  ...
  var ka = {
    ...
    parse: function parse(e) {
      ...
      for (this.scanner.skipSC(); !this.scanner.eof && (t.push(this.MediaQuery(e)), this.scanner.tokenType === Va);) {
        this.scanner.next();
      }
  ...
  var To = {
    ...
    parse: function parse() {
      for (var e = this.createList(); !this.scanner.eof && (e.push(this.Selector()), this.scanner.tokenType === Lo);) {
        this.scanner.next();
      }
    ...
    Value: {
      ...
      "var": function _var() {
        ...
        if (this.scanner.skipSC(), e.push(this.Identifier()), this.scanner.skipSC(), this.scanner.tokenType === qs) {
          ...
          var _t6 = this.scanner.tokenIndex,
              _n5 = this.parseCustomProperty ? this.Value(null) : this.Raw(this.scanner.tokenIndex, Ws.exclamationMarkOrSemicolon, !1);

          if ("Value" === _n5.type && _n5.children.isEmpty()) for (var _e5 = _t6 - this.scanner.tokenIndex; _e5 <= 0; _e5++) {
            if (this.scanner.lookupType(_e5) === Ys) {
              _n5.children.appendData({
                type: "WhiteSpace",
                loc: null,
                value: " "
              });
