...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : (global = global || self, factory(global.csso = {}));
    ...
    !function (e, t) {
      ...
      function K(e, t, n, r) {
        ...
        switch (e.type) {
          ...
          case "Multiplier":
            return K(e.term, t, n, r) + t(0 === (i = e).min && 0 === i.max ? "*" : 0 === i.min && 1 === i.max ? "?" : 1 === i.min && 0 === i.max ? i.comma ? "#" : "+" : 1 === i.min && 1 === i.max ? "" : (i.comma ? "#" : "") + (i.min === i.max ? "{" + i.min + "}" : "{" + i.min + "," + (0 !== i.max ? i.max : "") + "}"), e);
      ...
      var G = function G(e, t) {
        var n = V,
            r = !1,
            a = !1;
        return "function" == typeof t ? n = t : t && (r = Boolean(t.forceBraces), a = Boolean(t.compact), "function" == typeof t.decorate && (n = t.decorate)), K(e, n, r, a);
      };
      ...
      var X = function X(e, t) {
        ...
        return a.rawMessage = e, a.syntax = t ? G(t) : "<generic>", a.css = h, a.mismatchOffset = s, a.loc = {
      ...
      var re = {
        keyword: function keyword(e) {
          if ($.call(J, e)) return J[e];
          var t = e.toLowerCase();
          if ($.call(J, t)) return J[e] = J[t];
          var n = te(t, 0),
              r = n ? "" : ne(t, 0);
        ...
        property: function property(e) {
          if ($.call(ee, e)) return ee[e];
          var t = e,
              n = e[0];
          "/" === n ? n = "/" === e[1] ? "//" : "/" : "_" !== n && "*" !== n && "$" !== n && "#" !== n && "+" !== n && "&" !== n && (n = "");
          var r = te(t, n.length);
          if (!r && (t = t.toLowerCase(), $.call(ee, t))) return ee[e] = ee[t];
          var a = r ? "" : ne(t, n.length),
        ...
        vendorPrefix: ne
          ...
          ae = "undefined" != typeof Uint32Array ? Uint32Array : Array,
          ie = function ie(e, t) {
        return null === e || e.length < t ? new ae(Math.max(t + 1024, 16384)) : e;
      },
          oe = h.TYPE,
          se = z.isNewline,
          le = z.isName,
          ce = z.isValidEscape,
          ue = z.isNumberStart,
          he = z.isIdentifierStart,
          pe = z.charCodeCategory,
          de = z.isBOM,
          me = M.cmpStr,
          ge = M.getNewlineLength,
      ...
      function xe(e, t) {
        ...
        function r() {
          return h = ke(e, h), he(n(h), n(h + 1), n(h + 2)) ? (f = oe.Dimension, void (h = ye(e, h))) : 37 === n(h) ? (f = oe.Percentage, void h++) : void (f = oe.Number);
        }

        function a() {
          var t = h;
          return h = ye(e, h), me(e, t, h, "url") && 40 === n(h) ? 34 === n(h = fe(e, h + 1)) || 39 === n(h) ? (f = oe.Function, void (h = t + 4)) : void function () {
            for (f = oe.Url, h = fe(e, h); h < e.length; h++) {
              ...
              switch (pe(t)) {
                ...
                case pe.WhiteSpace:
                  return 41 === n(h = fe(e, h)) || h >= e.length ? void (h < e.length && h++) : (h = ve(e, h), void (f = oe.BadUrl));

                case 34:
                case 39:
                case 40:
                case pe.NonPrintable:
                  return h = ve(e, h), void (f = oe.BadUrl);
          ...
          }() : 40 === n(h) ? (f = oe.Function, void h++) : void (f = oe.Ident);
        }

        function i(t) {
          for (t || (t = n(h++)), f = oe.String; h < e.length; h++) {
            ...
            switch (pe(r)) {
              ...
              case pe.WhiteSpace:
                if (se(r)) return h += ge(e, h, r), void (f = oe.BadString);
                break;

              case 92:
                if (h === e.length - 1) break;
                var a = n(h + 1);
                se(a) ? h += ge(e, h + 1, a) : ce(r, a) && (h = be(e, h) - 1);
            }
          }
        }
        ...
        for (var o = (e = String(e || "")).length, s = ie(t.offsetAndType, o + 1), l = ie(t.balance, o + 1), c = 0, u = de(n(0)), h = u, p = 0, d = 0, m = 0; h < o;) {
          var g = e.charCodeAt(h),
              f = 0;

          switch (l[c] = o, pe(g)) {
            case pe.WhiteSpace:
              f = oe.WhiteSpace, h = fe(e, h + 1);
              break;
            ...
            case 35:
              le(n(h + 1)) || ce(n(h + 1), n(h + 2)) ? (f = oe.Hash, h = ye(e, h + 1)) : (f = oe.Delim, h++);
              break;
            ...
            case 40:
              f = oe.LeftParenthesis, h++;
              break;

            case 41:
              f = oe.RightParenthesis, h++;
              break;

            case 43:
              ue(g, n(h + 1), n(h + 2)) ? r() : (f = oe.Delim, h++);
              break;
            ...
            case 45:
              ue(g, n(h + 1), n(h + 2)) ? r() : 45 === n(h + 1) && 62 === n(h + 2) ? (f = oe.CDC, h += 3) : he(g, n(h + 1), n(h + 2)) ? a() : (f = oe.Delim, h++);
              break;
            ...
            case 47:
              42 === n(h + 1) ? (f = oe.Comment, 1 === (h = e.indexOf("*/", h + 2) + 2) && (h = e.length)) : (f = oe.Delim, h++);
              break;
            ...
            case 60:
              33 === n(h + 1) && 45 === n(h + 2) && 45 === n(h + 3) ? (f = oe.CDO, h += 4) : (f = oe.Delim, h++);
              break;

            case 64:
              he(n(h + 1), n(h + 2), n(h + 3)) ? (f = oe.AtKeyword, h = ye(e, h + 1)) : (f = oe.Delim, h++);
              break;

            case 91:
              f = oe.LeftSquareBracket, h++;
              break;

            case 92:
              ce(g, n(h + 1)) ? a() : (f = oe.Delim, h++);
              break;

            case 93:
              f = oe.RightSquareBracket, h++;
              break;

            case 123:
              f = oe.LeftCurlyBracket, h++;
              break;

            case 125:
              f = oe.RightCurlyBracket, h++;
              break;
          ...
          switch (f) {
            ...
            case oe.Function:
              l[c] = d, d = (p = oe.RightParenthesis) << 24 | c;
              break;

            case oe.LeftSquareBracket:
              l[c] = d, d = (p = oe.RightSquareBracket) << 24 | c;
              break;

            case oe.LeftCurlyBracket:
              l[c] = d, d = (p = oe.RightCurlyBracket) << 24 | c;
          }

          s[c++] = f << 24 | h;
        }

        for (s[c] = oe.EOF << 24 | h, l[c] = o, l[o] = o; 0 !== d;) {
      ...
      function Be(e, t, n) {
        for (; null !== e && (e.type === Pe || e.type === Te);) {
          e = n(++t);
        }
      ...
      function Ne(e, t, n) {
        ...
        if (e.type !== Ee) {
          ...
          if (r = !0, a = Be(n(++a), a, n), null === (e = n(a)) && e.type !== Ee) return 0;
        }
      ...
      function Ye(e, t) {
        return null !== e && e.type === Fe && e.value.charCodeAt(0) === t;
      }
      ...
      function He(e, t, n) {
        for (var r = t, a = 0; r < e.value.length; r++) {
          ...
          if (45 === i && n && 0 !== a) return He(e, t + a + 1, !1) > 0 ? 6 : 0;
          if (!Re(i)) return 0;
          if (++a > 6) return 0;
        }
      ...
      var Ke = we.isIdentifierStart,
          Ge = we.isHexDigit,
          Qe = we.isDigit,
          Xe = we.cmpStr,
          Ze = we.consumeNumber,
          $e = we.TYPE,
          Je = ["unset", "initial", "inherit"],
          et = ["calc(", "-moz-calc(", "-webkit-calc("];
      ...
      function st(e) {
        return function (t, n, r) {
          return null === t ? 0 : t.type === $e.Function && rt(t.value, et) ? ot(t, n) : e(t, n, r);
        };
      }
        ...
        return function (t, n, r) {
          ...
          if (null !== e) {
            var i = t.value.indexOf("\\", a),
                o = -1 !== i && at(t.value, i) ? t.value.substring(a, i) : t.value.substr(a);
            if (!1 === e.hasOwnProperty(o.toLowerCase())) return 0;
          }

          return it(r, t.value, a) ? 0 : 1;
        };
      }
      ...
      var ht,
          pt = {
        "ident-token": lt($e.Ident),
        "function-token": lt($e.Function),
        "at-keyword-token": lt($e.AtKeyword),
        "hash-token": lt($e.Hash),
        "string-token": lt($e.String),
        "bad-string-token": lt($e.BadString),
        "url-token": lt($e.Url),
        "bad-url-token": lt($e.BadUrl),
        "delim-token": lt($e.Delim),
        "number-token": lt($e.Number),
        "percentage-token": lt($e.Percentage),
        "dimension-token": lt($e.Dimension),
        "whitespace-token": lt($e.WhiteSpace),
        "CDO-token": lt($e.CDO),
        "CDC-token": lt($e.CDC),
        "colon-token": lt($e.Colon),
        "semicolon-token": lt($e.Semicolon),
        "comma-token": lt($e.Comma),
        "[-token": lt($e.LeftSquareBracket),
        "]-token": lt($e.RightSquareBracket),
        "(-token": lt($e.LeftParenthesis),
        ")-token": lt($e.RightParenthesis),
        "{-token": lt($e.LeftCurlyBracket),
        "}-token": lt($e.RightCurlyBracket),
        string: lt($e.String),
        ident: lt($e.Ident),
        "custom-ident": function customIdent(e) {
          if (null === e || e.type !== $e.Ident) return 0;
          var t = e.value.toLowerCase();
          return rt(t, Je) || nt(t, "default") ? 0 : 1;
        },
        "custom-property-name": function customPropertyName(e) {
          return null === e || e.type !== $e.Ident || 45 !== tt(e.value, 0) || 45 !== tt(e.value, 1) ? 0 : 1;
        },
        "hex-color": function hexColor(e) {
          ...
          for (var n = 1; n < t; n++) {
            if (!Ge(e.value.charCodeAt(n))) return 0;
          }

          return 1;
        },
        "id-selector": function idSelector(e) {
          return null === e || e.type !== $e.Hash ? 0 : Ke(tt(e.value, 1), tt(e.value, 2), tt(e.value, 3)) ? 1 : 0;
        },
        "an-plus-b": function anPlusB(e, t) {
          var n = 0;
          if (!e) return 0;
          if (e.type === Ee) return Ie(e, 0, !1, n);
          ...
          if (e.type === Le && 45 === e.value.charCodeAt(0)) {
            ...
            switch (e.value.length) {
              ...
              case 3:
                return 45 !== e.value.charCodeAt(2) ? 0 : (n = Be(t(++n), n, t), Ie(e = t(n), 0, !0, n));

              default:
                return 45 !== e.value.charCodeAt(2) ? 0 : Ie(e, 3, !0, n);
            }
          } else if (e.type === Le || Oe(e, 43) && t(n + 1).type === Le) {
            if (e.type !== Le && (e = t(++n)), null === e || !Ce(e.value, 0, 110)) return 0;
            ...
            switch (e.value.length) {
              ...
              case 2:
                return 45 !== e.value.charCodeAt(1) ? 0 : (n = Be(t(++n), n, t), Ie(e = t(n), 0, !0, n));

              default:
                return 45 !== e.value.charCodeAt(1) ? 0 : Ie(e, 2, !0, n);
            }
          } else if (e.type === De) {
            for (var r = e.value.charCodeAt(0), a = 43 === r || 45 === r ? 1 : 0, i = a; i < e.value.length && Se(e.value.charCodeAt(i)); i++) {
              ;
            }

            return i === a ? 0 : Ce(e.value, i, 110) ? i + 1 === e.value.length ? Ne(t(++n), n, t) : 45 !== e.value.charCodeAt(i + 1) ? 0 : i + 2 === e.value.length ? (n = Be(t(++n), n, t), Ie(e = t(n), 0, !0, n)) : Ie(e, i + 2, !0, n) : 0;
          }
        ...
        urange: function urange(e, t) {
          var n = 0;
          if (null === e || e.type !== _e || !Me(e.value, 0, 117)) return 0;
          if (null === (e = t(++n))) return 0;
          if (Ye(e, 43)) return null === (e = t(++n)) ? 0 : e.type === _e ? Ve(He(e, 0, !0), ++n, t) : Ye(e, 63) ? Ve(1, ++n, t) : 0;

          if (e.type === We) {
            if (!Ue(e, 43)) return 0;
            var r = He(e, 1, !0);
            return 0 === r ? 0 : null === (e = t(++n)) ? n : e.type === qe || e.type === We ? Ue(e, 45) && He(e, 1, !1) ? n + 1 : 0 : Ve(r, n, t);
          }

          return e.type === qe && Ue(e, 43) ? Ve(He(e, 1, !0), ++n, t) : 0;
        },
        ...
        percentage: st(function (e, t, n) {
          return null === e || e.type !== $e.Percentage || it(n, e.value, e.value.length - 1) ? 0 : 1;
        }),
        zero: ut(),
        number: st(function (e, t, n) {
          if (null === e) return 0;
          var r = Ze(e.value, 0);
          return r === e.value.length || at(e.value, r) ? it(n, e.value, r) ? 0 : 1 : 0;
        }),
        integer: st(function (e, t, n) {
          ...
          return it(n, e.value, r) ? 0 : 1;
        }),
        "-ms-legacy-expression": (ht = "expression", ht += "(", function (e, t) {
          return null !== e && nt(e.value, ht) ? ot(e, t) : 0;
        })
      },
      ...
      mt.prototype = {
        ...
        error: function error(e) {
          throw new dt(e, this.str, this.pos);
        }
      };
      ...
      function wt(e) {
        var t,
            n = null;
        return e.eat(123), t = vt(e), 44 === e.charCode() ? (e.pos++, 125 !== e.charCode() && (n = vt(e))) : n = t, e.eat(125), {
          min: Number(t),
          max: n ? Number(n) : 0
        };
      }
      ...
      function St(e, t) {
        var n = function (e) {
          ...
          switch (e.charCode()) {
            ...
            case 35:
              e.pos++, n = !0, t = 123 === e.charCode() ? wt(e) : {
                min: 1,
                max: 0
              };
              break;
      ...
      function zt(e) {
        var t,
            n = null;
        return e.eat(60), t = kt(e), 40 === e.charCode() && 41 === e.nextCharCode() && (e.pos += 2, t += "()"), 91 === e.charCodeAt(e.findWsEnd(e.pos)) && (yt(e), n = function (e) {
          var t = null,
              n = null,
              r = 1;
          return e.eat(91), 45 === e.charCode() && (e.peek(), r = -1), -1 == r && 8734 === e.charCode() ? e.peek() : t = r * Number(vt(e)), yt(e), e.eat(44), yt(e), 8734 === e.charCode() ? e.peek() : (r = 1, 45 === e.charCode() && (e.peek(), r = -1), n = r * Number(vt(e))), e.eat(93), null === t && null === n ? null : {
            type: "Range",
            min: t,
            max: n
          };
      ...
      function Tt(e) {
        var t = e.charCode();
        if (t < 128 && 1 === ft[t]) return function (e) {
          var t;
          return t = kt(e), 40 === e.charCode() ? (e.pos++, {
            type: "Function",
            name: t
          }) : St(e, {
            type: "Keyword",
        ...
        switch (t) {
          ...
          case 91:
            return St(e, function (e) {
              var t;
              return e.eat(91), t = Pt(e), e.eat(93), t.explicit = !0, 33 === e.charCode() && (e.pos++, t.disallowEmpty = !0), t;
            }(e));

          case 60:
            return 39 === e.nextCharCode() ? function (e) {
              var t;
              return e.eat(60), e.eat(39), t = kt(e), e.eat(39), e.eat(62), St(e, {
                type: "Property",
                name: t
              });
            }(e) : zt(e);
          ...
          case 64:
            return (t = e.nextCharCode()) < 128 && 1 === ft[t] ? (e.pos++, {
              type: "AtKeyword",
              name: kt(e)
            }) : Ct(e);
          ...
          case 123:
            if ((t = e.nextCharCode()) < 48 || t > 57) return Ct(e);
            break;
      ...
      var Bt = function Bt(e, t, n) {
        var r = Dt,
            a = Dt;
        if ("function" == typeof t ? r = t : t && (r = Ot(t.enter), a = Ot(t.leave)), r === Dt && a === Dt) throw new Error("Neither `enter` nor `leave` walker handler is set or both aren't a function");
        !function e(t) {
      ...
      function Rt(e, t) {
        ...
        for (we(e, It); !It.eof;) {
          if (t) for (; a < t.length && r + t[a].len <= It.tokenStart;) {
            r += t[a++].len, i = t[a].node;
          }
          n.push({
            type: It.tokenType,
            value: It.getTokenValue(),
            index: It.tokenIndex,
            balance: It.balance[It.tokenIndex],
            node: i
          }), It.next();
        }
      ...
      function Ft(e, t, n) {
        return t === Mt && n === jt || e === Mt && t === Mt && n === Mt ? e : ("If" === e.type && e["else"] === jt && t === Mt && (t = e.then, e = e.match), {
          type: "If",
          match: e,
          then: t,
          "else": n
      ...
      function qt(e) {
        return "Keyword" === e.type || "AtKeyword" === e.type || "Function" === e.type || "Type" === e.type && Wt(e.name);
      }
        ...
        switch (e.type) {
          case "Group":
            var t = function e(t, n, r) {
              switch (t) {
                case " ":
                  for (var a = Mt, i = n.length - 1; i >= 0; i--) {
                    a = Ft(l = n[i], a, jt);
                  }
                ...
                case "|":
                  ...
                  for (i = n.length - 1; i >= 0; i--) {
                    if (qt(l = n[i]) && (null === o && i > 0 && qt(n[i - 1]) && (a = Ft({
                      type: "Enum",
                      map: o = Object.create(null)
                    }, Mt, a)), null !== o)) {
                      var s = (Wt(l.name) ? l.name.slice(0, -1) : l.name).toLowerCase();
                ...
                case "||":
                  ...
                  for (a = r ? Mt : jt, i = n.length - 1; i >= 0; i--) {
                    var c;
                    l = n[i];
                    c = n.length > 1 ? e(t, n.filter(function (e) {
                      return e !== l;
            ...
            return e.disallowEmpty && (t = Ft(t, _t, jt)), t;

          case "Multiplier":
            return function (e) {
              var t = Mt,
                  n = Yt(e.term);
              if (0 === e.max) n = Ft(n, _t, jt), (t = Ft(n, null, jt)).then = Ft(Mt, Mt, t), e.comma && (t.then["else"] = Ft({
                type: "Comma",
                syntax: e
              }, t, jt));else for (var r = e.min || 1; r <= e.max; r++) {
                e.comma && t !== Mt && (t = Ft({
                  type: "Comma",
                  syntax: e
                }, t, jt)), t = Ft(n, Ft(Mt, Mt, t), jt);
              }
              if (0 === e.min) t = Ft(Mt, Mt, t);else for (r = 0; r < e.min - 1; r++) {
                e.comma && t !== Mt && (t = Ft({
                  type: "Comma",
                  syntax: e
                }, t, jt)), t = Ft(n, t, jt);
      ...
      function tn(e) {
        return null === e || e.type === $t.Comma || e.type === $t.Function || e.type === $t.LeftParenthesis || e.type === $t.LeftSquareBracket || e.type === $t.LeftCurlyBracket || function (e) {
          return e.type === $t.Delim && "?" !== e.value;
        }(e);
      }

      function nn(e) {
        return null === e || e.type === $t.RightParenthesis || e.type === $t.RightSquareBracket || e.type === $t.RightCurlyBracket || e.type === $t.Delim;
      }
      ...
      function rn(e, t, n) {
        function r() {
          ...
          } while (null !== f && (f.type === $t.WhiteSpace || f.type === $t.Comment));
        }
        ...
        for (r(); null === g && ++m < 15e3;) {
          switch (t.type) {
            ...
            case "Enum":
              if (null !== f) if (-1 !== (A = f.value.toLowerCase()).indexOf("\\") && (A = A.replace(/\\[09].*$/, "")), Gt.call(t.map, A)) {
                t = t.map[A];
                break;
              }
              t = Xt;
            ...
            case "Property":
              var C = "Type" === t.type ? "types" : "properties",
                  z = Gt.call(n, C) ? n[C][t.name] : null;
              if (!z || !z.match) throw new Error("Bad syntax reference: " + ("Type" === t.type ? "<" + t.name + ">" : "<'" + t.name + "'>"));
              if (!1 !== d && null !== f && "Type" === t.type) if ("custom-ident" === t.name && f.type === $t.Ident || "length" === t.name && "0" === f.value) {
                null === d && (d = i(t, p)), t = Xt;
                break;
              }
              u = {
            ...
            case "Keyword":
              ...
              if (null !== f) {
                ...
                if (-1 !== P.indexOf("\\") && (P = P.replace(/\\[09].*$/, "")), en(P, A)) {
                  l(), t = Qt;
                  break;
                }
              }
            ...
            case "Comma":
              null !== f && f.type === $t.Comma ? tn(k.token) ? t = Xt : (l(), t = nn(f) ? Xt : Qt) : t = tn(k.token) || nn(f) ? Qt : Xt;
              break;
      ...
      function pn(e) {
        return Boolean(e) && hn(e.offset) && hn(e.line) && hn(e.column);
      }
      ...
      function dn(e, t) {
        return function (n, r) {
          ...
          for (var a in t) {
            un.call(t, a) && !1 === un.call(n, a) && r(n, "Field `" + e + "." + a + "` is missed");
          }
        };
      }
      ...
      var gn = X,
        ...
        return t;
          ...
          vn = bn("inherit | initial | unset"),
          xn = bn("inherit | initial | unset | <-ms-legacy-expression>");

      function wn(e, t, n) {
        var r = {};

        for (var a in e) {
          e[a].syntax && (r[a] = n ? e[a].syntax : G(e[a].syntax, {
            compact: t
          }));
        }
      ...
      function Sn(e, t, n) {
        ...
        for (var _i2 = 0, _Object$entries = Object.entries(e); _i2 < _Object$entries.length; _i2++) {
          ...
          r[_a2] = {
            prelude: _i3.prelude && (n ? _i3.prelude.syntax : G(_i3.prelude.syntax, {
              compact: t
            })),
            descriptors: _i3.descriptors && wn(_i3.descriptors, t, n)
          };
        }
      ...
      function Cn(e, t, n) {
        return {
          ...
          iterations: n,
          error: t,
          getTrace: ln.getTrace,
          isType: ln.isType,
          isProperty: ln.isProperty,
          isKeyword: ln.isKeyword
        };
      }
      ...
      function zn(e, t, n, r) {
        var a,
            i = function (e, t) {
          return "string" == typeof e ? Rt(e, null) : t.generate(e, Nt);
        }(n, e.syntax);
        ...
        return function (e) {
          ...
          return !1;
        }(i) ? Cn(null, new Error("Matching for a tree with var() is not supported")) : (r && (a = yn(i, e.valueCommonSyntax, e)), r && a.match || (a = yn(i, t.match, e)).match ? Cn(a.match, null, a.iterations) : Cn(null, new fn(a.reason, t.syntax, n, a), a.iterations));
      }

      var An = function An(e, t, n) {
        if (this.valueCommonSyntax = vn, this.syntax = t, this.generic = !1, this.atrules = {}, this.properties = {}, this.types = {}, this.structure = n || kn(e), e) {
      ...
      An.prototype = {
        ...
        createDescriptor: function createDescriptor(e, t, n) {
          ...
          return "function" == typeof e ? a.match = bn(e, r) : ("string" == typeof e ? Object.defineProperty(a, "syntax", {
            get: function get() {
        ...
        matchAtrulePrelude: function matchAtrulePrelude(e, t) {
          ...
          return r ? zn(this, r, t, !0) : n.basename in this.atrules ? Cn(null, new Error("At-rule `" + e + "` should not contain a prelude")) : Cn(null, new gn("Unknown at-rule", e));
        },
        matchAtruleDescriptor: function matchAtruleDescriptor(e, t, n) {
          ...
          return o ? zn(this, o, n, !0) : Cn(null, new gn("Unknown at-rule descriptor", t));
        },
        ...
        matchProperty: function matchProperty(e, t) {
          ...
          return r ? zn(this, r, t, !0) : Cn(null, new gn("Unknown property", e));
        },
        matchType: function matchType(e, t) {
          var n = this.getType(e);
          return n ? zn(this, n, t, !1) : Cn(null, new gn("Unknown type", e));
        },
        match: function match(e, t) {
          return "string" == typeof e || e && e.type ? ("string" != typeof e && e.match || (e = this.createDescriptor(e, "Type", "anonymous")), zn(this, e, t, !1)) : Cn(null, new gn("Bad syntax"));
        },
        findValueFragments: function findValueFragments(e, t, n, r) {
          return cn.matchFragments(this, t, this.matchProperty(e, t), n, r);
        },
        findDeclarationValueFragments: function findDeclarationValueFragments(e, t, n) {
          return cn.matchFragments(this, e.value, this.matchDeclaration(e), t, n);
        },
        ...
        validate: function validate() {
          function e(r, a, i, o) {
            ...
            i[a] = !1, null !== o.syntax && Bt(o.syntax, function (o) {
        ...
        dump: function dump(e, t) {
          return {
            ...
            types: wn(this.types, !t, e),
            properties: wn(this.properties, !t, e),
            atrules: Sn(this.atrules, !t, e)
          };
        },
      ...
      En.prototype = {
        ...
        ensureLinesAndColumnsComputed: function ensureLinesAndColumnsComputed() {
          this.linesAndColumnsComputed || (!function (e, t) {
            for (var n = t.length, r = ie(e.lines, n), a = e.startLine, i = ie(e.columns, n), o = e.startColumn, s = t.length > 0 ? Ln(t.charCodeAt(0)) : 0; s < n; s++) {
      ...
      var Xn = function Xn(e) {
        var t = {
          ...
          eat: function eat(e) {
            if (this.scanner.tokenType !== e) {
              ...
              switch (e) {
                case Yn:
                  this.scanner.tokenType === Un || this.scanner.tokenType === Hn ? (t = this.scanner.tokenEnd - 1, n = "Identifier is expected but function found") : n = "Identifier is expected";
                  break;
                ...
                case Kn:
                  this.scanner.tokenType === Gn && (t = this.scanner.tokenEnd, n = "Percent sign is expected");
                  break;
          ...
          error: function error(e, t) {
            var n = void 0 !== t && t < this.scanner.source.length ? this.locationMap.getLocation(t) : this.scanner.eof ? this.locationMap.getLocation(Rn(this.scanner.source, this.scanner.source.length - 1)) : this.locationMap.getLocation(this.scanner.tokenStart);
        ...
        return function (e, n) {
          ...
          return "function" == typeof i && t.scanner.forEachToken(function (n, r, a) {
            if (n === qn) {
              var _n2 = t.getLocation(r, a),
                  _o2 = Mn(e, a - 2, a, "*/") ? e.slice(r + 2, a - 2) : e.slice(r + 2, a);
          ...
          Zn = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split(""),
          $n = function $n(e) {
        if (0 <= e && e < Zn.length) return Zn[e];
      ...
      rr.fromArray = function (e, t) {
        ...
        var n = nr ? e : er.toSetString(e),
            r = nr ? this.has(e) : tr.call(this._set, n),
            a = this._array.length;
        r && !t || this._array.push(e), r || (nr ? this._set.set(e, a) : this._set[n] = a);
      }, rr.prototype.has = function (e) {
        if (nr) return this._set.has(e);
        var t = er.toSetString(e);
        return tr.call(this._set, t);
      }, rr.prototype.indexOf = function (e) {
        if (nr) {
          var t = this._set.get(e);

          if (t >= 0) return t;
        } else {
          var n = er.toSetString(e);
          if (tr.call(this._set, n)) return this._set[n];
        }

        throw new Error('"' + e + '" is not in the set.');
      }, rr.prototype.at = function (e) {
      ...
      ir.prototype.unsortedForEach = function (e, t) {
        this._array.forEach(e, t);
      }, ir.prototype.add = function (e) {
        var t, n, r, a, i, o;
        t = this._last, n = e, r = t.generatedLine, a = n.generatedLine, i = t.generatedColumn, o = n.generatedColumn, a > r || a == r && o >= i || er.compareByGeneratedPositionsInflated(t, n) <= 0 ? (this._last = e, this._array.push(e)) : (this._sorted = !1, this._array.push(e));
      }, ir.prototype.toArray = function () {
        return this._sorted || (this._array.sort(er.compareByGeneratedPositionsInflated), this._sorted = !0), this._array;
      };
      var or = ar.ArraySet,
          sr = {
        MappingList: ir
      ...
      function lr(e) {
        e || (e = {}), this._file = er.getArg(e, "file", null), this._sourceRoot = er.getArg(e, "sourceRoot", null), this._skipValidation = er.getArg(e, "skipValidation", !1), this._sources = new or(), this._names = new or(), this._mappings = new sr(), this._sourcesContents = null;
      }

      lr.prototype._version = 3, lr.fromSourceMap = function (e) {
        var t = e.sourceRoot,
            n = new lr({
          file: e.file,
          sourceRoot: t
        ...
        return e.eachMapping(function (e) {
          ...
          null != e.source && (r.source = e.source, null != t && (r.source = er.relative(t, r.source)), r.original = {
            line: e.originalLine,
            column: e.originalColumn
          }, null != e.name && (r.name = e.name)), n.addMapping(r);
        }), e.sources.forEach(function (r) {
          var a = r;
          null !== t && (a = er.relative(t, r)), n._sources.has(a) || n._sources.add(a);
          var i = e.sourceContentFor(r);
          null != i && n.setSourceContent(r, i);
        }), n;
      }, lr.prototype.addMapping = function (e) {
        var t = er.getArg(e, "generated"),
            n = er.getArg(e, "original", null),
            r = er.getArg(e, "source", null),
            a = er.getArg(e, "name", null);
      ...
      }, lr.prototype.setSourceContent = function (e, t) {
        var n = e;
        null != this._sourceRoot && (n = er.relative(this._sourceRoot, n)), null != t ? (this._sourcesContents || (this._sourcesContents = Object.create(null)), this._sourcesContents[er.toSetString(n)] = t) : this._sourcesContents && (delete this._sourcesContents[er.toSetString(n)], 0 === Object.keys(this._sourcesContents).length && (this._sourcesContents = null));
      }, lr.prototype.applySourceMap = function (e, t, n) {
        var r = t;
        ...
        this._mappings.unsortedForEach(function (t) {
          if (t.source === r && null != t.originalLine) {
            ...
            null != s.source && (t.source = s.source, null != n && (t.source = er.join(n, t.source)), null != a && (t.source = er.relative(a, t.source)), t.originalLine = s.line, t.originalColumn = s.column, null != s.name && (t.name = s.name));
          }
          ...
          null != r && (null != n && (t = er.join(n, t)), null != a && (t = er.relative(a, t)), this.setSourceContent(t, r));
        }, this);
      }, lr.prototype._validateMapping = function (e, t, n, r) {
      ...
      }, lr.prototype._serializeMappings = function () {
        for (var e, t, n, r, a = 0, i = 1, o = 0, s = 0, l = 0, c = 0, u = "", h = this._mappings.toArray(), p = 0, d = h.length; p < d; p++) {
          if (e = "", (t = h[p]).generatedLine !== i) for (a = 0; t.generatedLine !== i;) {
            e += ";", i++;
          } else if (p > 0) {
            if (!er.compareByGeneratedPositionsInflated(t, h[p - 1])) continue;
            e += ",";
          }
          e += Jn(t.generatedColumn - a), a = t.generatedColumn, null != t.source && (r = this._sources.indexOf(t.source), e += Jn(r - c), c = r, e += Jn(t.originalLine - 1 - s), s = t.originalLine - 1, e += Jn(t.originalColumn - o), o = t.originalColumn, null != t.name && (n = this._names.indexOf(t.name), e += Jn(n - l), l = n)), u += e;
        }

        return u;
      }, lr.prototype._generateSourcesContent = function (e, t) {
        return e.map(function (e) {
          if (!this._sourcesContents) return null;
          null != t && (e = er.relative(t, e));
          var n = er.toSetString(e);
      ...
      var dr = function dr(e) {
        function t(e) {
          if (!hr.call(n, e.type)) throw new Error("Unknown node type: " + e.type);
        ...
        return function (e, n) {
          ...
          return n && ("function" == typeof n.decorator && (a = n.decorator(a)), n.sourceMap && (a = function (e) {
            ...
            e.node = function (e) {
              if (e.loc && e.loc.start && ur.hasOwnProperty(e.type)) {
              ...
              c.call(this, e), o && ur.hasOwnProperty(e.type) && (s.line = n, s.column = r);
            };
      ...
      var xr = function xr(e) {
        ...
        for (var o in t) {
          mr.call(t, o) && null !== t[o] && (n[o] = kr(t[o], !1), r[o] = kr(t[o], !0));
        }
        ...
        var s = vr(n),
          ...
          function c(e, t, n) {
            ...
            return r === a || r !== i && (!(!d.hasOwnProperty(e.type) || !d[e.type](e, m, c, u)) || p.call(m, e, t, n) === a);
          }
          ...
          if ("function" == typeof o) h = o;else if (o && (h = fr(o.enter), p = fr(o.leave), o.reverse && (d = r), o.visit)) {
            ...
            h = br(h, o.visit), p = br(p, o.visit);
          }
          if (h === gr && p === gr) throw new Error("Neither `enter` nor `leave` walker handler is set or both aren't a function");
          c(e);
        };
      ...
      function Ar(e) {
        return zr(e) ? Object.assign({}, e) : e;
      }

      function Pr(e, t) {
        for (var n in t) {
          Sr.call(t, n) && (zr(e[n]) ? Pr(e[n], Ar(t[n])) : e[n] = Ar(t[n]));
        }
      }
      ...
      var Tr = function Tr(e, t) {
        return function e(t, n, r) {
          for (var a in r) {
            if (!1 !== Sr.call(r, a)) if (!0 === r[a]) a in n && Sr.call(n, a) && (t[a] = Ar(n[a]));else if (r[a]) {
              if (zr(r[a])) Pr(i = {}, t[a]), Pr(i, n[a]), t[a] = i;else if (Array.isArray(r[a])) {
                var i = {},
                ...
                for (var s in t[a]) {
                  Sr.call(t[a], s) && (i[s] = {}, t[a] && t[a][s] && e(i[s], t[a][s], o));
                }

                for (var s in n[a]) {
                  Sr.call(n[a], s) && (i[s] || (i[s] = {}), n[a] && n[a][s] && e(i[s], n[a][s], o));
                }
      ...
      function Lr(e) {
        var t = Xn(e),
            ...
            fromPlainObject: function fromPlainObject(t) {
              return e(t, {
                enter: function enter(e) {
                  e.children && e.children instanceof i == !1 && (e.children = new i().fromArray(e.children));
                }
              }), t;
            },
          ...
          TokenStream: H,
          Lexer: Pn,
          vendorPrefix: re.vendorPrefix,
          keyword: re.keyword,
          property: re.property,
          isCustomProperty: re.isCustomProperty,
          definitionSyntax: Tn,
          lexer: null,
          createLexer: function createLexer(e) {
            return new Pn(e, o, o.lexer.structure);
          },
          tokenize: we,
          parse: t,
          walk: n,
          ...
          fork: function fork(t) {
            var n = Tr({}, e);
            return Lr("function" == typeof t ? t(n, Object.assign) : Tr(n, t));
          }
        };

        return o.lexer = new Pn({
          generic: !0,
          types: e.types,
          atrules: e.atrules,
      ...
      function Fr(e, t) {
        ...
        for (43 !== r && 45 !== r || (t && this.error("Number sign is not allowed"), n++); n < this.scanner.tokenEnd; n++) {
          Br(this.scanner.source.charCodeAt(n)) || this.error("Integer is expected", n);
        }
      }
      ...
      function qr(e, t) {
        if (!Or(this.scanner.source, this.scanner.tokenStart + e, t)) {
          var n = "";
      ...
      function Yr() {
        for (var e = 0, t = 0, n = this.scanner.tokenType; n === Nr || n === Rr;) {
        ...
        if (n !== jr) {
          ...
          n !== jr && (this.scanner.skip(e), Wr.call(this, !0));
        }

        return e > 0 && this.scanner.skip(e), 0 === t && 43 !== (n = this.scanner.source.charCodeAt(this.scanner.tokenStart)) && 45 !== n && this.error("Number sign is expected"), Wr.call(this, 0 !== t), 45 === t ? "-" + this.consume(jr) : this.consume(jr);
      }
      ...
      var Ur = {
        ...
        parse: function parse() {
          var e = this.scanner.tokenStart,
              t = null,
              n = null;
          if (this.scanner.tokenType === jr) Wr.call(this, !1), n = this.consume(jr);else if (this.scanner.tokenType === Mr && Or(this.scanner.source, this.scanner.tokenStart, 45)) switch (t = "-1", qr.call(this, 1, 110), this.scanner.getTokenLength()) {
            case 2:
              this.scanner.next(), n = Yr.call(this);
              break;

            case 3:
              qr.call(this, 2, 45), this.scanner.next(), this.scanner.skipSC(), Wr.call(this, !0), n = "-" + this.consume(jr);
              break;

            default:
              qr.call(this, 2, 45), Fr.call(this, 3, !0), this.scanner.next(), n = this.scanner.substrToCursor(e + 2);
          } else if (this.scanner.tokenType === Mr || this.scanner.isDelim(43) && this.scanner.lookupType(1) === Mr) {
            var r = 0;

            switch (t = "1", this.scanner.isDelim(43) && (r = 1, this.scanner.next()), qr.call(this, 0, 110), this.scanner.getTokenLength()) {
              case 1:
                this.scanner.next(), n = Yr.call(this);
                break;

              case 2:
                qr.call(this, 1, 45), this.scanner.next(), this.scanner.skipSC(), Wr.call(this, !0), n = "-" + this.consume(jr);
                break;

              default:
                qr.call(this, 1, 45), Fr.call(this, 2, !0), this.scanner.next(), n = this.scanner.substrToCursor(e + r + 1);
            }
          } else if (this.scanner.tokenType === _r) {
            for (var a = this.scanner.source.charCodeAt(this.scanner.tokenStart), i = (r = 43 === a || 45 === a, this.scanner.tokenStart + r); i < this.scanner.tokenEnd && Br(this.scanner.source.charCodeAt(i)); i++) {
              ;
            }

            i === this.scanner.tokenStart + r && this.error("Integer is expected", this.scanner.tokenStart + r), qr.call(this, i - this.scanner.tokenStart, 110), t = this.scanner.source.substring(e, i), i + 1 === this.scanner.tokenEnd ? (this.scanner.next(), n = Yr.call(this)) : (qr.call(this, i - this.scanner.tokenStart + 1, 45), i + 2 === this.scanner.tokenEnd ? (this.scanner.next(), this.scanner.skipSC(), Wr.call(this, !0), n = "-" + this.consume(jr)) : (Fr.call(this, i - this.scanner.tokenStart + 2, !0), this.scanner.next(), n = this.scanner.substrToCursor(i + 1)));
          } else this.error();
        ...
        generate: function generate(e) {
          ...
          Vr = Hr.WhiteSpace,
          Kr = Hr.Semicolon,
          Gr = Hr.LeftCurlyBracket,
          Qr = Hr.Delim;

      function Xr() {
        return this.scanner.tokenIndex > 0 && this.scanner.lookupType(-1) === Vr ? this.scanner.tokenIndex > 1 ? this.scanner.getTokenStart(this.scanner.tokenIndex - 1) : this.scanner.firstCharOffset : this.scanner.tokenStart;
      }
      ...
      var $r = {
        ...
        parse: function parse(e, t, n) {
          ...
          return this.scanner.skip(this.scanner.getRawLength(e, t || Zr)), r = n && this.scanner.tokenStart > a ? Xr.call(this) : this.scanner.tokenStart, {
            type: "Raw",
        ...
        mode: {
          ...
          ta = Jr.AtKeyword,
          na = Jr.Semicolon,
          ra = Jr.LeftCurlyBracket,
          aa = Jr.RightCurlyBracket;

      function ia(e) {
        return this.Raw(e, ea.leftCurlyBracketOrSemicolon, !0);
      }

      function oa() {
        for (var e, t = 1; e = this.scanner.lookupType(t); t++) {
          if (e === aa) return !0;
          if (e === ra || e === ta) return !1;
        }
      ...
      var sa = {
        ...
        parse: function parse() {
          ...
          switch (this.eat(ta), t = (e = this.scanner.substrToCursor(n + 1)).toLowerCase(), this.scanner.skipSC(), !1 === this.scanner.eof && this.scanner.tokenType !== ra && this.scanner.tokenType !== na && (this.parseAtrulePrelude ? "AtrulePrelude" === (r = this.parseWithFallback(this.AtrulePrelude.bind(this, e), ia)).type && null === r.children.head && (r = null) : r = ia.call(this, this.scanner.tokenIndex), this.scanner.skipSC()), this.scanner.tokenType) {
            case na:
              this.scanner.next();
              break;

            case ra:
              a = this.atrule.hasOwnProperty(t) && "function" == typeof this.atrule[t].block ? this.atrule[t].block.call(this) : this.Block(oa.call(this));
          }
        ...
        parse: function parse(e) {
          var t = null;
          return null !== e && (e = e.toLowerCase()), this.scanner.skipSC(), t = this.atrule.hasOwnProperty(e) && "function" == typeof this.atrule[e].prelude ? this.atrule[e].prelude.call(this) : this.readSequence(this.scope.AtrulePrelude), this.scanner.skipSC(), !0 !== this.scanner.eof && this.scanner.tokenType !== ua && this.scanner.tokenType !== ca && this.error("Semicolon or block is expected"), null === t && (t = this.createList()), {
            type: "AtrulePrelude",
        ...
        walkContext: "atrulePrelude"
          ...
          ma = pa.String,
          ga = pa.Colon,
          fa = pa.LeftSquareBracket,
          ba = pa.RightSquareBracket;
      ...
      function ya() {
        ...
        var e = this.scanner.tokenStart,
            t = !1,
            n = !0;
        return this.scanner.isDelim(42) ? (t = !0, n = !1, this.scanner.next()) : this.scanner.isDelim(124) || this.eat(da), this.scanner.isDelim(124) ? 61 !== this.scanner.source.charCodeAt(this.scanner.tokenStart + 1) ? (this.scanner.next(), this.eat(da)) : t && this.error("Identifier is expected", this.scanner.tokenEnd) : t && this.error("Vertical line is expected"), n && this.scanner.tokenType === ga && (this.scanner.next(), this.eat(da)), {
          type: "Identifier",
          loc: this.getLocation(e, this.scanner.tokenStart),
      ...
      var va = {
        ...
        parse: function parse() {
          var e,
              ...
              r = null,
              a = null;
          return this.eat(fa), this.scanner.skipSC(), e = ya.call(this), this.scanner.skipSC(), this.scanner.tokenType !== ba && (this.scanner.tokenType !== da && (n = ka.call(this), this.scanner.skipSC(), r = this.scanner.tokenType === ma ? this.String() : this.Identifier(), this.scanner.skipSC()), this.scanner.tokenType === da && (a = this.scanner.getTokenValue(), this.scanner.next(), this.scanner.skipSC())), this.eat(ba), {
        ...
        generate: function generate(e) {
          ...
          za = xa.Semicolon,
          Aa = xa.AtKeyword,
          Pa = xa.LeftCurlyBracket,
          Ta = xa.RightCurlyBracket;
      ...
      function Ea() {
        return this.parseWithFallback(this.Rule, La);
      }

      function Da(e) {
        return this.Raw(e, wa.semicolonIncluded, !0);
      }

      function Oa() {
        if (this.scanner.tokenType === za) return Da.call(this, this.scanner.tokenIndex);
        var e = this.parseWithFallback(this.Declaration, Da);
        return this.scanner.tokenType === za && this.scanner.next(), e;
      }
      ...
      var Ba = {
        ...
        parse: function parse(e) {
          ...
          e: for (; !this.scanner.eof;) {
            switch (this.scanner.tokenType) {
              ...
              case Aa:
                r.push(this.parseWithFallback(this.Atrule, La));
                break;
          ...
          return this.scanner.eof || this.eat(Ta), {
            type: "Block",
            loc: this.getLocation(n, this.scanner.tokenStart),
            children: r
          };
        ...
        walkContext: "block"
          ...
          Ia = we.TYPE,
          Na = Ia.LeftSquareBracket,
          Ra = Ia.RightSquareBracket,
          Ma = {
        name: "Brackets",
        structure: {
          children: [[]]
        ...
        parse: function parse(e, t) {
          ...
          return this.eat(Na), n = e.call(this, t), this.scanner.eof || this.eat(Ra), {
            type: "Brackets",
        ...
        parse: function parse() {
          ...
          switch (this.scanner.source.charCodeAt(this.scanner.tokenStart)) {
            ...
            case 47:
              this.scanner.next(), this.scanner.tokenType === Ua && !1 !== this.scanner.lookupValue(0, "deep") || this.error("Identifier `deep` is expected"), this.scanner.next(), this.scanner.isDelim(47) || this.error("Solidus is expected"), this.scanner.next();
              break;
        ...
        parse: function parse() {
          ...
          return this.eat(Va), t - e + 2 >= 2 && 42 === this.scanner.source.charCodeAt(t - 2) && 47 === this.scanner.source.charCodeAt(t - 1) && (t -= 2), {
            type: "Comment",
            loc: this.getLocation(e, this.scanner.tokenStart),
      ...
      function ni(e) {
        return this.Raw(e, Xa.exclamationMarkOrSemicolon, !0);
      }

      function ri(e) {
        return this.Raw(e, Xa.exclamationMarkOrSemicolon, !1);
      }

      function ai() {
        var e = this.scanner.tokenIndex,
            t = this.Value();
        return "Raw" !== t.type && !1 === this.scanner.eof && this.scanner.tokenType !== ei && !1 === this.scanner.isDelim(33) && !1 === this.scanner.isBalanceEdge(e) && this.error(), t;
      }
      ...
      var ii = {
        ...
        parse: function parse() {
          var e,
              ...
              o = a ? ri : ni,
              s = !1;
          return this.scanner.skipSC(), this.eat(Ja), a || this.scanner.skipSC(), e = i ? this.parseWithFallback(ai, o) : o.call(this, this.scanner.tokenIndex), this.scanner.isDelim(33) && (s = si.call(this), this.scanner.skipSC()), !1 === this.scanner.eof && this.scanner.tokenType !== ei && !1 === this.scanner.isBalanceEdge(n) && this.error(), {
            type: "Declaration",
            loc: this.getLocation(t, this.scanner.tokenStart),
            important: s,
            property: r,
      ...
      function oi() {
        var e = this.scanner.tokenStart;
        if (this.scanner.tokenType === ti) switch (this.scanner.source.charCodeAt(this.scanner.tokenStart)) {
          case 42:
          case 36:
          case 43:
          case 35:
        ...
        return this.scanner.tokenType === $a ? this.eat($a) : this.eat(Za), this.scanner.substrToCursor(e);
      }

      function si() {
        this.eat(ti), this.scanner.skipSC();
        var e = this.consume(Za);
      ...
      function di(e) {
        return this.Raw(e, ci.semicolonIncluded, !0);
      }
      ...
      var mi = {
        ...
        parse: function parse() {
          for (var e = this.createList(); !this.scanner.eof;) {
            switch (this.scanner.tokenType) {
              ...
              default:
                e.push(this.parseWithFallback(this.Declaration, di));
            }
          }
        ...
        parse: function parse(e, t) {
          var n,
              ...
              i = a.toLowerCase();
          return n = t.hasOwnProperty(i) ? t[i].call(this, t) : e.call(this, t), this.scanner.eof || this.eat(yi), {
            type: "Function",
            loc: this.getLocation(r, this.scanner.tokenStart),
            name: a,
            children: n
        ...
        generate: function generate(e) {
          ...
          Ti = Ai.Number,
          Li = Ai.Dimension,
          Ei = Ai.LeftParenthesis,
          Di = Ai.RightParenthesis,
          Oi = Ai.Colon,
          Bi = Ai.Delim,
          Ii = {
        name: "MediaFeature",
        ...
        parse: function parse() {
          ...
          if (this.eat(Ei), this.scanner.skipSC(), e = this.consume(Pi), this.scanner.skipSC(), this.scanner.tokenType !== Di) {
            switch (this.eat(Oi), this.scanner.skipSC(), this.scanner.tokenType) {
              case Ti:
                n = this.lookupNonWSType(1) === Bi ? this.Ratio() : this.Number();
                break;
        ...
        parse: function parse(e) {
          ...
          for (this.scanner.skipSC(); !this.scanner.eof && (t.push(this.MediaQuery(e)), this.scanner.tokenType === Wi);) {
            this.scanner.next();
          }
        ...
        generate: function generate(e) {
          ...
          Vi = we.TYPE,
          Ki = Vi.LeftParenthesis,
          Gi = Vi.RightParenthesis,
          Qi = {
        name: "Parentheses",
        structure: {
          children: [[]]
        ...
        parse: function parse(e, t) {
          var n,
              r = this.scanner.tokenStart;
          return this.eat(Ki), n = e.call(this, t), this.scanner.eof || this.eat(Gi), {
            type: "Parentheses",
            loc: this.getLocation(r, this.scanner.tokenStart),
            children: n
          };
        ...
        parse: function parse() {
          var e,
              ...
              n = this.scanner.tokenStart,
              r = null;
          return this.eat(no), this.scanner.tokenType === to ? (t = (e = this.consumeFunctionName()).toLowerCase(), this.pseudo.hasOwnProperty(t) ? (this.scanner.skipSC(), r = this.pseudo[t].call(this), this.scanner.skipSC()) : (r = this.createList()).push(this.Raw(this.scanner.tokenIndex, null, !1)), this.eat(ro)) : e = this.consume(eo), {
        ...
        parse: function parse() {
          var e,
              ...
              n = this.scanner.tokenStart,
              r = null;
          return this.eat(lo), this.eat(lo), this.scanner.tokenType === so ? (t = (e = this.consumeFunctionName()).toLowerCase(), this.pseudo.hasOwnProperty(t) ? (this.scanner.skipSC(), r = this.pseudo[t].call(this), this.scanner.skipSC()) : (r = this.createList()).push(this.Raw(this.scanner.tokenIndex, null, !1)), this.eat(co)) : e = this.consume(oo), {
      ...
      function fo() {
        ...
        for (var e = this.consume(mo), t = 0; t < e.length; t++) {
          var n = e.charCodeAt(t);
          ho(n) || 46 === n || this.error("Unsigned number is expected", this.scanner.tokenStart - e.length + t);
        }
      ...
      var bo = {
        ...
        parse: function parse() {
          var e,
              t = this.scanner.tokenStart,
              n = fo.call(this);
          return this.scanner.skipWS(), this.scanner.isDelim(47) || this.error("Solidus is expected"), this.eat(go), e = fo.call(this), {
            type: "Ratio",
            loc: this.getLocation(t, this.scanner.tokenStart),
            left: n,
            right: e
        ...
        generate: function generate(e) {
          ...
          yo = we.TYPE,
          ko = $r.mode,
          vo = yo.LeftCurlyBracket;

      function xo(e) {
        return this.Raw(e, ko.leftCurlyBracket, !0);
      }

      function wo() {
        var e = this.SelectorList();
        return "Raw" !== e.type && !1 === this.scanner.eof && this.scanner.tokenType !== vo && this.error(), e;
      }
      ...
      var So = {
        ...
        parse: function parse() {
          var e,
              ...
              n = this.scanner.tokenIndex,
              r = this.scanner.tokenStart;
          return e = this.parseRulePrelude ? this.parseWithFallback(wo, xo) : xo.call(this, n), t = this.Block(!0), {
            type: "Rule",
            loc: this.getLocation(r, this.scanner.tokenStart),
            prelude: e,
            block: t
        ...
        parse: function parse() {
          for (var e, t = this.scanner.tokenStart, n = this.createList(); !this.scanner.eof;) {
            switch (this.scanner.tokenType) {
              ...
              case Do:
                e = this.parseWithFallback(this.Atrule, Io);
                break;

              default:
                e = this.parseWithFallback(this.Rule, Io);
            }
      ...
      function Mo() {
        this.scanner.tokenType !== Ro && !1 === this.scanner.isDelim(42) && this.error("Identifier or asterisk is expected"), this.scanner.next();
      }
      ...
      var jo = {
        ...
        parse: function parse() {
          var e = this.scanner.tokenStart;
          return this.scanner.isDelim(124) ? (this.scanner.next(), Mo.call(this)) : (Mo.call(this), this.scanner.isDelim(124) && (this.scanner.next(), Mo.call(this))), {
            type: "TypeSelector",
            loc: this.getLocation(e, this.scanner.tokenStart),
            name: this.scanner.substrToCursor(e)
          };
      ...
      function Vo(e, t) {
        for (var n = this.scanner.tokenStart + e, r = 0; n < this.scanner.tokenEnd; n++) {
          ...
          if (45 === a && t && 0 !== r) return 0 === Vo.call(this, e + r + 1, !1) && this.error(), -1;
          _o(a) || this.error(t && 0 !== r ? "HyphenMinus" + (r < 6 ? " or hex digit" : "") + " is expected" : r < 6 ? "Hex digit is expected" : "Unexpected input", n), ++r > 6 && this.error("Too many hex digits", n);
        }
      ...
      function Go(e) {
        this.scanner.source.charCodeAt(this.scanner.tokenStart) !== e && this.error(qo[e] + " is expected");
      }

      function Qo() {
        var e = 0;
        return this.scanner.isDelim(43) ? (this.scanner.next(), this.scanner.tokenType === Yo ? void ((e = Vo.call(this, 0, !0)) > 0 && Ko.call(this, 6 - e)) : this.scanner.isDelim(63) ? (this.scanner.next(), void Ko.call(this, 5)) : void this.error("Hex digit or question mark is expected")) : this.scanner.tokenType === Uo ? (Go.call(this, 43), e = Vo.call(this, 1, !0), this.scanner.isDelim(63) ? void Ko.call(this, 6 - e) : this.scanner.tokenType === Ho || this.scanner.tokenType === Uo ? (Go.call(this, 45), void Vo.call(this, 1, !1)) : void 0) : this.scanner.tokenType === Ho ? (Go.call(this, 43), void ((e = Vo.call(this, 1, !0)) > 0 && Ko.call(this, 6 - e))) : void this.error();
      }
      ...
      var Xo = {
        ...
        parse: function parse() {
          var e = this.scanner.tokenStart;
          return Fo(this.scanner.source, e, 117) || this.error("U is expected"), Fo(this.scanner.source, e + 1, 43) || this.error("Plus sign is expected"), this.scanner.next(), Qo.call(this), {
            type: "UnicodeRange",
            loc: this.getLocation(e, this.scanner.tokenStart),
            value: this.scanner.substrToCursor(e)
          };
        ...
        parse: function parse() {
          ...
          switch (this.scanner.tokenType) {
            case ts:
              for (var n = t + 4, r = this.scanner.tokenEnd - 1; n < r && Zo(this.scanner.source.charCodeAt(n));) {
                n++;
              }

              for (; n < r && Zo(this.scanner.source.charCodeAt(r - 1));) {
                r--;
              }
            ...
            case es:
              $o(this.scanner.source, this.scanner.tokenStart, this.scanner.tokenEnd, "url(") || this.error("Function name must be `url`"), this.eat(es), this.scanner.skipSC(), e = this.String(), this.scanner.skipSC(), this.eat(ns);
              break;
        ...
        node: os
          ...
          bs = us.Dimension,
          ys = us.Percentage,
          ks = us.LeftParenthesis,
          vs = us.LeftSquareBracket,
          xs = us.Comma,
          ws = us.Delim,
          Ss = function Ss(e) {
        switch (this.scanner.tokenType) {
          ...
          case ms:
            return cs(this.scanner.source, this.scanner.tokenStart, this.scanner.tokenEnd, "url(") ? this.Url() : this.Function(this.readSequence, e.recognizer);

          case gs:
            return this.Url();

          case hs:
            return ls(this.scanner.source, this.scanner.tokenStart, 117) && ls(this.scanner.source, this.scanner.tokenStart + 1, 43) ? this.UnicodeRange() : this.Identifier();
      ...
      var Is = {
        getNode: function getNode(e) {
          switch (this.scanner.tokenType) {
            ...
            case Os:
              return this.scanner.lookupType(1) === Os ? this.PseudoElementSelector() : this.PseudoClassSelector();
        ...
        Value: {
          ...
          "var": function _var() {
            var e = this.createList();
            return this.scanner.skipSC(), e.push(this.Identifier()), this.scanner.skipSC(), this.scanner.tokenType === Ms && (e.push(this.Operator()), e.push(this.parseCustomProperty ? this.Value(null) : this.Raw(this.scanner.tokenIndex, Rs.exclamationMarkOrSemicolon, !1))), e;
          }
        }
      },
          _s = we.TYPE,
        ...
        parse: {
          prelude: function prelude() {
            ...
            return this.lookupNonWSType(0) !== Ws && this.lookupNonWSType(0) !== Us || (e.push(this.WhiteSpace()), e.push(this.MediaQueryList())), e;
          },
          block: null
        }
      },
      ...
      function el() {
        return this.scanner.skipSC(), this.scanner.tokenType === Qs && this.lookupNonWSType(1) === Zs ? this.createSingleNodeList(this.Declaration()) : tl.call(this);
      }
      ...
      function tl() {
        ...
        e: for (; !this.scanner.eof;) {
          switch (this.scanner.tokenType) {
            ...
            case Xs:
              e = this.Function(Js, this.scope.AtrulePrelude);
              break;
            ...
            case $s:
              e = this.Parentheses(el, this.scope.AtrulePrelude);
              break;
  ...
  var utils = {
    hasNoChildren: function hasNoChildren(node) {
      return !node || !node.children || node.children.isEmpty();
    },
    isNodeChildrenList: function isNodeChildrenList(node, list) {
      return node !== null && node.children === list;
    }
  };
  var resolveKeyword = csstree_min.keyword;
  var hasNoChildren = utils.hasNoChildren;
  ...
  var isNodeChildrenList = utils.isNodeChildrenList;
  ...
  var hasNoChildren$1 = utils.hasNoChildren;
      ...
      walk(selector, function (node) {
        ...
        if (this.selector === null || this.selector === selectorList) {
          switch (node.type) {
            ...
            case 'ClassSelector':
              if (usageData.whitelist !== null && usageData.whitelist.classes !== null && !hasOwnProperty$1.call(usageData.whitelist.classes, node.name)) {
                shouldRemove = true;
              }

              if (usageData.blacklist !== null && usageData.blacklist.classes !== null && hasOwnProperty$1.call(usageData.blacklist.classes, node.name)) {
                shouldRemove = true;
              }
            ...
            case 'IdSelector':
              if (usageData.whitelist !== null && usageData.whitelist.ids !== null && !hasOwnProperty$1.call(usageData.whitelist.ids, node.name)) {
                shouldRemove = true;
              }

              if (usageData.blacklist !== null && usageData.blacklist.ids !== null && hasOwnProperty$1.call(usageData.blacklist.ids, node.name)) {
                shouldRemove = true;
              }
            ...
            case 'TypeSelector':
              ...
              if (node.name.charAt(node.name.length - 1) !== '*') {
                if (usageData.whitelist !== null && usageData.whitelist.tags !== null && !hasOwnProperty$1.call(usageData.whitelist.tags, node.name.toLowerCase())) {
                  shouldRemove = true;
                }

                if (usageData.blacklist !== null && usageData.blacklist.tags !== null && hasOwnProperty$1.call(usageData.blacklist.tags, node.name.toLowerCase())) {
                  shouldRemove = true;
                }
              }
  ...
  var isNodeChildrenList$1 = utils.isNodeChildrenList;
  ...
  var clean = function clean(ast, options) {
    walk$1(ast, {
  ...
  var keyframes = function keyframes(node) {
  ...
  var Atrule$1 = function Atrule$1(node) {
  ...
  var AttributeSelector = function AttributeSelector(node) {
  ...
  var _Number = function _Number(node, item) {
  ...
  var _String = function _String(node) {
  ...
  var packNumber$3 = _Number.pack; // http://www.w3.org/TR/css3-color/#svg-color
  ...
  var replace = function replace(ast) {
    walk$2(ast, {
      leave: function leave(node, item, list) {
  ...
  function compareDeclarations(declarations1, declarations2) {
    ...
    for (var cursor = declarations2.head; cursor; cursor = cursor.next) {
      ...
      if (declarations2hash[data.id]) {
        ...
        if (!hasOwnProperty$3.call(fingerprints, data.fingerprint) || !fingerprints[data.fingerprint] && data.important) {
  ...
  TRBL.prototype.getValue = function () {
    ...
    var stringValues = [generate$3(sides.top.node), generate$3(sides.right.node), generate$3(sides.bottom.node), generate$3(sides.left.node)];
  ...
  */
  ...
  function processRule$5(node, item, list) {
    ...
    list.prevUntil(item.prev, function (prev, prevItem) {
      ...
      var diff = utils$1.compareDeclarations(block.children, prevBlock.children); // console.log(diff.eq, diff.ne1, diff.ne2);
  ...
  var restructure = function restructure(ast, options) {
  ...
  var compress = function compress(ast, options) {
    ...
    do {
      ...
      if (chunk.comment) {
        ...
        output.insert(List$5.createItem(chunk.comment)); // add \n after comment if chunk is not empty
  ...
  function createDefaultLogger(level) {
    ...
    return function logger(title, ast) {
      ...
      if (level > 1 && ast) {
        var css = generate$5(ast); // when level 2, limit css to 256 symbols
  ...
  function minify(context, source, options) {
    ...
    if (options.sourceMap) {
      result = debugOutput('generate(sourceMap: true)', options, Date.now(), function () {
        var tmp = generate$5(compressResult.ast, {
          sourceMap: true
        });
