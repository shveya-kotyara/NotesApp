...
var findVisualStudio = require('../lib/find-visualstudio');

var VisualStudioFinder = findVisualStudio.test.VisualStudioFinder;
var semverV1 = {
  major: 1,
  minor: 0,
  patch: 0
...
TestVisualStudioFinder.prototype = Object.create(VisualStudioFinder.prototype); // Silence npmlog - remove for debugging
...
test('VS2013', function (t) {
  t.plan(4);
  var finder = new TestVisualStudioFinder(semverV1, null, function (err, info) {
  ...
  finder.findVisualStudio2017OrNewer = function (cb) {
    finder.parseData(new Error(), '', '', cb);
  };

  finder.regSearchKeys = function (keys, value, addOpts, cb) {
    for (var i = 0; i < keys.length; ++i) {
      var fullName = "".concat(keys[i], "\\").concat(value);
      ...
      switch (fullName) {
        ...
        case 'HKLM\\Software\\Microsoft\\VisualStudio\\SxS\\VC7\\12.0':
          t.pass("expected search for registry value ".concat(fullName));
        ...
        default:
          t.fail("unexpected search for registry value ".concat(fullName));
      }
    }
...
test('VS2013 should not be found on new node versions', function (t) {
  t.plan(2);
  var finder = new TestVisualStudioFinder({
    major: 10,
    minor: 0,
    patch: 0
  ...
  finder.findVisualStudio2017OrNewer = function (cb) {
    var file = path.join(__dirname, 'fixtures', 'VS_2017_Unusable.txt');
...
test('error from PowerShell', function (t) {
  t.plan(2);
  var finder = new TestVisualStudioFinder(semverV1, null, null);
  finder.parseData(new Error(), '', '', function (info) {
...
test('empty output from PowerShell', function (t) {
  t.plan(2);
  var finder = new TestVisualStudioFinder(semverV1, null, null);
  finder.parseData(null, '', '', function (info) {
    t.ok(/use PowerShell/i.test(finder.errorLog[0]), 'expect error');
    t["false"](info, 'no data');
  });
});
test('output from PowerShell not JSON', function (t) {
  t.plan(2);
  var finder = new TestVisualStudioFinder(semverV1, null, null);
  finder.parseData(null, 'AAAABBBB', '', function (info) {
    t.ok(/use PowerShell/i.test(finder.errorLog[0]), 'expect error');
    t["false"](info, 'no data');
  });
});
...
test('future version', function (t) {
  ...
  finder.parseData(null, JSON.stringify([{
    packages: ['Microsoft.VisualStudio.Component.VC.Tools.x86.x64', 'Microsoft.VisualStudio.Component.Windows10SDK.17763', 'Microsoft.VisualStudio.VC.MSBuild.Base'],
    path: 'C:\\VS',
...
test('single unusable VS2017', function (t) {
  ...
  var file = path.join(__dirname, 'fixtures', 'VS_2017_Unusable.txt');
  var data = fs.readFileSync(file);
  finder.parseData(null, data, '', function (info) {
...
test('minimal VS2017 Build Tools', function (t) {
  ...
  finder.findVisualStudio2017OrNewer = function (cb) {
    var file = path.join(__dirname, 'fixtures', 'VS_2017_BuildTools_minimal.txt');
    var data = fs.readFileSync(file);
    finder.parseData(null, data, '', cb);
  };
...
test('VS2017 Community with C++ workload', function (t) {
  ...
  finder.findVisualStudio2017OrNewer = function (cb) {
    var file = path.join(__dirname, 'fixtures', 'VS_2017_Community_workload.txt');
    var data = fs.readFileSync(file);
    finder.parseData(null, data, '', cb);
  };
...
test('VS2017 Express', function (t) {
  ...
  var finder = new TestVisualStudioFinder(semverV1, null, function (err, info) {
    t.strictEqual(err, null);
    t.deepEqual(info, {
      msBuild: 'C:\\Program Files (x86)\\Microsoft Visual Studio\\2017\\' + 'WDExpress\\MSBuild\\15.0\\Bin\\MSBuild.exe',
  ...
  finder.findVisualStudio2017OrNewer = function (cb) {
    var file = path.join(__dirname, 'fixtures', 'VS_2017_Express.txt');
    var data = fs.readFileSync(file);
    finder.parseData(null, data, '', cb);
  };
...
test('VS2019 Preview with C++ workload', function (t) {
  ...
  finder.findVisualStudio2017OrNewer = function (cb) {
    var file = path.join(__dirname, 'fixtures', 'VS_2019_Preview.txt');
    var data = fs.readFileSync(file);
    finder.parseData(null, data, '', cb);
  };
...
test('minimal VS2019 Build Tools', function (t) {
  ...
  finder.findVisualStudio2017OrNewer = function (cb) {
    var file = path.join(__dirname, 'fixtures', 'VS_2019_BuildTools_minimal.txt');
    var data = fs.readFileSync(file);
    finder.parseData(null, data, '', cb);
  };
...
test('VS2019 Community with C++ workload', function (t) {
  ...
  finder.findVisualStudio2017OrNewer = function (cb) {
    var file = path.join(__dirname, 'fixtures', 'VS_2019_Community_workload.txt');
    var data = fs.readFileSync(file);
    finder.parseData(null, data, '', cb);
  };
...
function allVsVersions(t, finder) {
  finder.findVisualStudio2017OrNewer = function (cb) {
    var data0 = JSON.parse(fs.readFileSync(path.join(__dirname, 'fixtures', 'VS_2017_Unusable.txt')));
    var data1 = JSON.parse(fs.readFileSync(path.join(__dirname, 'fixtures', 'VS_2017_BuildTools_minimal.txt')));
    var data2 = JSON.parse(fs.readFileSync(path.join(__dirname, 'fixtures', 'VS_2017_Community_workload.txt')));
    var data3 = JSON.parse(fs.readFileSync(path.join(__dirname, 'fixtures', 'VS_2017_Express.txt')));
    var data4 = JSON.parse(fs.readFileSync(path.join(__dirname, 'fixtures', 'VS_2019_Preview.txt')));
    var data5 = JSON.parse(fs.readFileSync(path.join(__dirname, 'fixtures', 'VS_2019_BuildTools_minimal.txt')));
    var data6 = JSON.parse(fs.readFileSync(path.join(__dirname, 'fixtures', 'VS_2019_Community_workload.txt')));
    var data = JSON.stringify(data0.concat(data1, data2, data3, data4, data5, data6));
    finder.parseData(null, data, '', cb);
  };
...
test('fail when looking for invalid path', function (t) {
  t.plan(2);
  var finder = new TestVisualStudioFinder(semverV1, 'AABB', function (err, info) {
    t.ok(/find .* Visual Studio/i.test(err), 'expect error');
    t["false"](info, 'no data');
  });
...
test('look for VS2013 by version number', function (t) {
  t.plan(2);
  var finder = new TestVisualStudioFinder(semverV1, '2013', function (err, info) {
    t.strictEqual(err, null);
...
test('look for VS2013 by installation path', function (t) {
  t.plan(2);
  var finder = new TestVisualStudioFinder(semverV1, 'C:\\VS2013', function (err, info) {
    t.strictEqual(err, null);
...
test('look for VS2015 by version number', function (t) {
  t.plan(2);
  var finder = new TestVisualStudioFinder(semverV1, '2015', function (err, info) {
    t.strictEqual(err, null);
...
test('look for VS2015 by installation path', function (t) {
  t.plan(2);
  var finder = new TestVisualStudioFinder(semverV1, 'C:\\VS2015', function (err, info) {
    t.strictEqual(err, null);
...
test('look for VS2017 by version number', function (t) {
  t.plan(2);
  var finder = new TestVisualStudioFinder(semverV1, '2017', function (err, info) {
    t.strictEqual(err, null);
...
test('look for VS2017 by installation path', function (t) {
  t.plan(2);
  var finder = new TestVisualStudioFinder(semverV1, 'C:\\Program Files (x86)\\Microsoft Visual Studio\\2017\\Community', function (err, info) {
    t.strictEqual(err, null);
    t.deepEqual(info.path, 'C:\\Program Files (x86)\\Microsoft Visual Studio\\2017\\Community');
  });
  allVsVersions(t, finder);
  finder.findVisualStudio();
});
test('look for VS2019 by version number', function (t) {
  t.plan(2);
  var finder = new TestVisualStudioFinder(semverV1, '2019', function (err, info) {
    t.strictEqual(err, null);
...
test('look for VS2019 by installation path', function (t) {
  t.plan(2);
  var finder = new TestVisualStudioFinder(semverV1, 'C:\\Program Files (x86)\\Microsoft Visual Studio\\2019\\BuildTools', function (err, info) {
    t.strictEqual(err, null);
    t.deepEqual(info.path, 'C:\\Program Files (x86)\\Microsoft Visual Studio\\2019\\BuildTools');
  });
  allVsVersions(t, finder);
  finder.findVisualStudio();
});
...
test('run on a usable VS Command Prompt', function (t) {
  t.plan(2);
  process.env.VCINSTALLDIR = 'C:\\VS2015\\VC'; // VSINSTALLDIR is not defined on Visual C++ Build Tools 2015
...
test('VCINSTALLDIR match should be case insensitive', function (t) {
  t.plan(2);
  process.env.VCINSTALLDIR = 'c:\\program files (x86)\\microsoft visual studio\\2019\\BUILDTOOLS\\VC';
  var finder = new TestVisualStudioFinder(semverV1, null, function (err, info) {
    t.strictEqual(err, null);
    t.deepEqual(info.path, 'C:\\Program Files (x86)\\Microsoft Visual Studio\\2019\\BuildTools');
  });
...
test('run on a unusable VS Command Prompt', function (t) {
  t.plan(2);
  process.env.VCINSTALLDIR = 'C:\\Program Files (x86)\\Microsoft Visual Studio\\2019\\BuildToolsUnusable\\VC';
  var finder = new TestVisualStudioFinder(semverV1, null, function (err, info) {
    t.ok(/find .* Visual Studio/i.test(err), 'expect error');
    t["false"](info, 'no data');
  });
