...
var log = require('npmlog'); // versions where -headers.tar.gz started shipping


var headersTarballRange = '>= 3.0.0 || ~0.12.10 || ~0.10.42';
var bitsre = /\/win-(x86|x64|arm64)\//;
var bitsreV3 = /\/win-(x86|ia32|x64)\//; // io.js v3.x.x shipped with "ia32" but should
// have been "x86"
