'use strict'; // Taken from https://github.com/request/request/blob/212570b/lib/getProxyFromURI.js
...
function getProxyFromURI(gyp, env, uri) {
  ...
  var noProxy = gyp.opts.noproxy || env.NO_PROXY || env.no_proxy || env.npm_config_noproxy || ''; // if the noProxy is a wildcard then return null
