...
module.exports = DefaultLinePrependor = function (superClass) {
  ...
  DefaultLinePrependor.prototype._render = function (inherited, options) {
    var addToLeft, addToRight, alignment, bullet, _char, charLen, diff, left, output, space, toWrite;

    if (this._lineNo === 0 && (bullet = this._config.bullet)) {
      _char = bullet["char"];
      charLen = SpecialString(_char).length;
      ...
      output = addToLeft + _char + addToRight;
    } else {
