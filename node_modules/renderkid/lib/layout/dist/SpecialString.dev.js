...
module.exports = SpecialString = function () {
  ...
  SpecialString.prototype.splitIn = function (limit, trimLeftEachLine) {
    ...
    self._countChars(this._str, function (_char, charLength) {
      ...
      if (bufferLength === 0 && _char === ' ' && !justSkippedSkipChar && trimLeftEachLine) {
  ...
  SpecialString.prototype._getLength = function () {
    ...
    self._countChars(this._str, function (_char2, charLength) {
      sum += charLength;
    });
  ...
  SpecialString.prototype.cut = function (from, to, trimLeft) {
    ...
    self._countChars(this._str, function (_this) {
      return function (_char3, charLength) {
        if (_this.str === 'ab<tag>') {
          console.log(charLength, _char3);
        }

        if (cur === from && _char3.match(/^\s+$/) && trimLeft) {
          return;
        }
  ...
  SpecialString._countChars = function (text, cb) {
    var _char4, charLength, m;

    while (text.length !== 0) {
      if (m = text.match(self._tagRx)) {
        _char4 = m[0];
        charLength = 0;
        text = text.substr(_char4.length, text.length);
      ...
      cb.call(null, _char4, charLength);
    }
  };
