...
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t(((e = e || self).prettierPlugins = e.prettierPlugins || {}, e.prettierPlugins.markdown = {}));
}(void 0, function (e) {
  "use strict";
  ...
  var g = Object.freeze({
    ...
    for (n in b(o, e), b(a, o), r = o.prototype) {
      (i = r[n]) && "object" === t(i) && (r[n] = "concat" in i ? i.concat() : p(i));
    }
  ...
  var k = function k(e, t) {
    return function (r) {
      ...
      for (; -1 !== a;) {
        u.push(r.slice(i, a)), i = a + 1, (n = r.charAt(i)) && -1 !== o.indexOf(n) || u.push("\\"), a = r.indexOf("\\", i);
      }
  ...
  var P = D(_),
    ...
    return function (e, t) {
      ...
      for (; ++q < x;) {
        if (a === X && (L = F[N] || 1), (a = be(q)) !== z) a === X && (I++, N++, L = 0), a ? (te += a, L++) : ye();else {
          if ((u = be(q + 1)) === ee || u === X || u === j || u === Y || u === Z || u === z || u === K || y && u === y) {
            te += a, L++;
            continue;
          }

          for (f = h = q + 1, b = h, u !== G ? d = re : (b = ++f, (u = be(b)) === W || u === Q ? (d = ne, b = ++f) : d = ie), r = K, p = K, i = K, D = oe[d], b--; ++b < x && (u = be(b), D(u));) {
  ...
  var Ze = function Ze(e, t, r) {
    ...
    for (; g < D;) {
      if (a = t.charAt(g), s += l, c += p, l = "", p = "", a === Je) {
        for (s ? (l += a, p += a) : m += a, u = "", g++; g < D && (a = t.charAt(g)) === et;) {
          u += a, g++;
        }
  ...
  var ut = function ut(e, t, r) {
    ...
    for (; E < m;) {
      for (o = t.indexOf(st, E), c = E, l = !1, -1 === o && (o = m); E < m && ((i = t.charAt(E)) === lt || i === ct);) {
        E++;
      }
  ...
  var vt = function vt(e, t, r) {
    ...
    for (; ++u < s;) {
      if ((n = t.charAt(u)) === i) a++, c += o + i, o = "";else {
  ...
  var Tt = function Tt(e) {
    ...
    for (; i in _t;) {
      t = _t[i], n += t, t > 1 && (n = Math.floor(n / t) * t), a[n] = r, i = e.charAt(++r);
    }
  ...
  var Nt = function Nt(e, t, r) {
    ...
    for (; ++N < L;) {
      b = g[N].value.join(Rt), w = e.now(), (b = e(b)(Qt(this, b, w), A)).loose && (C = !0), b = g[N].trail.join(Rt), N !== L - 1 && (b += Rt), e(b);
    }
  ...
  function Zt(e, t, r) {
    ...
    })).split(Rt), (u = St(t, Tt(n).indent).split(Rt))[0] = a, l[p] = (l[p] || 0) + i.length, p++, s = 0, c = o.length; ++s < c;) {
  ...
  function kr(e, t, r) {
    ...
    if (this.options.footnotes) {
      for (n = 0, i = t.length, a = "", o = e.now(), u = o.line; n < i && (p = t.charAt(n), Re(p));) {
        a += p, n++;
      }

      if (t.charAt(n) === yr && t.charAt(n + 1) === Cr) {
        for (n = (a += yr + Cr).length, c = ""; n < i && (p = t.charAt(n)) !== Er;) {
        ...
        if (c && t.charAt(n) === Er && t.charAt(n + 1) === Ar) {
          ...
          for (f = dr(c), n = (a += c + Er + Ar).length; n < i && ((p = t.charAt(n)) === vr || p === br);) {
            a += p, n++;
          }
  ...
  function $r(e, t, r) {
    for (var n, i, a, o, u, s, c, l, p = this.options.commonmark, f = 0, h = t.length, d = ""; f < h && ((o = t.charAt(f)) === Nr || o === qr);) {
      d += o, f++;
    }
    ...
    if ((o = t.charAt(f)) === Lr) {
      ...
      if (a && t.charAt(f) === Br && t.charAt(f + 1) === Rr) {
        for (s = a, f = (d += a + Br + Rr).length, a = ""; f < h && ((o = t.charAt(f)) === qr || o === Nr || o === xr);) {
          d += o, f++;
        }

        if (a = "", n = d, (o = t.charAt(f)) === Ir) {
          for (f++; f < h && Vr(o = t.charAt(f));) {
            a += o, f++;
          }
        ...
        if (a) {
          for (c = a, a = ""; f < h && ((o = t.charAt(f)) === qr || o === Nr || o === xr);) {
            a += o, f++;
          }
  ...
  var jr = function jr(e, t, r) {
    ...
    for (; ++b < y;) {
      for (E = c[b], u = {
        type: "tableRow",
        children: []
      }, b && e(Yr), e(E).reset(u, A), s = E.length + 1, n = 0, l = "", d = "", D = !0, g = null, m = null; n < s;) {
  ...
  function En(e, t, r) {
    ...
    if (t.charAt(0) === Dn) {
      for (this, n = "", i = t.length, a = 0, o = "", s = !1, c = "", a++, n = Dn; a < i && (u = t.charAt(a), !(Re(u) || u === gn || u === mn || ":" === u && t.charAt(a + 1) === vn));) {
        o += u, a++;
      }
  ...
  function Bn(e, t, r) {
    ...
    if (this.options.gfm) {
      ...
      if (n) {
        for (o = n.length, l = t.length, p = "", f = 0; o < l && (a = t.charAt(o), !Re(a) && a !== Fn) && ("." !== a && "," !== a && ":" !== a && ";" !== a && '"' !== a && "'" !== a && ")" !== a && "]" !== a || (h = t.charAt(o + 1)) && !Re(h)) && (a !== _n && a !== kn || f++, a !== Sn && a !== Tn || !(--f < 0));) {
          p += a, o++;
        }
    ...
    if ("!" === w && (p = !0, C = w, w = t.charAt(++A)), w === zn && (p || !this.inLink)) {
      for (C += w, m = "", A++, d = t.length, g = 0, (b = e.now()).column += A, b.offset += A; A < d;) {
        if (s = w = t.charAt(A), w === Yn) {
          ...
          if ((!a || _) && w === Gn) {
            if (!g) {
              if (!k) for (; A < d && (w = t.charAt(A + 1), Re(w));) {
                s += w, A++;
              }
    ...
    if ("!" === p && (g = ri, D = p, p = t.charAt(++f)), p === ci) {
      ...
      if (d = s, n = s, (p = t.charAt(f)) === li) {
        ...
        if (p = t.charAt(f), g !== ni && p === ci) {
          for (i = "", s += p, f++; f < h && (p = t.charAt(f)) !== ci && p !== li;) {
  ...
  function Li(e, t, r) {
    for (var n, i, a, o, u, s, c, l, p = t.length, f = 0, h = "", d = ""; f < p && t.charAt(f) === Ni;) {
      h += Ni, f++;
    }
    ...
    if (h) {
      ...
      for (n = "", i = "", p = h.length, f = -1; ++f < p;) {
        s = h.charAt(f), Re(s) ? i += s : (i && (n && (n += i), i = ""), n += s);
      }
  ...
  var Ii = function Ii(e, t, r) {
    ...
    for (; ++a < o;) {
      "text" !== (l = n[a]) && i[l] && ((c = i[l].locator) || e.file.fail("Missing locator: `" + l + "`"), -1 !== (s = c.call(this, t, 1)) && s < p && (p = s));
    }
  ...
  var Gi = Object.prototype.hasOwnProperty,
    ...
    for ("boolean" == typeof s && (p = s, s = arguments[1] || {}, c = 2), (null == s || "object" !== t(s) && "function" != typeof s) && (s = {}); c < l; ++c) {
      if (null != (r = arguments[c])) for (n in r) {
        i = Ji(s, n), s !== (a = Ji(r, n)) && (p && a && (Yi(a) || (o = Qi(a))) ? (o ? (o = !1, u = i && Qi(i) ? i : []) : u = i && Yi(i) ? i : {}, Zi(s, {
          name: n,
          newValue: e(p, u, a)
        })) : void 0 !== a && Zi(s, {
          name: n,
  ...
  function Ma(e) {
    ...
    for (this.data = {}, this.messages = [], this.history = [], this.cwd = Ba.cwd(), r = -1, n = Va.length; ++r < n;) {
      t = Va[r], Ua.call(e, t) && (this[t] = e[t]);
    }

    for (t in e) {
      -1 === Va.indexOf(t) && (this[t] = e[t]);
    }
  }
  ...
  var Ya = function Ya(e) {
    ...
    function s() {
      ...
      for (; ++o < r.length;) {
        t = (e = r[o])[0], null, !1 !== (i = e[1]) && (!0 === i && (e[1] = void 0), "function" == typeof (s = t.apply(u, e.slice(1))) && n.use(s));
      }
  ...
  var Ro = {
    ...
    getOrderedListItemInfo: function getOrderedListItemInfo(e, t) {
  ...
  var Go = /^\\\$/,
    ...
    r.math = function (e, t, r) {
      for (var n, i, a, o, u, s, c, l, p, f, h = t.length + 1, d = 0, D = ""; d < h && ((a = t.charAt(d)) === Zo || a === Yo);) {
        D += a, d++;
      }
      ...
      if (p = d, (a = t.charAt(d)) === Jo) {
        ...
        if (!(n < Ko)) {
          ...
          for ((f = e.now()).column += D.length, f.offset += D.length, o = c = l = u = s = ""; d < h;) {
            if (u += c, s += l, c = l = "", (a = t.charAt(d)) === Qo) {
              for (u ? (c += a, l += a) : D += a, o = "", d++; d < h && (a = t.charAt(d)) === Zo;) {
                o += a, d++;
              }
  ...
  var Tc = d(function (e, t) {
    ...
    var d = function e(t) {
      ...
      return i(e, [{
        ...
        value: function value() {
          for (var e, t, r = this._index, n = null; this._peek !== bc.$COLON && !(((e = this._peek) < bc.$a || bc.$z < e) && (e < bc.$A || bc.$Z < e) && (e < bc.$0 || e > bc.$9));) {
            this._advance();
          }
        ...
        value: function value(e) {
          ...
          try {
            ...
            for (this._consumeTagOpenStart(e), r = (t = this._input.substring(a, this._index)).toLowerCase(), this._attemptCharCodeUntilFn(g); this._peek !== bc.$SLASH && this._peek !== bc.$GT;) {
              this._consumeAttributeName(), this._attemptCharCodeUntilFn(g), this._attemptCharCode(bc.$EQ) && (this._attemptCharCodeUntilFn(g), this._consumeAttributeValue()), this._attemptCharCodeUntilFn(g);
            }
  ...
  var _c = d(function (e, t) {
    ...
    var l = function () {
      ...
      return i(e, [{
        ...
        value: function value(e) {
          for (var t = e.parts[0], r = e.parts[1], i = []; this._peek.type === Tc.TokenType.ATTR_NAME;) {
