...
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t(((e = e || self).prettierPlugins = e.prettierPlugins || {}, e.prettierPlugins.yaml = {}));
}(void 0, function (e) {
  "use strict";

  var t = function t(e, _t2) {
    var n = new SyntaxError(e + " (" + _t2.start.line + ":" + _t2.start.column + ")");
    return n.loc = _t2, n;
  };
  ...
  function g(e, t) {
    return !t || "object" != _typeof(t) && "function" != typeof t ? v(e) : t;
  }
  ...
  var k = Object.freeze({
    ...
    __extends: function __extends(e, t) {
      ...
      _E(e, t), e.prototype = null === t ? Object.create(t) : (n.prototype = t.prototype, new n());
    },
    ...
    __decorate: function __decorate(e, t, n, r) {
      ...
      if ("object" === ("undefined" == typeof Reflect ? "undefined" : i(Reflect)) && "function" == typeof Reflect.decorate) s = Reflect.decorate(e, t, n, r);else for (var u = e.length - 1; u >= 0; u--) {
        (a = e[u]) && (s = (o < 3 ? a(s) : o > 3 ? a(t, n, s) : a(t, n)) || s);
      }
    ...
    var n = function () {
      ...
      return f(e, null, [{
        ...
        value: function value(e, t) {
          ...
          for (var a = t; a < e.length && !(e[a] > n);) {
            ++a;
          }

          this.origStart = n + a;

          for (var o = a; a < e.length && !(e[a] >= r);) {
            ++a;
          }
  ...
  var N = o(function (e, t) {
    ...
    var a = function () {
      ...
      return f(e, null, [{
        ...
        key: "hasComment",
        get: function get() {
          if (this.context) for (var e = this.context.src, t = 0; t < this.props.length; ++t) {
        ...
        get: function get() {
          ...
          for (var e = this.valueRange, t = e.start, n = e.end, r = this.context.src, a = t; a < n; ++a) {
            if ("\n" === r[a]) return !0;
          }
  ...
  var D = o(function (e, t) {
    ...
    function d(e) {
      for (var t = e; t instanceof r["default"];) {
        t = t.node;
      }
      ...
      for (var l = t.items.splice(a, n - a), c = l[0].range.start; t.range.end = c, t.valueRange && t.valueRange.end > c && (t.valueRange.end = c), t !== e;) {
        t = t.context.parent;
      }
    ...
    var d = function (e) {
      ...
      return l(t, e), f(t, null, [{
        ...
        value: function value(e) {
          ...
          for (var u = !0, f = !1, l = e; !o["default"].atDocumentBoundary(s, l, T.Char.DIRECTIVES_END);) {
  ...
  var ae = o(function (e, t) {
    ...
    var l = function () {
      ...
      return f(e, null, [{
        ...
        key: "createMergePair",
        value: function value() {
          for (var e = this, t = new a["default"](), o = arguments.length, i = new Array(o), s = 0; s < o; s++) {
            i[s] = arguments[s];
          }
  ...
  var fe = o(function (e, t) {
    ...
    function r(e, t) {
      ...
      for (var f = "", l = 0, c = 0, d = u[c]; d; d = u[++c]) {
        if (" " === d && "\\" === u[c + 1] && "n" === u[c + 2] && (f += u.slice(l, c) + "\\ ", l = c += 1, d = "\\"), "\\" === d) switch (u[c + 1]) {
          case "u":
            f += u.slice(l, c);
  ...
  var de = o(function (e, t) {
    ...
    var o = {
      createNode: function createNode(e, t, r) {
        var a = new n["default"]();
  ...
  var pe = o(function (e, t) {
    ...
    var o = {
      createNode: function createNode(e, t, n) {
        var a = new r["default"]();
  ...
  var ve = o(function (e, t) {
    ...
    var r = {
      ...
      resolve: n,
      stringify: function stringify(e, t, n, r) {
  ...
  function Se(e, t, n) {
    for (var r, a, o = [], i = t; i < n; i += 3) {
      r = (e[i] << 16) + (e[i + 1] << 8) + e[i + 2], o.push(be[(a = r) >> 18 & 63] + be[a >> 12 & 63] + be[a >> 6 & 63] + be[63 & a]);
    }
  ...
  function Ae(e) {
    ...
    for (var n = e.length, r = n % 3, a = "", o = [], i = 0, s = n - r; i < s; i += 16383) {
  ...
  function Be(e, t) {
    if (Ie(t), e = Ne(e, t < 0 ? 0 : 0 | je(t)), !xe.TYPED_ARRAY_SUPPORT) for (var n = 0; n < t; ++n) {
      e[n] = 0;
    }
    return e;
  }
  ...
  function He(e, t, n, r) {
    return vt(function (e, t) {
      for (var n, r, a, o = [], i = 0; i < e.length && !((t -= 2) < 0); ++i) {
        n = e.charCodeAt(i), r = n >> 8, a = n % 256, o.push(a), o.push(r);
      }
  ...
  xe.TYPED_ARRAY_SUPPORT = void 0 === _e.TYPED_ARRAY_SUPPORT || _e.TYPED_ARRAY_SUPPORT, xe.poolSize = 8192, xe._augment = function (e) {
    ...
    for (var o = (a >>>= 0) - (r >>>= 0), i = (n >>>= 0) - (t >>>= 0), s = Math.min(o, i), u = this.slice(r, a), f = e.slice(t, n), l = 0; l < s; ++l) {
      if (u[l] !== f[l]) {
        o = u[l], i = f[l];
        break;
      }
  ...
  xe.prototype.slice = function (e, t) {
    ...
    if (this === e && n < t && t < r) for (a = o - 1; a >= 0; --a) {
      e[a + t] = this[a + n];
    } else if (o < 1e3 || !xe.TYPED_ARRAY_SUPPORT) for (a = 0; a < o; ++a) {
      e[a + t] = this[a + n];
  ...
  function pt(e) {
    return function (e) {
      ...
      for (t = 0, n = 0; t < r; t += 4, n += 3) {
        a = we[e.charCodeAt(t)] << 18 | we[e.charCodeAt(t + 1)] << 12 | we[e.charCodeAt(t + 2)] << 6 | we[e.charCodeAt(t + 3)], i[u++] = a >> 16 & 255, i[u++] = a >> 8 & 255, i[u++] = 255 & a;
      }
    ...
    var n = {
      ...
      stringify: function stringify(e, t, n, r) {
        ...
        if (a = s instanceof xe ? s.toString("base64") : xe.from(s.buffer).toString("base64"), i || (i = ue.binaryOptions.defaultType), i === T.Type.QUOTE_DOUBLE) s = a;else {
          for (var u = ue.binaryOptions.lineWidth, f = Math.ceil(a.length / u), l = new Array(f), c = 0, d = 0; c < f; ++c, d += u) {
            l[c] = a.substr(d, u);
          }
  ...
  var wt = o(function (e, t) {
    ...
    var n = function n(e, t) {
      ...
      resolve: function resolve(e, t, r) {
    ...
    var i = {
      ...
      resolve: function resolve(e, t, r, a, o, i, s, u, f) {
        u && (u = (u + "00").substr(1, 3));
  ...
  var At = o(function (e, t) {
    ...
    var d = {
      ...
      parseAllDocuments: function parseAllDocuments(e, t) {
        var r,
            a = [],
            o = !0,
            i = !1,
  ...
  var Pt = o(function (e, t) {
    ...
    t.__esModule = !0, t.attachComments = function (e) {
      ...
      e.comments.sort(function (e, t) {
        ...
        for (; r.length > 1 && e.position.start.line > r[0].position.end.line;) {
          r.shift();
        }
  ...
  var dn = o(function (e, t) {
    t.__esModule = !0, t.transformDocumentHead = function (e, t) {
      ...
      return (n = t.comments).push.apply(n, xt.__spreadArrays(i, s)), {
        createDocumentHeadWithTrailingComment: function createDocumentHeadWithTrailingComment(e) {
  ...
  var Xn = o(function (e, t) {
    t.__esModule = !0, t.parse = function (e) {
      ...
      var n = t.map(function (e) {
        ...
        comments: r,
        transformOffset: function transformOffset(e) {
          return qn.transformOffset(e, a);
        },
        transformRange: function transformRange(e) {
          return Jn.transformRange(e, a);
        },
        transformNode: function transformNode(e) {
          return Wn.transformNode(e, a);
        },
        transformContent: function transformContent(e) {
