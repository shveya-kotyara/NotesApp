...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e(((t = t || self).prettierPlugins = t.prettierPlugins || {}, t.prettierPlugins.glimmer = {}));
}(void 0, function (t) {
  "use strict";

  var e = function e(t, _e) {
    var r = new SyntaxError(t + " (" + _e.start.line + ":" + _e.start.column + ")");
    return r.loc = _e, r;
  };
  ...
  var g = ("undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}).performance || {},
      v = (g.now || g.mozNow || g.msNow || g.oNow || g.webkitNow, Object.freeze([]), new (function () {
    function t(e, r) {
  ...
  }())(null, null), Object.keys);

  function b(t) {
    for (var e = 1; e < arguments.length; e++) {
      var a = arguments[e];
      if (null !== a && "object" === r(a)) for (var n = v(a), i = 0; i < n.length; i++) {
        var o = n[i];
        t[o] = a[o];
      }
    }
  ...
  function w(t) {
    ...
    return n = l, Array.isArray(n) && !S(n) && (e = l, function (t) {
      return !("object" !== r(t) || !t || Array.isArray(t));
    }(l = s.shift()) && (a = function (t, e) {
      var r = [];
      return Object.keys(t).forEach(function (e) {
        r.push(L(e, t[e]));
      }), N(r, e);
    }(l))), S(l) && (o = l[1]), k(i, e, a, o);
  }

  function x(t) {
    return P(t[0], "string" == typeof t[1] ? A(t[1]) : t[1], t[2] ? t[2][1] : void 0);
  }
  ...
  var I = {
    ...
    block: function block(t, e, r, a, n, i) {
      var o, s;
      return o = "Template" === a.type ? b({}, a, {
        type: "Block"
      }) : a, s = null != n && "Template" === n.type ? b({}, n, {
        type: "Block"
      }) : n, {
        type: "BlockStatement",
        path: _(t),
    ...
    element: function element(t, e) {
      ...
      var s = a,
          ...
          f = s.loc,
          d = !1;
      return "object" === r(t) ? (d = t.selfClosing, t = t.name) : "/" === t.slice(-1) && (t = t.slice(0, -1), d = !0), {
        type: "ElementNode",
        tag: t || "",
        selfClosing: d,
        attributes: l || [],
    ...
    blockItself: function blockItself(t, e) {
      return {
        type: "Block",
        body: t || [],
        blockParams: e || [],
        chained: arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
        loc: O((arguments.length > 3 ? arguments[3] : void 0) || null)
      };
    },
    template: function template(t, e, r) {
      return {
        type: "Template",
        body: t || [],
        blockParams: e || [],
  ...
  function H(t) {
    var e = function (t) {
      ...
      if (-1 !== n && e > n && "|" === r[n + 1].charAt(0)) {
        ...
        if ("|" !== i.charAt(i.length - 1) || 2 !== i.match(/\|/g).length) throw new R("Invalid block parameters syntax: '" + i + "'", t.loc);

        for (var o = [], s = n + 1; s < e; s++) {
          var l = r[s].replace(/\|/g, "");

          if ("" !== l) {
            if (V.test(l)) throw new R("Invalid identifier for block parameters: '" + l + "' in '" + i + "'", t.loc);
            o.push(l);
          }
        }

        if (0 === o.length) throw new R("Cannot use zero block parameters: '" + i + "'", t.loc);
  ...
  var $ = {
    ...
    return t.prototype.parse = function (t) {
      if (t) {
        var e = t.match(z);
        return e ? String.fromCharCode(parseInt(e[1], 16)) : (e = t.match(F)) ? String.fromCharCode(parseInt(e[1], 10)) : (e = t.match(G)) ? this.named[e[1]] : void 0;
      }
    }, t;
  }(),
      J = /[\t\n\f ]/,
  ...
  var X = function () {
    function t(t, e) {
      this.delegate = t, this.entityParser = e, this.state = "beforeData", this.line = -1, this.column = -1, this.input = "", this.index = -1, this.tagNameBuffer = "", this.states = {
        ...
        tagOpen: function tagOpen() {
          var t = this.consume();
          "!" === t ? this.transitionTo("markupDeclarationOpen") : "/" === t ? this.transitionTo("endTagOpen") : ("@" === t || ":" === t || Z(t)) && (this.transitionTo("tagName"), this.tagNameBuffer = "", this.delegate.beginStartTag(), this.appendToTagName(t));
        },
        ...
        tagName: function tagName() {
          var t = this.consume();
          Y(t) ? this.transitionTo("beforeAttributeName") : "/" === t ? this.transitionTo("selfClosingStartTag") : ">" === t ? (this.delegate.finishTag(), this.transitionTo("beforeData")) : this.appendToTagName(t);
        },
        ...
        afterAttributeValueQuoted: function afterAttributeValueQuoted() {
          var t = this.peek();
          Y(t) ? (this.consume(), this.transitionTo("beforeAttributeName")) : "/" === t ? (this.consume(), this.transitionTo("selfClosingStartTag")) : ">" === t ? (this.consume(), this.delegate.finishTag(), this.transitionTo("beforeData")) : this.transitionTo("beforeAttributeName");
        },
        ...
        endTagOpen: function endTagOpen() {
          var t = this.consume();
          ("@" === t || ":" === t || Z(t)) && (this.transitionTo("tagName"), this.tagNameBuffer = "", this.delegate.beginEndTag(), this.appendToTagName(t));
        }
      }, this.reset();
    }
    ...
    function e() {
      var t;
      return a(this, e), (t = c(this, s(e).apply(this, arguments))).cursorCount = 0, t;
    }
    ...
    return o(e, t), i(e, [{
      ...
      value: function value(t) {
        var e,
            r = [];
        this.cursorCount = 0, e = this.isTopLevel ? I.template(r, t.blockParams, t.loc) : I.blockItself(r, t.blockParams, t.chained, t.loc);
        var a,
            n = t.body.length;
        if (this.elementStack.push(e), 0 === n) return this.elementStack.pop();

        for (a = 0; a < n; a++) {
          this.acceptNode(t.body[a]);
        }
        ...
        if (i !== e) {
          var o = i;
          throw new R("Unclosed element `" + o.tag + "` (on line " + o.loc.start.line + ").", o.loc);
        }
      ...
      value: function value(t) {
        if ("comment" !== this.tokenizer.state) {
          if ("comment" !== this.tokenizer.state && "data" !== this.tokenizer.state && "beforeData" !== this.tokenizer.state) throw new R("A block may only be used inside an HTML element or another block.", t.loc);
          var e = et(this, t),
              r = e.path,
              a = e.params,
              n = e.hash,
          ...
          "in-element" === r.original && (n = function (t, e, r) {
            ...
            e.pairs.forEach(function (t) {
              if ("guid" === t.key) throw new R("Cannot pass `guid` from user space", r);
      ...
      value: function value(t) {
        ...
        if ("comment" !== e.state) {
          ...
          switch (e.state) {
            case "tagOpen":
            case "tagName":
              throw new R("Cannot use mustaches in an elements tagname: `".concat(this.sourceForNode(t, t.path), "` at L").concat(n.start.line, ":C").concat(n.start.column), r.loc);
            ...
            case "afterAttributeName":
              this.beginAttributeValue(!1), this.finishAttributeValue(), rt(this.currentStartTag, r), e.transitionTo("beforeAttributeName");
              break;

            case "afterAttributeValueQuoted":
              rt(this.currentStartTag, r), e.transitionTo("beforeAttributeName");
              break;

            case "beforeAttributeValue":
              this.beginAttributeValue(!1), at(this.currentAttribute, r), e.transitionTo("attributeValueUnquoted");
              break;
      ...
      value: function value(t) {
        ...
        switch (e.state) {
          ...
          default:
            throw new R("Using a Handlebars comment when in the `".concat(e.state, '` state is not supported: "').concat(n.value, '" on line ').concat(a.start.line, ":").concat(a.start.column), t.loc);
        }
      ...
      value: function value(t) {
        var e = t.loc;
        throw new R('Handlebars partials are not supported: "'.concat(this.sourceForNode(t, t.name), '" at L').concat(e.start.line, ":C").concat(e.start.column), t.loc);
      }
    }, {
      key: "PartialBlockStatement",
      value: function value(t) {
        var e = t.loc;
        throw new R('Handlebars partial blocks are not supported: "'.concat(this.sourceForNode(t, t.name), '" at L').concat(e.start.line, ":C").concat(e.start.column), t.loc);
      }
    }, {
      key: "Decorator",
      value: function value(t) {
        var e = t.loc;
        throw new R('Handlebars decorators are not supported: "'.concat(this.sourceForNode(t, t.path), '" at L').concat(e.start.line, ":C").concat(e.start.column), t.loc);
      }
    }, {
      key: "DecoratorBlock",
      value: function value(t) {
        var e = t.loc;
        throw new R('Handlebars decorator blocks are not supported: "'.concat(this.sourceForNode(t, t.path), '" at L').concat(e.start.line, ":C").concat(e.start.column), t.loc);
      }
    }, {
      key: "SubExpression",
      value: function value(t) {
      ...
      value: function value(t) {
        ...
        if (-1 !== r.indexOf("/")) {
          if ("./" === r.slice(0, 2)) throw new R('Using "./" is not supported in Glimmer and unnecessary: "'.concat(t.original, '" on line ').concat(a.start.line, "."), t.loc);
          if ("../" === r.slice(0, 3)) throw new R('Changing context using "../" is not supported in Glimmer: "'.concat(t.original, '" on line ').concat(a.start.line, "."), t.loc);
          if (-1 !== r.indexOf(".")) throw new R("Mixing '.' and '/' in paths is not supported in Glimmer; use only '.' to separate property paths: \"".concat(t.original, '" on line ').concat(a.start.line, "."), t.loc);
          e = [t.parts.join("/")];
        } else {
          if ("." === r) {
            var n = "L".concat(a.start.line, ":C").concat(a.start.column);
            throw new R("'.' is not a supported path in Glimmer; check for a path with a trailing '.' at ".concat(n, "."), t.loc);
          }
    ...
    function t(e) {
      var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : new K($);
      a(this, t), this.elementStack = [], this.currentAttribute = null, this.currentNode = null, this.source = e.split(/(?:\r\n?|\n)/g), this.tokenizer = new X(this, r);
    }
    ...
    return i(t, [{
      ...
      value: function value(t, e) {
        ...
        for (e ? (a = e.loc.end.line - 1, n = e.loc.end.column) : (a = t.loc.end.line - 1, n = t.loc.end.column); o < a;) {
          o++, r = this.source[o], o === i ? i === a ? l.push(r.slice(s, n)) : l.push(r.slice(s)) : o === a ? l.push(r.slice(0, n)) : l.push(r);
        }
  ...
  function rt(t, e) {
    ...
    if (j(r)) {
      ...
      throw new R("In ".concat(s, ", ").concat(o, ' is not a valid modifier: "').concat(r.original, '" on line ').concat(i && i.start.line, "."), e.loc);
    }
  ...
  function ot(t, e, r) {
    return new it("Cannot remove a node unless it is part of an array", t, e, r);
  }

  function st(t, e, r) {
    return new it("Cannot replace a node with multiple nodes unless it is part of an array", t, e, r);
  }

  function lt(t, e) {
    return new it("Replacing and removing in key handlers is not yet supported.", t, null, e);
  }
  ...
  function ht(t, e) {
    ...
    if (void 0 !== i && (r = ct(i), a = ut(i)), void 0 !== r && (n = r(e)), null != n) {
      if (JSON.stringify(e) !== JSON.stringify(n)) return Array.isArray(n) ? (dt(t, n), n) : ht(t, n) || n;
      n = void 0;
    }
  ...
  function ft(t, e, r, a) {
    ...
    if (n) {
      ...
      if (Array.isArray(n)) dt(t, n);else {
        var l = ht(t, n);
        void 0 !== l && function (t, e, r, a) {
          if (null === a) throw ot(r, t, e);

          if (Array.isArray(a)) {
            if (1 !== a.length) throw 0 === a.length ? ot(r, t, e) : st(r, t, e);
            pt(t, e, a[0]);
          } else pt(t, e, a);
        }(r, a, n, l);
      }
  ...
  function mt(t, e, r) {
    return null === r ? (t.splice(e, 1), 0) : Array.isArray(r) ? (t.splice.apply(t, [e, 1].concat(p(r))), r.length) : (t.splice(e, 1, r), 1);
  }
  ...
  function Et(t) {
    ...
    switch (t.type) {
      ...
      case "ElementNode":
        l.push("<", t.tag), t.attributes.length && l.push(" ", r(t.attributes).join(" ")), t.modifiers.length && l.push(" ", r(t.modifiers).join(" ")), t.comments.length && l.push(" ", r(t.comments).join(" ")), t.blockParams.length && l.push(" ", "as", " ", "|".concat(t.blockParams.join(" "), "|")), ie[t.tag] ? (t.selfClosing && l.push(" /"), l.push(">")) : t.selfClosing ? l.push(" />") : (l.push(">"), l.push.apply(l, r(t.children)), l.push("</", t.tag, ">"));
        break;

      case "AttrNode":
        "TextNode" === t.value.type ? "" !== t.value.chars ? (l.push(t.name, "="), l.push('"', "raw" === e.entityEncoding ? t.value.chars : xt(t.value.chars), '"')) : l.push(t.name) : (l.push(t.name, "="), l.push(Et(t.value, e)));
        break;

      case "ConcatStatement":
        l.push('"'), t.parts.forEach(function (t) {
          "TextNode" === t.type ? l.push("raw" === e.entityEncoding ? t.chars : xt(t.chars)) : l.push(Et(t, e));
        }), l.push('"');
        break;

      case "TextNode":
        l.push("raw" === e.entityEncoding ? t.chars : (s = t.chars, yt.test(s) ? s.replace(kt, wt) : s));
        break;
      ...
      case "BlockStatement":
        var h = [];
        t.chained ? h.push(["{{else ", a(t), "}}"].join("")) : h.push(["{{#", a(o = t), i(o), "}}"].join("")), h.push(Et(t.program, e)), t.inverse && (t.inverse.chained || h.push("{{else}}"), h.push(Et(t.inverse, e))), t.chained || h.push(function (t) {
  ...
  var Pt = function () {
    ...
    return i(t, [{
      ...
      value: function value(t, e) {
        var r;
        r = "Block" === t.type || "Template" === t.type && At.Program ? "Program" : t.type;
        var a = At[r];
        a && a(this, t, e);
      }
    }]), t;
    ...
    BlockStatement: function BlockStatement(t, e, r) {
      ...
      _t = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {};
  ...
  Tt(Lt);
  Lt.extend, Lt.indexOf, Lt.escapeExpression, Lt.isEmpty, Lt.createFrame, Lt.blockParams, Lt.appendContextPath, Lt.isFunction, Lt.isArray;
  ...
  var Dt = Nt(function (t, e) {
    e.__esModule = !0, e["default"] = function (t) {
      t.registerHelper("blockHelperMissing", function (e, r) {
        ...
        if (Lt.isArray(e)) return e.length > 0 ? (r.ids && (r.ids = [r.name]), t.helpers.each(e, r)) : a(this);

        if (r.data && r.ids) {
          var i = Lt.createFrame(r.data);
          i.contextPath = Lt.appendContextPath(r.data.contextPath, r.name), r = {
            data: i
          };
        }
  ...
  var qt = Nt(function (t, e) {
    ...
    e["default"] = function (t) {
      t.registerHelper("each", function (t, e) {
        ...
        function u(e, r, n) {
          l && (l.key = e, l.index = r, l.first = 0 === r, l.last = !!n, c && (l.contextPath = c + e)), s += a(t[e], {
            data: l,
            blockParams: Lt.blockParams([t[e], e], [c + e, null])
          });
        }

        if (e.data && e.ids && (c = Lt.appendContextPath(e.data.contextPath, e.ids[0]) + "."), Lt.isFunction(t) && (t = t.call(this)), e.data && (l = Lt.createFrame(e.data)), t && "object" === r(t)) if (Lt.isArray(t)) for (var h = t.length; o < h; o++) {
          o in t && u(o, o, o === t.length - 1);
        } else if (_t.Symbol && t[_t.Symbol.iterator]) {
          for (var p = [], f = t[_t.Symbol.iterator](), d = f.next(); !d.done; d = f.next()) {
            p.push(d.value);
          }
          ...
          for (var g in t) {
            t.hasOwnProperty(g) && (void 0 !== m && u(m, o - 1), m = g, o++);
          }
  ...
  var It = Nt(function (t, e) {
    e.__esModule = !0, e["default"] = function (t) {
      t.registerHelper("if", function (t, e) {
        return Lt.isFunction(t) && (t = t.call(this)), !e.hash.includeZero && !t || Lt.isEmpty(t) ? e.inverse(this) : e.fn(this);
  ...
  var Vt = Nt(function (t, e) {
    e.__esModule = !0, e["default"] = function (t) {
      t.registerHelper("with", function (t, e) {
        ...
        var a = e.data;
        return e.data && e.ids && ((a = Lt.createFrame(e.data)).contextPath = Lt.appendContextPath(e.data.contextPath, e.ids[0])), r(t, {
          data: a,
  ...
  var Ht = Nt(function (t, e) {
    ...
    e.__esModule = !0, e.registerDefaultHelpers = function (t) {
      a["default"](t), n["default"](t), i["default"](t), o["default"](t), s["default"](t), l["default"](t), c["default"](t);
  ...
  var $t = Nt(function (t, e) {
    ...
    function i(t, e, r) {
      this.helpers = t || {}, this.partials = e || {}, this.decorators = r || {}, Ht.registerDefaultHelpers(this), jt.registerDefaultDecorators(this);
    }
    ...
    i.prototype = {
      ...
      registerPartial: function registerPartial(t, e) {
        if ("[object Object]" === Lt.toString.call(t)) Lt.extend(this.partials, t);else {
  ...
  Tt($t);
  $t.HandlebarsEnvironment, $t.VERSION, $t.COMPILER_REVISION, $t.LAST_COMPATIBLE_COMPILER_REVISION, $t.REVISION_CHANGES, $t.log, $t.createFrame, $t.logger;
  ...
  var Ft = Nt(function (t, e) {
    e.__esModule = !0, e.checkRevision = function (t) {
      ...
      if (e >= $t.LAST_COMPATIBLE_COMPILER_REVISION && e <= $t.COMPILER_REVISION) return;
      ...
      if (!t || !t.main) throw new i["default"]("Unknown template object: " + r(t));
      ...
      var s = {
        ...
        invokePartial: function invokePartial(r, a, o) {
          o.hash && (a = n.extend({}, a, o.hash), o.ids && (o.ids[0] = !0)), r = e.VM.resolvePartial.call(this, r, a, o);
          var s = n.extend({}, o, {
            hooks: this.hooks
          }),
              l = e.VM.invokePartial.call(this, r, a, s);

          if (null == l && e.compile && (o.partials[o.name] = e.compile(r, t.compilerOptions, e), l = o.partials[o.name](a, s)), null != l) {
            if (o.indent) {
        ...
        program: function program(t, e, r, a, n) {
          var i = this.programs[t],
              s = this.fn(t);
          return e || n || a || r ? i = o(this, t, s, e, r, a, n) : i || (i = this.programs[t] = o(this, t, s)), i;
        },
      ...
      function c(e) {
        var r = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1],
            a = r.data;
        c._setup(r), !r.partial && t.useData && (a = function (t, e) {
          e && "root" in e || ((e = e ? $t.createFrame(e) : {}).root = t);
          return e;
        }(e, a));
        var n = void 0,
        ...
        return t.useDepths && (n = r.depths ? e != r.depths[0] ? [e].concat(r.depths) : r.depths : [e]), (o = l(t.main, o, s, r.depths || [], a, i))(e, r);
      }

      return c.isTop = !0, c._setup = function (r) {
        if (r.partial) s.helpers = r.helpers, s.partials = r.partials, s.decorators = r.decorators, s.hooks = r.hooks;else {
          s.helpers = n.extend({}, e.helpers, r.helpers), t.usePartial && (s.partials = n.extend({}, e.partials, r.partials)), (t.usePartial || t.useDecorators) && (s.decorators = n.extend({}, e.decorators, r.decorators)), s.hooks = {};
          var i = r.allowCallsToHelperMissing || a;
          Ht.moveHelperToHooks(s, "helperMissing", i), Ht.moveHelperToHooks(s, "blockHelperMissing", i);
        }
      }, c._child = function (e, r, a, n) {
        if (t.useBlockParams && !a) throw new i["default"]("must pass block params");
        if (t.useDepths && !n) throw new i["default"]("must pass parent depths");
        return o(s, e, t[e], r, 0, a, n);
      }, c;
    }, e.wrapProgram = o, e.resolvePartial = function (t, e, r) {
      ...
      r.fn && r.fn !== s && function () {
        ...
        o = r.data["partial-block"] = function (e) {
          var r = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1];
          return r.data = $t.createFrame(r.data), r.data["partial-block"] = a, t(e, r);
    ...
    function o(t, e, r, a, n, i, o) {
      function s(e) {
        var n = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1],
            s = o;
        return !o || e == o[0] || e === t.nullContext && null === o[0] || (s = [e].concat(o)), r(t, e, t.helpers, t.partials, n.data || a, i && [n.blockParams].concat(i), s);
      }

      return (s = l(r, s, t, o, a, i)).program = e, s.depth = o ? o.length : 0, s.blockParams = n || 0, s;
    }
  ...
  Tt(Ft);
  Ft.checkRevision, Ft.template, Ft.wrapProgram, Ft.resolvePartial, Ft.invokePartial, Ft.noop;
  ...
  var Kt = Nt(function (t, e) {
    ...
    function u() {
      ...
      return s.extend(t, n), t.SafeString = i["default"], t.Exception = o["default"], t.Utils = s, t.escapeExpression = s.escapeExpression, t.VM = l, t.template = function (e) {
  ...
  var Qt = Nt(function (t, e) {
    ...
    var r = function () {
      var t = {
        ...
        performAction: function performAction(t, e, r, a, n, i, o) {
          var s = i.length - 1;
          ...
          switch (n) {
            ...
            case 13:
              this.$ = a.prepareBlock(i[s - 3], i[s - 2], i[s - 1], i[s], !1, this._$);
              break;

            case 14:
              this.$ = a.prepareBlock(i[s - 3], i[s - 2], i[s - 1], i[s], !0, this._$);
              break;
            ...
            case 19:
              var l = a.prepareBlock(i[s - 2], i[s - 1], i[s], i[s], !1, this._$),
            ...
            case 22:
            case 23:
              this.$ = a.prepareMustache(i[s - 3], i[s - 2], i[s - 1], i[s - 4], a.stripFlags(i[s - 4], i[s]), this._$);
              break;
            ...
            case 25:
              this.$ = a.preparePartialBlock(i[s - 2], i[s - 1], i[s], this._$);
              break;
        ...
        parse: function parse(t) {
          ...
          for (var p, f, d, m, g, v, b, y, k, S, w = {};;) {
            if (d = r[r.length - 1], this.defaultActions[d] ? m = this.defaultActions[d] : (null == p && (S = void 0, "number" != typeof (S = e.lexer.lex() || 1) && (S = e.symbols_[S] || S), p = S), m = i[d] && i[d][p]), void 0 === m || !m.length || !m[0]) {
              var x = "";
              ...
              if (!c) {
                ...
                x = this.lexer.showPosition ? "Parse error on line " + (s + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + k.join(", ") + ", got '" + (this.terminals_[p] || p) + "'" : "Parse error on line " + (s + 1) + ": Unexpected " + (1 == p ? "end of input" : "'" + (this.terminals_[p] || p) + "'"), this.parseError(x, {
            ...
            switch (m[0]) {
              case 1:
                r.push(p), a.push(this.lexer.yytext), n.push(this.lexer.yylloc), r.push(m[1]), p = null, f ? (p = f, f = null) : (l = this.lexer.yyleng, o = this.lexer.yytext, s = this.lexer.yylineno, u = this.lexer.yylloc, c > 0 && c--);
                break;
              ...
              case 2:
                ...
                }, h && (w._$.range = [n[n.length - (b || 1)].range[0], n[n.length - 1].range[1]]), void 0 !== (g = this.performAction.call(w, o, l, s, this.yy, m[1], a, n))) return g;
        ...
        var t = {
          ...
          next: function next() {
            ...
            for (var i = this._currentRules(), o = 0; o < i.length && (!(r = this._input.match(this.rules[i[o]])) || e && !(r[0].length > e[0].length) || (e = r, a = o, this.options.flex)); o++) {
              ;
            }
    ...
    n.prototype = new a["default"](), n.prototype.Program = function (t) {
      ...
      for (var a = t.body, n = 0, c = a.length; n < c; n++) {
        ...
        if (h) {
          ...
          h.close && s(a, n, !0), h.open && l(a, n, !0), e && g && (s(a, n), l(a, n) && "PartialStatement" === u.type && (u.indent = /([ \t]+$)/.exec(a[n - 1].original)[1])), e && d && (s((u.program || u.inverse).body), l(a, n)), e && m && (s(a, n), l((u.inverse || u.program).body));
        }
      }
      ...
      if (t.openStrip.close && s(e.body, null, !0), r) {
        ...
        u.open && l(e.body, null, !0), u.close && s(a.body, null, !0), t.closeStrip.open && l(n.body, null, !0), !this.options.ignoreStandalone && i(e.body) && o(a.body) && (l(e.body), s(a.body));
  ...
  var Zt = Nt(function (t, e) {
    e.__esModule = !0, e.SourceLocation = function (t, e) {
      ...
      for (var n = t ? "@" : "", i = [], o = 0, s = 0, l = e.length; s < l; s++) {
        var c = e[s].part,
            u = e[s].original !== c;
        if (n += (e[s].separator || "") + c, u || ".." !== c && "." !== c && "this" !== c) i.push(c);else {
  ...
  Tt(Zt);
  Zt.SourceLocation, Zt.id, Zt.stripFlags, Zt.stripComment, Zt.preparePath, Zt.prepareMustache, Zt.prepareRawBlock, Zt.prepareBlock, Zt.prepareProgram, Zt.preparePartialBlock;
  var Xt = Nt(function (t, e) {
    ...
    e.__esModule = !0, e.parse = function (t, e) {
      ...
      return a["default"].yy = o, o.locInfo = function (t) {
  ...
  var te = Nt(function (t, e) {
    ...
    e.__esModule = !0, e.Compiler = o, e.precompile = function (t, e, r) {
    ...
    o.prototype = {
      ...
      helperSexpr: function helperSexpr(t, e, r) {
        var i = this.setupFullMustacheParams(t, e, r),
            o = t.path,
            s = o.parts[0];
        if (this.options.knownHelpers[s]) this.opcode("invokeKnownHelper", i.length, s);else {
          if (this.options.knownHelpersOnly) throw new a["default"]("You specified knownHelpersOnly, but used the unknown helper " + s, t);
          o.strict = !0, o.falsy = !0, this.accept(o), this.opcode("invokeHelper", i.length, o.original, n["default"].helpers.simpleId(o));
        }
      },
  ...
  var re = Nt(function (t, e) {
    ...
    o.prototype = {
      nameLookup: function nameLookup(t, e) {
        var r = [this.aliasable("container.propertyIsEnumerable"), ".call(", t, ',"constructor")'];
      ...
      appendToBuffer: function appendToBuffer(t, e, r) {
        return Lt.isArray(t) || (t = [t]), t = this.source.wrap(t, e), this.environment.isSimple ? ["return ", t, ";"] : r ? ["buffer += ", t, ";"] : (t.appendToBuffer = !0, t);
      },
      ...
      compile: function compile(t, e, r, n) {
        ...
        for (l = 0, c = i.length; l < c; l++) {
          o = i[l], this.source.currentLocation = o.loc, s = s || o.loc, this[o.opcode].apply(this, o.args);
        }
      ...
      mergeSource: function mergeSource(t) {
        ...
        return this.source.each(function (t) {
          t.appendToBuffer ? (i ? t.prepend("  + ") : i = t, o = t) : (i && (n ? i.prepend("buffer += ") : a = !0, o.add(";"), i = o = void 0), n = !0, e || (r = !1));
        }), r ? i ? (i.prepend("return "), o.add(";")) : n || this.source.push('return "";') : (t += ", buffer = " + (a ? "" : this.initializeBuffer()), i ? (i.prepend("return buffer + "), o.add(";")) : this.source.push("return buffer;")), t && this.source.prepend("var " + t.substring(2) + (a ? "" : ";\n")), this.source.merge();
      },
      ...
      resolvePath: function resolvePath(t, e, r, a, n) {
        ...
        }(this.options.strict && n, this, e, t));else for (var o = e.length; r < o; r++) {
      ...
      invokeHelper: function invokeHelper(t, e, r) {
        var a = this.popStack(),
            ...
            i = [];
        r && i.push(n.name), i.push(a), this.options.strict || i.push(this.aliasable("container.hooks.helperMissing"));
        var o = ["(", this.itemsSeparatedBy(i, "||"), ")"],
            s = this.source.functionCall(o, "call", n.callParams);
        this.push(s);
      },
      itemsSeparatedBy: function itemsSeparatedBy(t, e) {
        var r = [];
        r.push(t[0]);
      ...
      invokeAmbiguous: function invokeAmbiguous(t, e) {
        ...
        this.options.strict || (n[0] = "(helper = ", n.push(" != null ? helper : ", this.aliasable("container.hooks.helperMissing"))), this.push(["(", n, a.paramsInit ? ["),(", a.paramsInit] : [], "),", "(typeof helper === ", this.aliasable('"function"'), " ? ", this.source.functionCall("helper", "call", a.callParams), " : helper))"]);
      },
      ...
      compileChildren: function compileChildren(t, e) {
        for (var r = t.children, a = void 0, n = void 0, i = 0, o = r.length; i < o; i++) {
          ...
          } else a.index = s.index, a.name = "program" + s.index, this.useDepths = this.useDepths || s.useDepths, this.useBlockParams = this.useBlockParams || s.useBlockParams;
        }
      },
      ...
      replaceStack: function replaceStack(t) {
        ...
        if (s instanceof i) e = ["(", r = [s.value]], o = !0;else {
          n = !0;
          var l = this.incrStack();
          e = ["((", this.push(l), " = ", s, ")"], r = this.topStack();
        }
        var c = t.call(this, r);
        o || this.popStack(), n && this.stackSlot--, this.push(e.concat(c, ")"));
      },
      ...
      setupParams: function setupParams(t, e, r) {
        var a = {},
            ...
            s = !r,
            l = void 0;
        s && (r = []), a.name = this.quotedString(t), a.hash = this.popStack(), this.trackIds && (a.hashIds = this.popStack()), this.stringParams && (a.hashTypes = this.popStack(), a.hashContexts = this.popStack());
        var c = this.popStack(),
            u = this.popStack();
        (u || c) && (a.fn = u || "container.noop", a.inverse = c || "container.noop");

        for (var h = e; h--;) {
          l = this.popStack(), r[h] = l, this.trackIds && (o[h] = this.popStack()), this.stringParams && (i[h] = this.popStack(), n[h] = this.popStack());
        }

        return s && (a.args = this.source.generateArray(r)), this.trackIds && (a.ids = this.source.generateArray(o)), this.stringParams && (a.types = this.source.generateArray(i), a.contexts = this.source.generateArray(n)), this.options.data && (a.data = "data"), this.useBlockParams && (a.blockParams = "blockParams"), a;
      },
      ...
      for (var t = "break else new var case finally return void catch for switch while continue function this with default if throw delete in try do instanceof typeof abstract enum int short boolean export interface static byte extends long super char final native synchronized class float package throws const goto private transient debugger implements protected volatile double import public let yield await null true false".split(" "), e = o.RESERVED_WORDS = {}, r = 0, a = t.length; r < a; r++) {
        e[t[r]] = !0;
      }
  ...
  var ae = Nt(function (t, e) {
    ...
    function c() {
      ...
      }, t.AST = n["default"], t.Compiler = te.Compiler, t.JavaScriptCompiler = i["default"], t.Parser = Xt.parser, t.parse = Xt.parse, t;
    }

    var u = c();
    u.create = c, s["default"](u), u.Visitor = o["default"], u["default"] = u, e["default"] = u, t.exports = e["default"];
  });
  Tt(ae);
  var ne = ae.parse,
  ...
  var oe = function (t) {
    function e() {
      var t;
      return a(this, e), (t = c(this, s(e).apply(this, arguments))).tagOpenLine = 0, t.tagOpenColumn = 0, t;
    }
    ...
    return o(e, t), i(e, [{
      ...
      key: "beginComment",
      value: function value() {
        this.currentNode = I.comment(""), this.currentNode.loc = {
          source: null,
      ...
      key: "finishComment",
      value: function value() {
        this.currentComment.loc.end = I.pos(this.tokenizer.line, this.tokenizer.column), M(this.currentElement(), this.currentComment);
      }
    }, {
      key: "beginData",
      value: function value() {
        this.currentNode = I.text(), this.currentNode.loc = {
          source: null,
      ...
      key: "finishData",
      value: function value() {
        this.currentData.loc.end = I.pos(this.tokenizer.line, this.tokenizer.column), M(this.currentElement(), this.currentData);
      }
    }, {
      key: "tagOpen",
      value: function value() {
      ...
      value: function value() {
        var t = this.tokenizer,
            ...
            r = t.column,
            a = this.currentTag;
        a.loc = I.loc(this.tagOpenLine, this.tagOpenColumn, e, r), "StartTag" === a.type ? (this.finishStartTag(), (ie[a.name] || a.selfClosing) && this.finishEndTag(!0)) : "EndTag" === a.type && this.finishEndTag(!1);
      }
    }, {
      key: "finishStartTag",
      value: function value() {
      ...
      value: function value(t) {
        ...
        !function (t, e, r) {
          var a;
          ie[t.name] && !r ? a = "Invalid end tag " + se(t) + " (void elements cannot have end tags)." : void 0 === e.tag ? a = "Closing tag " + se(t) + " without an open tag." : e.tag !== t.name && (a = "Closing tag " + se(t) + " did not match last open tag `" + e.tag + "` (on line " + e.loc.start.line + ").");
          if (a) throw new R(a, e.loc);
        }(e, r, t), r.loc.end.line = this.tokenizer.line, r.loc.end.column = this.tokenizer.column, H(r), M(a, r);
      }
    }, {
      ...
      value: function value() {
        ...
        if ("EndTag" === t.type) throw new R("Invalid end tag: closing tag must not have attributes, " + "in `".concat(t.name, "` (on line ").concat(this.tokenizer.line, ")."), t.loc);
      ...
      value: function value(t) {
        ...
        if (r && "TextNode" === r.type) r.chars += t, r.loc.end.line = this.tokenizer.line, r.loc.end.column = this.tokenizer.column;else {
          var a = I.loc(this.tokenizer.line, this.tokenizer.column, this.tokenizer.line, this.tokenizer.column);
      ...
      value: function value() {
          ...
          if (r) {
            if (e) return function (t) {
              for (var e = 0; e < t.length; e++) {
                var r = t[e];
                if ("MustacheStatement" !== r.type && "TextNode" !== r.type) throw new R("Unsupported node in quoted attribute value: " + r.type, r.loc);
              }

              return I.concat(t);
            }(t);
            if (1 === t.length || 2 === t.length && "TextNode" === t[1].type && "/" === t[1].chars) return t[0];
            throw new R("An unquoted attribute value must be a string or a mustache, preceeded by whitespace or a '=' character, and " + "followed by whitespace, a '>' character, or '/>' (on line ".concat(a, ")"), I.loc(a, 0));
          }
        ...
        var l = I.loc(this.currentAttr.start.line, this.currentAttr.start.column, this.tokenizer.line, this.tokenizer.column),
            c = I.attr(e, s, l);
      ...
      value: function value(t) {
        throw new R("Syntax error at line ".concat(this.tokenizer.line, " col ").concat(this.tokenizer.column, ": ").concat(t), I.loc(this.tokenizer.line, this.tokenizer.column));
      }
    }]), e;
  }(tt);
  ...
  function ce(t) {
    ...
    if (a && a.plugins && a.plugins.ast) for (var l = 0, c = a.plugins.ast.length; l < c; l++) {
      gt(s, (0, a.plugins.ast[l])(b({}, a, {
        syntax: le
      }, {
        plugins: void 0
      })).visitor);
  ...
  var pe = {
    parsers: {
      ...
      fe = pe.parsers;
  t["default"] = pe, t.parsers = fe, Object.defineProperty(t, "__esModule", {
    value: !0
  });
});